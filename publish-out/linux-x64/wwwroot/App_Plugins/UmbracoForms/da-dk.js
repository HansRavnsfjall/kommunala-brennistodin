const t = {
  ...
  formImport: {
    ...
    importInstruction2: "Hvis der allerede findes en formular med id'et for den valgte fil, vil den blive opdateret og flyttet til den valgte placering. Hvis der ikke findes en eksisterende formular, oprettes en ny på det valgte sted."
  },
  formPermissions: {
  ...
  formEdit: {
    ...
    magicStringsForFieldsNote: 'Mange feltindstillinger understøtter brugen af <b>magiske strenge</b>. Når formularen vises, kan disse strenge erstattes med værdier fra forskellige kilder, herunder ordbogsværdier, sessions- eller cookiedata og Umbraco-sidefelter. <a href="https://docs.umbraco.com/umbraco-forms/developer/magic-strings" target="_blank">Læs mere</a>.',
    magicStringsForWorkflowsNote: 'Mange workflow-indstillinger understøtter brugen af <b>magiske strenge</b>. Når arbejdsgangen behandles, kan disse strenge erstattes med værdier fra forskellige kilder, herunder registreringsdata og ordbogsværdier. <a href="https://docs.umbraco.com/umbraco-forms/developer/magic-strings" target="_blank">Læs mere</a>.',
  ...
  formMove: {
    ...
    title: (e) => `Vælg den mappe du vil flytte <strong>${e}</strong> til i træstrukturen nedenfor.`,
  ...
  formSettings: {
    ...
    storeRecordsDescription: "Afkryds denne boks for at gemme besvarelser i databasen. Dette vil give dig mulighed for at gennemgå og eksportere besvarelser via oversigten. Hvis du ikke vil gemme data (på grund af regler i din organisation), så skal du lade boksen være uafkrydset.",
