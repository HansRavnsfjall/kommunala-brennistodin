const o = {
  ...
  formCopyWorkflows: {
    ...
    selectedWorkflows: "The following workflows are assigned to the form. Please confirm the ones you wish to copy:",
    stage: "Stage",
    selected: "Selected",
  ...
  formImport: {
    ...
    importInstruction2: "If a form already exists with the ID of the file selected, it will be updated and moved to the selected location. If no existing form is found, a new one will be created at the selected location."
  },
  formPermissions: {
  ...
  formEdit: {
    ...
    workflows: "Workflows",
    magicStringsForFieldsNote: 'Many field settings support the use of <b>magic strings</b>. When the form is displayed, these strings can be replaced with values from various sources, including dictionary values, session or cookie data and Umbraco page fields. <a href="https://docs.umbraco.com/umbraco-forms/developer/magic-strings" target="_blank": Read more</a>.',
    magicStringsForWorkflowsNote: 'Many workflow settings support the use of <b>magic strings</b>. When the workflow is processed, these strings can be replaced with values from various sources, including record data and dictionary values. <a href="https://docs.umbraco.com/umbraco-forms/developer/magic-strings" target="_blank": Read more</a>.',
  ...
  formMove: {
    ...
    successMessage: (e, t) => `<strong>${e}</strong> was moved underneath <strong>${t}</strong>`,
  ...
  formConditions: {
    ...
    pageButtonConditionStatus: (e, t) => `<strong>${e}</strong> buttons for this page if <strong>${t}</strong> of the following match:`,
    fieldsetConditionStatus: (e, t) => `<strong>${e}</strong> this group if <strong>${t}</strong> of the following match:`,
    fieldConditionStatus: (e, t) => `<strong>${e}</strong> this question if <strong>${t}</strong> of the following match:`,
    empty: "empty"
  },
  formThemes: {
  ...
  formSettings: {
    ...
    storeRecordsDescription: "Check this box to save submitted records in a database. This will allow you to view and export them from the queries overview. If you don't want to store data (due to policies in your organization), leave the box un-checked.",
  ...
  formPropertyEditors: {
    ...
    datePickerTypeNone: "None",
    datePickerTypeRelative: "Relative to today",
    datePickerTypeDate: "Specific date"
  },
  formProviderFieldTypes: {
    ...
    multipleChoiceDisplayLayoutDescription: "Indicate whether the field's layout should be horizontal or vertical (default if not specified).",
    ...
    dateMinDateLabel: "Minimum date",
    dateMinDateDescription: "The minimum/earliest date that can be selected.",
    dateMaxDateLabel: "Maximum date",
    dateMaxDateDescription: "The maximum/latest date that can be selected.",
    ...
    singleChoiceDisplayLayoutDescription: "Indicate whether the field's layout should be horizontal or vertical (default if not specified).",
  ...
  formProviderExportTypes: {
    csvSubmittedValues: "CSV file (submitted values)",
    csvSubmittedValuesDescription: "Exports all submitted values to a CSV file.",
    csvDisplayValues: "CSV file (display values)",
    csvDisplayValuesDescription: "Exports all display values to a CSV file. Captions are used for prevalue data where available.",
  ...
  formPreview: {
    headline: "Preview form",
    description: "This form is added to the following pages, choose one to open the preview:",
    descriptionNoItems: "To be able to preview the form, you first have to add it to a page and save or publish it."
  }
};
export {
  o as default
