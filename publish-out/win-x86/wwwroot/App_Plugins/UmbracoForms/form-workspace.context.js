...
var _ = (r, a, e) => a.has(r) || R("Cannot " + e);
var n = (r, a, e) => (_(r, a, "read from private field"), e ? e.call(r) : a.get(r)), d = (r, a, e) => a.has(r) ? R("Cannot add the same private member more than once") : a instanceof WeakSet ? a.add(r) : a.set(r, e), g = (r, a, e, t) => (_(r, a, "write to private field"), t ? t.call(r, e) : a.set(r, e), e), E = (r, a, e) => (_(r, a, "access private method"), e);
...
import { UmbLocalizationController as ae } from "@umbraco-cms/backoffice/localization-api";
var oe = Object.defineProperty, ne = Object.getOwnPropertyDescriptor, O = (r) => {
  throw TypeError(r);
}, q = (r, a, e, t) => {
  for (var s = t > 1 ? void 0 : t ? ne(a, e) : a, i = r.length - 1, o; i >= 0; i--)
    (o = r[i]) && (s = (t ? o(a, e, s) : o(s)) || s);
  return t && s && oe(a, e, s), s;
}, W = (r, a, e) => a.has(r) || O("Cannot " + e), P = (r, a, e) => (W(r, a, "read from private field"), a.get(r)), N = (r, a, e) => a.has(r) ? O("Cannot add the same private member more than once") : a instanceof WeakSet ? a.add(r) : a.set(r, e), le = (r, a, e, t) => (W(r, a, "write to private field"), a.set(r, e), e), k = (r, a, e) => (W(r, a, "access private method"), e), y, S, b, I;
...
I = function(r) {
  var a;
  (a = P(this, y)) == null || a.setName(r.target.value.toString());
};
f.styles = [
  H`
      :host {
...
class pe extends Q {
  constructor(e) {
    ...
    this.formRepository = new D(this), this.fieldTypeRepository = new x(
      ...
      const i = s.match.params.parentEntityType, o = s.match.params.parentUnique === "null" ? null : s.match.params.parentUnique, u = s.match.params.template;
      await this.create(
        { entityType: i, unique: o },
        u
      );
  ...
  async submit() {
    ...
    if (n(this, l).value.name.trim().length === 0) {
      ...
      return i == null || i.peek("danger", {
        data: {
          message: o.term("formEdit_noNameForForm")
        }
      }), Promise.reject();
    }
  ...
  setPageProperty(e, t, s) {
    var o;
    const i = (o = n(this, l).value) == null ? void 0 : o.pages.map((u, p) => ({
      ...u,
      ...p === e && {
        [t]: s
      }
  ...
  setFieldsetProperty(e, t, s, i) {
    var u;
    const o = (u = n(this, l).value) == null ? void 0 : u.pages[e].fieldSets.map(
      (p, c) => ({
        ...p,
        ...c === t && {
          [s]: i
    ...
    this.setPageProperty(e, "fieldSets", o);
  }
  setContainerProperty(e, t, s, i, o) {
    var p;
  ...
  setWorkflowProperty(e, t, s, i) {
    var u;
    const o = structuredClone((u = n(this, l).value) == null ? void 0 : u.formWorkflows);
    o && (o[e][t][s] = i, this.setFormProperty("formWorkflows", o));
  }
  moveFieldSet(e, t, s) {
    var o;
    if (s === e) return;
    const i = structuredClone((o = n(this, l).value) == null ? void 0 : o.pages);
    if (i) {
  ...
  getContainerIndexPathForField(e) {
    ...
    for (let s = 0; s < t.pages.length; s++) {
      const i = t.pages[s];
      for (let o = 0; o < i.fieldSets.length; o++) {
        const u = i.fieldSets[o];
  ...
  async getRichTextConfiguration() {
    ...
    return s || (e.push({
      ...
      alias: "stylesheets",
      value: t.configurationData.stylesheets
    })), e;
  }
  destroy() {
