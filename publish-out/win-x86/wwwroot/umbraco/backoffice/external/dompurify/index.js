...
const le = R(Array.prototype.forEach), jt = R(Array.prototype.lastIndexOf), lt = R(Array.prototype.pop), $ = R(Array.prototype.push), Vt = R(Array.prototype.splice), fe = R(String.prototype.toLowerCase), be = R(String.prototype.toString), Ne = R(String.prototype.match), q = R(String.prototype.replace), $t = R(String.prototype.indexOf), qt = R(String.prototype.trim), D = R(Object.prototype.hasOwnProperty), A = R(RegExp.prototype.test), K = Kt(TypeError);
function R(s) {
  return function(o) {
...
function C(s) {
  ...
  for (const [l, a] of Tt(s))
    D(s, l) && (Array.isArray(a) ? o[l] = Zt(a) : a && typeof a == "object" && a.constructor === Object ? o[l] = C(a) : o[l] = a);
  return o;
}
function Z(s, o) {
  for (; s !== null; ) {
...
function ht() {
  ...
  const a = l, c = a.currentScript, {
    ...
    DOMParser: Rt,
    trustedTypes: Q
  } = s, B = ve.prototype, Ot = Z(B, "cloneNode"), Lt = Z(B, "remove"), yt = Z(B, "nextSibling"), Dt = Z(B, "childNodes"), ee = Z(B, "parentNode");
  ...
  const tt = function(e) {
    let t = null;
    if (I(h.beforeSanitizeElements, e, null), ye(e))
      return b(e), !0;
    ...
    if (!p[n] || X[n]) {
      if (!X[n] && ot(n) && (u.tagNameCheck instanceof RegExp && A(u.tagNameCheck, n) || u.tagNameCheck instanceof Function && u.tagNameCheck(n)))
        return !1;
      if (Ae && !F[n]) {
        const f = ee(e) || e.parentNode, _ = Dt(e) || e.childNodes;
        if (_ && f) {
          const m = _.length;
          for (let L = m - 1; L >= 0; --L) {
            const M = Ot(_[L], !0);
    ...
    return e instanceof ve && !Gt(e) || (n === "noscript" || n === "noembed" || n === "noframes") && A(/<\/no(script|embed|frames)/i, e.innerHTML) ? (b(e), !0) : (v && e.nodeType === J.text && (t = e.textContent, le([pe, de, Te], (f) => {
      t = q(t, f, " ");
    ...
    for (; f--; ) {
      ...
      if (g && typeof Q == "object" && typeof Q.getAttributeType == "function" && !L)
      ...
      if (E !== De)
        try {
          L ? e.setAttributeNS(L, m, E) : e.setAttribute(m, E), ye(e) ? b(e) : lt(o.removed);
        } catch {
          x(m, e);
        }
    }
  ...
  return o.sanitize = function(i) {
    ...
    if (!o.isSupported)
      return i;
    if (ge || Le(e), o.removed = [], typeof i == "string" && (j = !1), j) {
      if (i.nodeName) {
    ...
    return w && p["!doctype"] && t.ownerDocument && t.ownerDocument.doctype && t.ownerDocument.doctype.name && A(gt, t.ownerDocument.doctype.name) && (L = "<!DOCTYPE " + t.ownerDocument.doctype.name + `>
` + L), v && le([pe, de, Te], (M) => {
      L = q(L, M, " ");
