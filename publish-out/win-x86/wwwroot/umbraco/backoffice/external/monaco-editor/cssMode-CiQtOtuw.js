import { m as tt } from "./index-CVakL7U_.js";
/*!-----------------------------------------------------------------------------
...
var rt = Object.defineProperty, nt = Object.getOwnPropertyDescriptor, it = Object.getOwnPropertyNames, ot = Object.prototype.hasOwnProperty, at = (e, n, i, r) => {
  if (n && typeof n == "object" || typeof n == "function")
    for (let t of it(n))
      !ot.call(e, t) && t !== i && rt(e, t, { get: () => n[t], enumerable: !(r = nt(n, t)) || r.enumerable });
  return e;
}, st = (e, n, i) => (at(e, n, "default"), i), d = {};
st(d, tt);
function ct(e, n) {
...
var M;
typeof self == "object" && self.constructor && self.constructor.name === "DedicatedWorkerGlobalScope" && globalThis.workerttPolicy !== void 0 ? M = globalThis.workerttPolicy : M = ct("defaultWorkerFactory", {
  createScriptURL: (e) => e
});
function ut(e) {
...
function dt(e) {
  ...
  return d.editor.createWebWorker({
    worker: n,
    host: e.host,
    keepIdleModels: e.keepIdleModels
  });
}
var lt = 120 * 1e3, ft = class {
  constructor(e) {
  ...
  _checkIfIdle() {
    if (!this._worker)
      return;
    Date.now() - this._lastUsedTime > lt && this._stopWorker();
  }
  _getClient() {
    return this._lastUsedTime = Date.now(), this._client || (this._worker = dt({
...
(function(e) {
  function n(r, t, o, s, c, f) {
    ...
    return a.defined(o) && (u.startCharacter = o), a.defined(s) && (u.endCharacter = s), a.defined(c) && (u.kind = c), a.defined(f) && (u.collapsedText = f), u;
  }
  e.create = n;
  function i(r) {
    const t = r;
...
(function(e) {
  function n(r, t, o, s, c, f) {
    let u = { range: r, message: t };
    return a.defined(o) && (u.severity = o), a.defined(s) && (u.code = s), a.defined(c) && (u.source = c), a.defined(f) && (u.relatedInformation = f), u;
  }
  e.create = n;
  function i(r) {
    var t;
...
(function(e) {
  function n(i) {
    let r = i;
    return !!r && a.objectLiteral(r) && (P.is(r.contents) || j.is(r.contents) || a.typedArray(r.contents, j.is)) && (i.range === void 0 || h.is(i.range));
  }
  e.is = n;
})(ve || (ve = {}));
var pe;
...
(function(e) {
  function n(r, t, o, s, c, f) {
    ...
    return f !== void 0 && (u.children = f), u;
  }
  e.create = n;
  function i(r) {
    let t = r;
...
(function(e) {
  ...
  function i(r) {
    let t = r;
    return a.defined(t) && a.typedArray(t.diagnostics, F.is) && (t.only === void 0 || a.typedArray(t.only, a.string)) && (t.triggerKind === void 0 || t.triggerKind === U.Invoked || t.triggerKind === U.Automatic);
  }
  e.is = i;
})(Ie || (Ie = {}));
var Le;
...
(function(e) {
  ...
  function i(r) {
    const t = r;
    return a.objectLiteral(t) && (t.tooltip === void 0 || a.string(t.tooltip) || P.is(t.tooltip)) && (t.location === void 0 || C.is(t.location)) && (t.command === void 0 || E.is(t.command));
  }
  e.is = i;
})(Y || (Y = {}));
var Ne;
(function(e) {
  ...
  function i(r) {
    const t = r;
    return a.objectLiteral(t) && w.is(t.position) && (a.string(t.label) || a.typedArray(t.label, Y.is)) && (t.kind === void 0 || Q.is(t.kind)) && t.textEdits === void 0 || a.typedArray(t.textEdits, I.is) && (t.tooltip === void 0 || a.string(t.tooltip) || P.is(t.tooltip)) && (t.paddingLeft === void 0 || a.boolean(t.paddingLeft)) && (t.paddingRight === void 0 || a.boolean(t.paddingRight));
  }
  e.is = i;
})(Ne || (Ne = {}));
var Se;
...
(function(e) {
  function n(i) {
    const r = i;
    return a.objectLiteral(r) && N.is(r.uri) && a.string(r.name);
  }
  e.is = n;
})($e || ($e = {}));
var ze;
(function(e) {
  ...
  function r(o, s) {
    ...
    for (let g = f.length - 1; g >= 0; g--) {
      ...
      if (l <= u)
        c = c.substring(0, b) + _.newText + c.substring(l, c.length);
      else
  ...
  function t(o, s) {
    if (o.length <= 1)
      return o;
    const c = o.length / 2 | 0, f = o.slice(0, c), u = o.slice(c);
    t(f, s), t(u, s);
    let g = 0, _ = 0, b = 0;
    for (; g < f.length && _ < u.length; )
      s(f[g], u[_]) <= 0 ? o[b++] = f[g++] : o[b++] = u[_++];
    for (; g < f.length; )
      o[b++] = f[g++];
    for (; _ < u.length; )
      o[b++] = u[_++];
...
(function(e) {
  ...
  e.number = s;
  function c(l, W, et) {
    return n.call(l) === "[object Number]" && W <= l && l <= et;
  }
  e.numberRange = c;
  function f(l) {
  ...
  e.objectLiteral = _;
  function b(l, W) {
    return Array.isArray(l) && l.every(W);
  }
  e.typedArray = b;
})(a || (a = {}));
var ht = class {
...
var mt = class {
  ...
  provideCompletionItems(e, n, i, r) {
    ...
    return this._worker(t).then((o) => o.doComplete(t.toString(), k(n))).then((o) => {
      if (!o)
        return;
      const s = e.getWordUntilPosition(n), c = new d.Range(
        n.lineNumber,
        s.startColumn,
        n.lineNumber,
        s.endColumn
        ...
        const g = {
          ...
          detail: u.detail,
          command: wt(u.command),
          range: c,
          kind: bt(u.kind)
        };
        return u.textEdit && (_t(u.textEdit) ? g.range = {
          insert: m(u.textEdit.insert),
          replace: m(u.textEdit.replace)
        } : g.range = m(u.textEdit.range), g.insertText = u.textEdit.newText), u.additionalTextEdits && (g.additionalTextEdits = u.additionalTextEdits.map(y)), u.insertTextFormat === G.Snippet && (g.insertTextRules = d.languages.CompletionItemInsertTextRule.InsertAsSnippet), g;
      });
      return {
...
var Rt = class {
  ...
  provideRenameEdits(e, n, i, r) {
    const t = e.uri;
    return this._worker(t).then((o) => o.doRename(t.toString(), k(n), i)).then((o) => yt(o));
  }
};
function yt(e) {
  if (!e || !e.changes)
...
var Ot = class {
  ...
  provideDocumentFormattingEdits(e, n, i) {
    const r = e.uri;
    return this._worker(r).then((t) => t.format(r.toString(), null, Ze(n)).then((o) => {
      if (!(!o || o.length === 0))
        return o.map(y);
    }));
  }
  ...
  provideDocumentRangeFormattingEdits(e, n, i, r) {
    const t = e.uri;
    return this._worker(t).then((o) => o.format(t.toString(), Ge(n), Ze(i)).then((s) => {
      if (!(!s || s.length === 0))
        return s.map(y);
    }));
  }
...
var jt = class {
  ...
  provideColorPresentations(e, n, i) {
    ...
    return this._worker(r).then(
      (t) => t.getColorPresentations(r.toString(), n.color, Ge(n.range))
    ).then((t) => {
      if (t)
        return t.map((o) => {
          let s = {
          ...
          return o.textEdit && (s.textEdit = y(o.textEdit)), o.additionalTextEdits && (s.additionalTextEdits = o.additionalTextEdits.map(y)), s;
        });
    });
  }
}, Ut = class {
    ...
    return this._worker(r).then((t) => t.getFoldingRanges(r.toString(), n)).then((t) => {
      if (t)
        return t.map((o) => {
          ...
          return typeof o.kind < "u" && (s.kind = Wt(o.kind)), s;
        });
    });
  }
};
...
function Vt(e) {
  ...
  function o() {
    ...
    Ke(i), c.completionItems && i.push(
      ...
      d.languages.registerRenameProvider(s, new Pt(t))
    ), c.colors && i.push(
    ...
    ), c.diagnostics && i.push(
      new ht(s, t, e.onDidChange)
...
export {
  mt as CompletionAdapter,
  At as DefinitionAdapter,
  ht as DiagnosticsAdapter,
  jt as DocumentColorAdapter,
  Ct as DocumentFormattingEditProvider,
  It as DocumentHighlightAdapter,
  Ot as DocumentLinkAdapter,
  Ft as DocumentRangeFormattingEditProvider,
  Mt as DocumentSymbolAdapter,
  Ut as FoldingRangeAdapter,
  kt as HoverAdapter,
  Rt as ReferenceAdapter,
  Pt as RenameAdapter,
  Nt as SelectionRangeAdapter,
  ft as WorkerManager,
  k as fromPosition,
  Ge as fromRange,
  Vt as setupMode,
...
//# sourceMappingURL=cssMode-CiQtOtuw.js.map
