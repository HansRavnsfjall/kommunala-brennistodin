import { t as O, m as I } from "./index-CVakL7U_.js";
/*!-----------------------------------------------------------------------------
 ...
 *-----------------------------------------------------------------------------*/
var M = Object.defineProperty, N = Object.getOwnPropertyDescriptor, R = Object.getOwnPropertyNames, E = Object.prototype.hasOwnProperty, K = (e, t, r, a) => {
  if (t && typeof t == "object" || typeof t == "function")
    for (let n of R(t))
      !E.call(e, n) && n !== r && M(e, n, { get: () => t[n], enumerable: !(a = N(t, n)) || a.enumerable });
  return e;
}, H = (e, t, r) => (K(e, t, "default"), r), o = {};
H(o, I);
function W(e, t) {
...
var C;
typeof self == "object" && self.constructor && self.constructor.name === "DedicatedWorkerGlobalScope" && globalThis.workerttPolicy !== void 0 ? C = globalThis.workerttPolicy : C = W("defaultWorkerFactory", {
  createScriptURL: (e) => e
});
function j(e) {
...
var U = class {
  ...
  _getClient() {
    return this._client || (this._client = (async () => (this._worker = V({
      label: this._modeId,
      keepIdleModels: !0,
  ...
  constructor(e, t, r, a) {
    ...
    const n = (s) => {
      ...
      const d = s.onDidChangeContent(() => {
        ...
        const { onlyVisible: f } = this._defaults.getDiagnosticsOptions();
        f && (s.isAttachedToEditor() ? c() : o.editor.setModelMarkers(s, this._selector, []));
      });
...
`)
    ...
    return !d || t.isDisposed() ? void 0 : {
      suggestions: d.entries.map((f) => {
        ...
        if (f.replacementSpan) {
          ...
          w = new o.Range(k.lineNumber, k.column, v.lineNumber, v.column);
        }
        const S = [];
        return f.kindModifiers !== void 0 && f.kindModifiers.indexOf("deprecated") !== -1 && S.push(o.languages.CompletionItemTag.Deprecated), {
          uri: s,
          position: r,
          offset: c,
          range: w,
  ...
  async resolveCompletionItem(t, r) {
    ...
    return c ? {
      ...
      position: l,
      label: c.name,
      kind: x.convertKind(c.kind),
      detail: y(c.displayParts),
      documentation: {
        value: x.createDocumentationString(c)
      }
    } : a;
  }
...
var G = class P extends m {
  ...
  async provideSignatureHelp(t, r, a, n) {
    ...
    return c.items.forEach((d) => {
      ...
      }, h.label += y(d.prefixDisplayParts), d.parameters.forEach((f, w, S) => {
        const k = y(f.displayParts), v = {
          label: k,
          documentation: {
            value: y(f.documentation)
          }
        };
        h.label += k, h.parameters.push(v), w < S.length - 1 && (h.label += y(d.separatorDisplayParts));
      }), h.label += y(d.suffixDisplayParts), g.signatures.push(h);
    }), {
      value: g,
      dispose() {
      }
  ...
  async provideHover(e, t, r) {
    ...
    if (!u || e.isDisposed())
      return;
    const s = y(u.documentation), c = u.tags ? u.tags.map((d) => F(d)).join(`  
...
` + c : "")
  ...
  async provideDocumentSymbols(e, t) {
    ...
    const l = (s, c) => ({
      name: s.text,
      detail: "",
      kind: b[s.kind] || o.languages.SymbolKind.Variable,
...
b[p.module] = o.languages.SymbolKind.Module;
b[p.class] = o.languages.SymbolKind.Class;
b[p.enum] = o.languages.SymbolKind.Enum;
b[p.interface] = o.languages.SymbolKind.Interface;
b[p.memberFunction] = o.languages.SymbolKind.Method;
b[p.memberVariable] = o.languages.SymbolKind.Property;
b[p.memberGetAccessor] = o.languages.SymbolKind.Property;
b[p.memberSetAccessor] = o.languages.SymbolKind.Property;
b[p.variable] = o.languages.SymbolKind.Variable;
b[p.const] = o.languages.SymbolKind.Variable;
b[p.localVariable] = o.languages.SymbolKind.Variable;
b[p.variable] = o.languages.SymbolKind.Variable;
b[p.function] = o.languages.SymbolKind.Function;
b[p.localFunction] = o.languages.SymbolKind.Function;
...
`];
  ...
  async provideCodeActions(e, t, r, a) {
    const n = e.uri, l = e.getOffsetAt({
      ...
      lineNumber: t.endLineNumber,
      column: t.endColumn
    }), s = _._convertOptions(e.getOptions()), c = r.markers.filter((f) => f.code).map((f) => f.code).map(Number), g = await this._worker(n);
    if (e.isDisposed())
      return;
    ...
    return !d || e.isDisposed() ? { actions: [], dispose: () => {
      ...
      actions: d.filter((f) => f.changes.filter((w) => w.isNewFile).length === 0).map((f) => this._tsCodeFixActionToMonacoCodeAction(e, r, f)),
      dispose: () => {
      }
    };
  }
...
function L(e, t) {
  const r = [], a = new U(t, e), n = (...s) => a.getLanguageServiceWorker(...s), l = new B(n);
  function u() {
    const { modeConfiguration: s } = e;
    ie(r), s.completionItems && r.push(
      ...
      o.languages.registerHoverProvider(t, new J(n))
      ...
      o.languages.registerCodeActionProvider(t, new te(n))
    ), s.inlayHints && r.push(
      o.languages.registerInlayHintsProvider(t, new se(n))
    ), s.diagnostics && r.push(new $(l, e, t, n));
  }
  return u(), n;
}
function ie(e) {
...
export {
  m as Adapter,
  te as CodeActionAdaptor,
  q as DefinitionAdapter,
  $ as DiagnosticsAdapter,
  Q as DocumentHighlightAdapter,
  Z as FormatAdapter,
  _ as FormatHelper,
  ee as FormatOnTypeAdapter,
  se as InlayHintsAdapter,
  p as Kind,
  B as LibFiles,
  X as OutlineAdapter,
  J as QuickInfoAdapter,
  Y as ReferenceAdapter,
  re as RenameAdapter,
  G as SignatureHelpAdapter,
  z as SuggestAdapter,
  U as WorkerManager,
  D as flattenDiagnosticMessageText,
  ce as getJavaScriptWorker,
  le as getTypeScriptWorker,
  ae as setupJavaScript,
  oe as setupTypeScript
};
//# sourceMappingURL=tsMode-6SFTzXmK.js.map
