 ...
 */
const Gr = globalThis, $n = Gr.ShadowRoot && (Gr.ShadyCSS === void 0 || Gr.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, kn = Symbol(), sa = /* @__PURE__ */ new WeakMap();
let pl = class {
  constructor(t, i, o) {
  ...
  get styleSheet() {
    ...
    if ($n && t === void 0) {
      ...
      o && (t = sa.get(i)), t === void 0 && ((this.o = t = new CSSStyleSheet()).replaceSync(this.cssText), o && sa.set(i, t));
    }
    return t;
  }
  toString() {
...
const wt = (e) => new pl(typeof e == "string" ? e : e + "", void 0, kn), p = (e, ...t) => {
  const i = e.length === 1 ? e[0] : t.reduce(((o, r, s) => o + ((n) => {
    if (n._$cssResult$ === !0) return n.cssText;
    if (typeof n == "number") return n;
    throw Error("Value passed to 'css' function must be a 'css' function result: " + n + ". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.");
  })(r) + e[s + 1]), e[0]);
  return new pl(i, e, kn);
}, lc = (e, t) => {
  if ($n) e.adoptedStyleSheets = t.map(((i) => i instanceof CSSStyleSheet ? i : i.styleSheet));
  else for (const i of t) {
    const o = document.createElement("style"), r = Gr.litNonce;
    r !== void 0 && o.setAttribute("nonce", r), o.textContent = i.cssText, e.appendChild(o);
  }
}, na = $n ? (e) => e : (e) => e instanceof CSSStyleSheet ? ((t) => {
  let i = "";
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: uc, defineProperty: cc, getOwnPropertyDescriptor: hc, getOwnPropertyNames: dc, getOwnPropertySymbols: pc, getPrototypeOf: vc } = Object, Fo = globalThis, aa = Fo.trustedTypes, fc = aa ? aa.emptyScript : "", bc = Fo.reactiveElementPolyfillSupport, Zi = (e, t) => e, lo = { toAttribute(e, t) {
  switch (t) {
    case Boolean:
      e = e ? fc : null;
      break;
  ...
  return i;
} }, Cn = (e, t) => !uc(e, t), la = { attribute: !0, type: String, converter: lo, reflect: !1, useDefault: !1, hasChanged: Cn };
Symbol.metadata ??= Symbol("metadata"), Fo.litPropertyMetadata ??= /* @__PURE__ */ new WeakMap();
let Yt = class extends HTMLElement {
  ...
  static finalize() {
    ...
    if (this.finalized = !0, this._$Ei(), this.hasOwnProperty(Zi("properties"))) {
      const i = this.properties, o = [...dc(i), ...pc(i)];
  ...
  static finalizeStyles(t) {
    ...
    if (Array.isArray(t)) {
      ...
      for (const r of o) i.unshift(na(r));
    } else t !== void 0 && i.push(na(t));
    return i;
  }
  static _$Eu(t, i) {
    const o = i.attribute;
  ...
  createRenderRoot() {
    ...
    return lc(t, this.constructor.elementStyles), t;
  }
  connectedCallback() {
  ...
  _$ET(t, i) {
    ...
    if (r !== void 0 && o.reflect === !0) {
      const s = (o.converter?.toAttribute !== void 0 ? o.converter : lo).toAttribute(i, o.type);
  ...
  _$AK(t, i) {
    ...
    if (r !== void 0 && this._$Em !== r) {
      const s = o.getPropertyOptions(r), n = typeof s.converter == "function" ? { fromAttribute: s.converter } : s.converter?.fromAttribute !== void 0 ? s.converter : lo;
      this._$Em = r;
      const u = n.fromAttribute(i, s.type);
  ...
  requestUpdate(t, i, o) {
    if (t !== void 0) {
      ...
      if (o ??= r.getPropertyOptions(t), !((o.hasChanged ?? Cn)(s, i) || o.useDefault && o.reflect && s === this._$Ej?.get(t) && !this.hasAttribute(r._$Eu(t, o)))) return;
      this.C(t, i, o);
    }
...
Yt.elementStyles = [], Yt.shadowRootOptions = { mode: "open" }, Yt[Zi("elementProperties")] = /* @__PURE__ */ new Map(), Yt[Zi("finalized")] = /* @__PURE__ */ new Map(), bc?.({ ReactiveElement: Yt }), (Fo.reactiveElementVersions ??= []).push("2.1.1");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const En = globalThis, uo = En.trustedTypes, ua = uo ? uo.createPolicy("lit-html", { createHTML: (e) => e }) : void 0, vl = "$lit$", at = `lit$${Math.random().toFixed(9).slice(2)}$`, fl = "?" + at, gc = `<${fl}>`, Mt = document, ar = () => Mt.createComment(""), lr = (e) => e === null || typeof e != "object" && typeof e != "function", Pn = Array.isArray, mc = (e) => Pn(e) || typeof e?.[Symbol.iterator] == "function", cs = `[ 	
\f\r]`, Vi = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, ca = /-->/g, ha = />/g, Et = RegExp(`>|${cs}(?:([^\\s"'>=/]+)(${cs}*=${cs}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), da = /'/g, pa = /"/g, bl = /^(?:script|style|textarea|title)$/i, gl = (e) => (t, ...i) => ({ _$litType$: e, strings: t, values: i }), l = gl(1), b = gl(2), se = Symbol.for("lit-noChange"), k = Symbol.for("lit-nothing"), va = /* @__PURE__ */ new WeakMap(), Ut = Mt.createTreeWalker(Mt, 129);
function ml(e, t) {
  if (!Pn(e) || !e.hasOwnProperty("raw")) throw Error("invalid template strings array");
  return ua !== void 0 ? ua.createHTML(t) : t;
}
const _c = (e, t) => {
  ...
  for (let u = 0; u < i; u++) {
    const c = e[u];
    let h, m, f = -1, C = 0;
    for (; C < c.length && (n.lastIndex = C, m = n.exec(c), m !== null); ) C = n.lastIndex, n === Vi ? m[1] === "!--" ? n = ca : m[1] !== void 0 ? n = ha : m[2] !== void 0 ? (bl.test(m[2]) && (r = RegExp("</" + m[2], "g")), n = Et) : m[3] !== void 0 && (n = Et) : n === Et ? m[0] === ">" ? (n = r ?? Vi, f = -1) : m[1] === void 0 ? f = -2 : (f = n.lastIndex - m[2].length, h = m[1], n = m[3] === void 0 ? Et : m[3] === '"' ? pa : da) : n === pa || n === da ? n = Et : n === ca || n === ha ? n = Vi : (n = Et, r = void 0);
    const x = n === Et && e[u + 1].startsWith("/>") ? " " : "";
    s += n === Vi ? c + gc : f >= 0 ? (o.push(h), c.slice(0, f) + vl + c.slice(f) + at + x) : c + at + (f === -2 ? u : x);
  }
...
let Is = class _l {
  constructor({ strings: t, _$litType$: i }, o) {
    ...
    this.parts = [];
    let s = 0, n = 0;
    const u = t.length - 1, c = this.parts, [h, m] = _c(t, i);
    if (this.el = _l.createElement(h, o), Ut.currentNode = this.el.content, i === 2 || i === 3) {
      const f = this.el.content.firstChild;
      f.replaceWith(...f.childNodes);
    }
    for (; (r = Ut.nextNode()) !== null && c.length < u; ) {
      if (r.nodeType === 1) {
        if (r.hasAttributes()) for (const f of r.getAttributeNames()) if (f.endsWith(vl)) {
          const C = m[n++], x = r.getAttribute(f).split(at), O = /([.?@])?(.*)/.exec(C);
          c.push({ type: 1, index: s, name: O[2], strings: x, ctor: O[1] === "." ? wc : O[1] === "?" ? xc : O[1] === "@" ? $c : Wo }), r.removeAttribute(f);
        ...
        if (bl.test(r.tagName)) {
          ...
          if (C > 0) {
            r.textContent = uo ? uo.emptyScript : "";
            for (let x = 0; x < C; x++) r.append(f[x], ar()), Ut.nextNode(), c.push({ type: 2, index: ++s });
            r.append(f[C], ar());
          }
        }
...
function ui(e, t, i = e, o) {
  if (t === se) return t;
  let r = o !== void 0 ? i._$Co?.[o] : i._$Cl;
  const s = lr(t) ? void 0 : t._$litDirective$;
  return r?.constructor !== s && (r?._$AO?.(!1), s === void 0 ? r = void 0 : (r = new s(e), r._$AT(e, i, o)), o !== void 0 ? (i._$Co ??= [])[o] = r : i._$Cl = r), r !== void 0 && (t = ui(e, r._$AS(e, t.values), r, o)), t;
}
let yc = class {
  constructor(t, i) {
  ...
  u(t) {
    ...
    Ut.currentNode = r;
    let s = Ut.nextNode(), n = 0, u = 0, c = o[0];
    for (; c !== void 0; ) {
      if (n === c.index) {
        let h;
        c.type === 2 ? h = new xi(s, s.nextSibling, this, t) : c.type === 1 ? h = new c.ctor(s, c.name, c.strings, this, t) : c.type === 6 && (h = new kc(s, this, t)), this._$AV.push(h), c = o[++u];
      }
      n !== c?.index && (s = Ut.nextNode(), n++);
    }
    return Ut.currentNode = Mt, r;
  }
  p(t) {
    let i = 0;
...
class xi {
  ...
  _$AI(t, i = this) {
    t = ui(this, t, i), lr(t) ? t === k || t == null || t === "" ? (this._$AH !== k && this._$AR(), this._$AH = k) : t !== this._$AH && t !== se && this._(t) : t._$litType$ !== void 0 ? this.$(t) : t.nodeType !== void 0 ? this.T(t) : mc(t) ? this.k(t) : this._(t);
  }
  O(t) {
  ...
  _(t) {
    this._$AH !== k && lr(this._$AH) ? this._$AA.nextSibling.data = t : this.T(Mt.createTextNode(t)), this._$AH = t;
  }
  $(t) {
    ...
    if (this._$AH?._$AD === r) this._$AH.p(i);
      ...
      const s = new yc(r, this), n = s.u(this.options);
      s.p(i), this.T(n), this._$AH = s;
    }
  }
  _$AC(t) {
    let i = va.get(t.strings);
    return i === void 0 && va.set(t.strings, i = new Is(t)), i;
  }
  k(t) {
    Pn(this._$AH) || (this._$AH = [], this._$AR());
    const i = this._$AH;
    let o, r = 0;
    for (const s of t) r === i.length ? i.push(o = new xi(this.O(ar()), this.O(ar()), this, this.options)) : o = i[r], o._$AI(s), r++;
...
let Wo = class {
  ...
  _$AI(t, i = this, o, r) {
    ...
    let n = !1;
    if (s === void 0) t = ui(this, t, i, 0), n = !lr(t) || t !== this._$AH && t !== se, n && (this._$AH = t);
    else {
      const u = t;
      let c, h;
      for (t = s[0], c = 0; c < s.length - 1; c++) h = ui(this, u[o + c], i, c), h === se && (h = this._$AH[c]), n ||= !lr(h) || h !== this._$AH[c], h === k ? t = k : t !== k && (t += (h ?? "") + s[c + 1]), this._$AH[c] = h;
    }
    n && !r && this.j(t);
  }
  j(t) {
...
class $c extends Wo {
  ...
  _$AI(t, i = this) {
    if ((t = ui(this, t, i, 0) ?? k) === se) return;
...
const Cc = { I: xi }, Ec = En.litHtmlPolyfillSupport;
Ec?.(Is, xi), (En.litHtmlVersions ??= []).push("3.3.1");
const Pc = (e, t, i) => {
  const o = i?.renderBefore ?? t;
  let r = o._$litPart$;
  if (r === void 0) {
    const s = i?.renderBefore ?? null;
    o._$litPart$ = r = new xi(t.insertBefore(ar(), s), s, void 0, i ?? {});
  }
  return r._$AI(e), r;
};
/**
...
let v = class extends Yt {
  ...
  update(t) {
    const i = this.render();
    this.hasUpdated || (this.renderOptions.isConnected = this.isConnected), super.update(t), this._$Do = Pc(i, this.renderRoot, this.renderOptions);
  }
  connectedCallback() {
...
v._$litElement$ = !0, v.finalized = !0, Sn.litElementHydrateSupport?.({ LitElement: v });
const Sc = Sn.litElementPolyfillSupport;
Sc?.({ LitElement: v });
(Sn.litElementVersions ??= []).push("4.2.1");
var Oc = `.uui-h1,
.uui-h2,
.uui-h3,
.uui-h4,
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Ic = { attribute: !0, type: String, converter: lo, reflect: !1, hasChanged: Cn }, Ac = (e = Ic, t, i) => {
...
function a(e) {
  return (t, i) => typeof i == "object" ? Ac(e, t, i) : ((o, r, s) => {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const On = (e, t, i) => (i.configurable = !0, i.enumerable = !0, Reflect.decorate && typeof t != "object" && Object.defineProperty(e, t, i), i);
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
let Uc;
function zc(e) {
  return (t, i) => On(t, i, { get() {
    return (this.renderRoot ?? (Uc ??= document.createDocumentFragment())).querySelectorAll(e);
  } });
}
/**
 * @license
...
`, fg = wt("uui-blink 0.9s infinite both"), bg = p`
  @keyframes pulse {
    0% {
...
var Dc = Object.defineProperty, Mc = (e, t, i, o) => {
...
var Lc = Object.defineProperty, fa = (e, t, i, o) => {
  for (var r = void 0, s = e.length - 1, n; s >= 0; s--)
    (n = e[s]) && (r = n(t, i, r) || r);
  return r && Lc(t, i, r), r;
};
const kg = (e, t) => {
  ...
  return fa([
    a({ type: String })
  ], i.prototype, "label"), fa([
    g()
  ], i.prototype, "_labelSlotHasContent"), i;
};
var Tc = Object.defineProperty, Nc = Object.getOwnPropertyDescriptor, ba = (e, t, i, o) => {
  for (var r = o > 1 ? void 0 : o ? Nc(t, i) : t, s = e.length - 1, n; s >= 0; s--)
    (n = e[s]) && (r = (o ? n(t, i, r) : n(r)) || r);
  return o && r && Tc(t, i, r), r;
};
const Cg = (e) => {
  class t extends e {
    constructor(...o) {
    ...
    #r() {
      ...
      const o = new Ir(Ir.SELECTED);
      this.dispatchEvent(o), !o.defaultPrevented && (this.selected = !0);
    }
    #s() {
      if (!this.deselectable) return;
      const o = new Ir(Ir.DESELECTED);
      this.dispatchEvent(o), !o.defaultPrevented && (this.selected = !1);
    }
  }
  return ba([
    a({ type: Boolean, reflect: !0 })
  ], t.prototype, "selectable", 1), ba([
    a({ type: Boolean, reflect: !0 })
  ], t.prototype, "selected", 2), t;
};
var Vc = Object.defineProperty, Bc = Object.getOwnPropertyDescriptor, Hc = (e, t, i, o) => {
  for (var r = Bc(t, i), s = e.length - 1, n; s >= 0; s--)
    (n = e[s]) && (r = n(t, i, r) || r);
  return r && Vc(t, i, r), r;
};
const Eg = (e) => {
...
var jc = Object.defineProperty, Rc = Object.getOwnPropertyDescriptor, Pt = (e, t, i, o) => {
  for (var r = o > 1 ? void 0 : o ? Rc(t, i) : t, s = e.length - 1, n; s >= 0; s--)
    (n = e[s]) && (r = (o ? n(t, i, r) : n(r)) || r);
...
const Ig = (e, t, i = `This element has to be present for ${e.nodeName} to work appropriate.`) => {
...
}, Ug = (e, t, i) => Math.min(Math.max(e, t), i), zg = (e, t, i) => i + t - e, Dg = (e) => {
...
var Gc = Object.defineProperty, qc = (e, t, i, o) => {
  for (var r = void 0, s = e.length - 1, n; s >= 0; s--)
    (n = e[s]) && (r = n(t, i, r) || r);
  return r && Gc(t, i, r), r;
};
...
var Kc = Object.getOwnPropertyDescriptor, Xc = (e, t, i, o) => {
  for (var r = o > 1 ? void 0 : o ? Kc(t, i) : t, s = e.length - 1, n; s >= 0; s--)
    (n = e[s]) && (r = n(r) || r);
  return r;
};
let ur = class extends v {
  render() {
    return l`<slot></slot>`;
  }
};
...
var Yc = Object.getOwnPropertyDescriptor, Zc = (e, t, i, o) => {
  for (var r = o > 1 ? void 0 : o ? Yc(t, i) : t, s = e.length - 1, n; s >= 0; s--)
    (n = e[s]) && (r = n(r) || r);
  return r;
};
let As = class extends ur {
};
As.styles = [
  ...ur.styles,
  p`
...
var Qc = Object.defineProperty, Jc = Object.getOwnPropertyDescriptor, Go = (e, t, i, o) => {
...
], ci.prototype, "_avatarNodes", 2);
Go([
  g()
], ci.prototype, "_avatarArray", 2);
Go([
  a({ type: Number, attribute: !0 })
], ci.prototype, "limit", 2);
ci = Go([
  d("uui-avatar-group")
], ci);
var eh = Object.defineProperty, th = Object.getOwnPropertyDescriptor, $i = (e, t, i, o) => {
  for (var r = o > 1 ? void 0 : o ? th(t, i) : t, s = e.length - 1, n; s >= 0; s--)
    (n = e[s]) && (r = (o ? n(t, i, r) : n(r)) || r);
  return o && r && eh(t, i, r), r;
};
...
], ct.prototype, "overflow", 2);
$i([
  a({ type: String, attribute: "img-src" })
], ct.prototype, "imgSrc", 2);
$i([
  a({ type: String, attribute: "img-srcset" })
], ct.prototype, "imgSrcset", 2);
$i([
  a({ type: String, reflect: !0 })
], ct.prototype, "name", 2);
$i([
  a({ type: String })
], ct.prototype, "initials", 2);
ct = $i([
  d("uui-avatar")
], ct);
var ih = Object.defineProperty, rh = Object.getOwnPropertyDescriptor, qo = (e, t, i, o) => {
  for (var r = o > 1 ? void 0 : o ? rh(t, i) : t, s = e.length - 1, n; s >= 0; s--)
    (n = e[s]) && (r = (o ? n(t, i, r) : n(r)) || r);
  return o && r && ih(t, i, r), r;
};
...
qo([
  a({ type: Boolean, reflect: !0 })
], hi.prototype, "attention", 2);
hi = qo([
  d("uui-badge")
], hi);
var oh = Object.defineProperty, sh = (e, t, i, o) => {
  for (var r = void 0, s = e.length - 1, n; s >= 0; s--)
    (n = e[s]) && (r = n(t, i, r) || r);
  return r && oh(t, i, r), r;
};
...
var nh = Object.defineProperty, ga = (e, t, i, o) => {
  for (var r = void 0, s = e.length - 1, n; s >= 0; s--)
    (n = e[s]) && (r = n(t, i, r) || r);
  return r && nh(t, i, r), r;
};
...
var lh = Object.defineProperty, uh = Object.getOwnPropertyDescriptor, ma = (e, t, i, o) => {
  for (var r = o > 1 ? void 0 : o ? uh(t, i) : t, s = e.length - 1, n; s >= 0; s--)
    (n = e[s]) && (r = (o ? n(t, i, r) : n(r)) || r);
  return o && r && lh(t, i, r), r;
};
const ki = (e) => {
  class t extends e {
    constructor(...o) {
    ...
    #r() {
      if (!this.selectable) return;
      const o = new Ar(Ar.SELECTED);
      this.dispatchEvent(o), !o.defaultPrevented && (this.selected = !0);
    }
    #s() {
      if (!this.deselectable) return;
      const o = new Ar(Ar.DESELECTED);
      this.dispatchEvent(o), !o.defaultPrevented && (this.selected = !1);
    }
  }
  return ma([
    a({ type: Boolean, reflect: !0 })
  ], t.prototype, "selectable", 1), ma([
    a({ type: Boolean, reflect: !0 })
  ], t.prototype, "selected", 2), t;
};
var ch = Object.defineProperty, hh = Object.getOwnPropertyDescriptor, dh = (e, t, i, o) => {
  for (var r = hh(t, i), s = e.length - 1, n; s >= 0; s--)
    (n = e[s]) && (r = n(t, i, r) || r);
  return r && ch(t, i, r), r;
};
const Ko = (e) => {
...
var ph = Object.defineProperty, vh = Object.getOwnPropertyDescriptor, St = (e, t, i, o) => {
  for (var r = o > 1 ? void 0 : o ? vh(t, i) : t, s = e.length - 1, n; s >= 0; s--)
    (n = e[s]) && (r = (o ? n(t, i, r) : n(r)) || r);
...
const fh = [
  ...
  class i extends e {
     ...
     */
    addFormControlElement(r) {
      this.#r.push(r), r.addEventListener(qt.INVALID, () => {
        this._runValidators();
      }), r.addEventListener(qt.VALID, () => {
        this._runValidators();
      }), this._pristine === !1 && (r.checkValidity(), this._runValidators());
    }
    /**
    ...
    #a() {
      this._pristine !== !0 && (this.#e.valid ? this.dispatchEvent(new qt(qt.VALID)) : this.dispatchEvent(
        new qt(qt.INVALID)
      ));
    }
    updated(r) {
  ...
  return St([
    a({ type: String })
  ], i.prototype, "name", 2), St([
    a()
  ], i.prototype, "value", 1), St([
    a({ type: Boolean, reflect: !0, attribute: "pristine" })
  ], i.prototype, "pristine", 1), St([
    a({ type: Boolean, reflect: !0 })
  ], i.prototype, "required", 2), St([
    a({ type: String, attribute: "required-message" })
  ], i.prototype, "requiredMessage", 2), St([
    a({ type: Boolean, reflect: !0 })
  ], i.prototype, "error", 2), St([
    a({ type: String, attribute: "error-message" })
  ], i.prototype, "errorMessage", 2), i;
}, bh = (e, t, i) => {
  let o = e;
...
var gh = Object.defineProperty, mh = (e, t, i, o) => {
  for (var r = void 0, s = e.length - 1, n; s >= 0; s--)
    (n = e[s]) && (r = n(t, i, r) || r);
  return r && gh(t, i, r), r;
};
...
var yh = Object.defineProperty, wh = Object.getOwnPropertyDescriptor, Ci = (e, t, i, o) => {
  for (var r = o > 1 ? void 0 : o ? wh(t, i) : t, s = e.length - 1, n; s >= 0; s--)
    (n = e[s]) && (r = (o ? n(t, i, r) : n(r)) || r);
...
class Te extends Le(
  ...
  _onInputChange(t) {
    t.stopPropagation(), this.pristine = !1, this.checked = this._input.checked, this.indeterminate = this._input.indeterminate, this.dispatchEvent(new _a(_a.CHANGE));
  }
  render() {
    return l`
      <label>
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const xl = Symbol.for(""), xh = (e) => {
  if (e?.r === xl) return e?._$litStatic$;
}, ya = (e) => ({ _$litStatic$: e, r: xl }), wa = /* @__PURE__ */ new Map(), $h = (e) => (t, ...i) => {
  const o = i.length;
  let r, s;
  const n = [], u = [];
  let c, h = 0, m = !1;
  for (; h < o; ) {
    for (c = t[h]; h < o && (s = i[h], (r = xh(s)) !== void 0); ) c += r + t[++h], m = !0;
    h !== o && u.push(s), n.push(c), h++;
  }
  if (h === o && n.push(t[o]), m) {
    const f = n.join("$$lit$$");
    (t = wa.get(f)) === void 0 && (n.raw = n, wa.set(f, t = n)), i = u;
  }
  return e(t, ...i);
}, xa = $h(l);
var kh = Object.defineProperty, Ch = Object.getOwnPropertyDescriptor, Vt = (e, t, i, o) => {
  for (var r = o > 1 ? void 0 : o ? Ch(t, i) : t, s = e.length - 1, n; s >= 0; s--)
    (n = e[s]) && (r = (o ? n(t, i, r) : n(r)) || r);
...
let Ye = class extends v {
  constructor() {
    super(...arguments), this.headline = null, this._headlineVariantTag = "h5", this._headlineSlotHasContent = !1, this._headlineSlotChanged = (e) => {
      this._headlineSlotHasContent = hs(e.target);
    }, this._headerSlotHasContent = !1, this._headerSlotChanged = (e) => {
      this._headerSlotHasContent = hs(e.target);
    }, this._headerActionsSlotHasContent = !1, this._headerActionsSlotChanged = (e) => {
      this._headerActionsSlotHasContent = hs(e.target);
    };
  }
...
var Eh = Object.defineProperty, Ph = Object.getOwnPropertyDescriptor, In = (e, t, i, o) => {
...
], di.prototype, "lastItem", 2);
di = In([
  d("uui-breadcrumb-item")
], di);
var Sh = Object.defineProperty, Oh = Object.getOwnPropertyDescriptor, $l = (e, t, i, o) => {
  for (var r = o > 1 ? void 0 : o ? Oh(t, i) : t, s = e.length - 1, n; s >= 0; s--)
    (n = e[s]) && (r = (o ? n(t, i, r) : n(r)) || r);
  return o && r && Sh(t, i, r), r;
};
...
`, Ah = wt("uui-blink 0.9s infinite both"), Uh = p`
  @keyframes pulse {
    0% {
      -webkit-transform: translate(-50%, -50%) scale(0.2);
      transform: translate(-50%, -50%) scale(0.2);
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const ye = { ATTRIBUTE: 1, CHILD: 2, PROPERTY: 3, BOOLEAN_ATTRIBUTE: 4 }, Ei = (e) => (...t) => ({ _$litDirective$: e, values: t });
let Pi = class {
  constructor(t) {
  }
  get _$AU() {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const kl = "important", zh = " !" + kl, Ze = Ei(class extends Pi {
  constructor(e) {
  ...
  update(e, [t]) {
    ...
    for (const o in t) {
      ...
      if (r != null) {
        this.ft.add(o);
        const s = typeof r == "string" && r.endsWith(zh);
...
var Dh = Object.defineProperty, Mh = Object.getOwnPropertyDescriptor, Cl = (e) => {
  throw TypeError(e);
}, Bt = (e, t, i, o) => {
  for (var r = o > 1 ? void 0 : o ? Mh(t, i) : t, s = e.length - 1, n; s >= 0; s--)
    (n = e[s]) && (r = (o ? n(t, i, r) : n(r)) || r);
  return o && r && Dh(t, i, r), r;
}, Lh = (e, t, i) => t.has(e) || Cl("Cannot " + i), Th = (e, t, i) => t.has(e) ? Cl("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, i), ho = (e, t, i) => (Lh(e, t, "access private method"), i), ri, An, El, Pl;
let Qe = class extends v {
  constructor() {
    super(...arguments), Th(this, ri), this._position = 0, this.vertical = !1;
  }
  _onMouseMove(e) {
  ...
  render() {
    return this.href ? ho(this, ri, El).call(this) : ho(this, ri, Pl).call(this);
  }
};
...
const y = (e, t, i = `This element has to be present for ${e.nodeName} to work appropriate.`) => {
  ...
  document.addEventListener("pointermove", i, { passive: !0 }), document.addEventListener("pointerup", o), t?.initialEvent && i(t.initialEvent);
}, A = (e, t, i) => Math.min(Math.max(e, t), i), ka = (e, t, i) => i + t - e, Vh = (e, t, i) => {
  let o = e;
  for (; o !== null; ) {
    const r = o instanceof HTMLElement && o.hasAttribute(t) && o.getAttribute(t) === i, s = o.querySelector(`[${t}="${i}"]`) !== null;
    if (r)
...
const Zo = b`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12" /></svg>`;
...
const jh = b`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"><rect width="18" height="11" x="3" y="11" rx="2" ry="2" /><path d="M7 11V7a5 5 0 0 1 10 0v4" /></svg>`;
...
const Rh = b`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"><rect width="18" height="18" x="3" y="3" rx="2" ry="2" /><circle cx="9" cy="9" r="2" /><path d="m21 15-3.086-3.086a2 2 0 0 0-2.828 0L6 21" /></svg>`;
...
const Un = b`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"><path d="M18 6 6 18" /><path d="m6 6 12 12" /></svg>`;
...
const Fh = b`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"><path d="M2 12s3-7 10-7 10 7 10 7-3 7-10 7-10-7-10-7Z" /><circle cx="12" cy="12" r="3" /></svg>`;
...
const Wh = b`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12h14" /></svg>`;
...
const Gh = b`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"><rect width="18" height="11" x="3" y="11" rx="2" ry="2" /><path d="M7 11V7a5 5 0 0 1 9.9-1" /></svg>`, qh = b`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"><path d="M9.88 9.88a3 3 0 1 0 4.24 4.24" /><path d="M10.73 5.08A10.43 10.43 0 0 1 12 5c7 0 10 7 10 7a13.16 13.16 0 0 1-1.67 2.68" /><path d="M6.61 6.61A13.526 13.526 0 0 0 2 12s3 7 10 7a9.74 9.74 0 0 0 5.39-1.61" /><line x1="2" x2="22" y1="2" y2="22" /></svg>`;
...
const Kh = b`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10" /><path d="m15 9-6 6" /><path d="m9 9 6 6" /></svg>`;
var Xh = Object.defineProperty, Yh = Object.getOwnPropertyDescriptor, Ol = (e) => {
  throw TypeError(e);
}, ge = (e, t, i, o) => {
  for (var r = o > 1 ? void 0 : o ? Yh(t, i) : t, s = e.length - 1, n; s >= 0; s--)
    (n = e[s]) && (r = (o ? n(t, i, r) : n(r)) || r);
  return o && r && Xh(t, i, r), r;
}, Il = (e, t, i) => t.has(e) || Ol("Cannot " + i), Zh = (e, t, i) => (Il(e, t, "read from private field"), t.get(e)), Qh = (e, t, i) => t.has(e) ? Ol("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, i), Jh = (e, t, i, o) => (Il(e, t, "write to private field"), t.set(e, i), i), qr;
let Z = class extends Le(
  Me("", _h(v))
) {
  constructor() {
    super(), this.type = "button", this.disabled = !1, this.look = "default", this.color = "default", this.compact = !1, this.state = void 0, this.title = "", Qh(this, qr), this.addEventListener("click", this._onHostClick);
  }
  getFormElement() {
    return this._button;
  }
  ...
  updated(e) {
    super.updated(e), e.has("state") && (clearTimeout(Zh(this, qr)), (this.state === "success" || this.state === "failed") && Jh(this, qr, setTimeout(
      () => this.state = void 0,
      2e3
    )));
  }
    ...
    switch (this.state) {
      ...
      case "success":
        y(this, "uui-icon"), e = l`<uui-icon
          name="check"
          .fallback=${Zo.strings[0]}></uui-icon>`;
        break;
      case "failed":
        y(this, "uui-icon"), e = l`<uui-icon
          name="wrong"
          .fallback=${Kh.strings[0]}></uui-icon>`;
        break;
      default:
        return k;
    }
...
var ed = Object.defineProperty, td = Object.getOwnPropertyDescriptor, Al = (e) => {
  throw TypeError(e);
}, Qo = (e, t, i, o) => {
  for (var r = o > 1 ? void 0 : o ? td(t, i) : t, s = e.length - 1, n; s >= 0; s--)
    (n = e[s]) && (r = (o ? n(t, i, r) : n(r)) || r);
  return o && r && ed(t, i, r), r;
}, Ul = (e, t, i) => t.has(e) || Al("Cannot " + i), ds = (e, t, i) => (Ul(e, t, "read from private field"), i ? i.call(e) : t.get(e)), Ca = (e, t, i) => t.has(e) ? Al("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, i), id = (e, t, i, o) => (Ul(e, t, "write to private field"), t.set(e, i), i), Ri, Us;
let pi = class extends Z {
  constructor() {
    super(), this.text = "", this.copyFrom = "", this.animationStateDelay = 250, Ca(this, Ri), Ca(this, Us, async () => {
      this.state = "waiting";
      let e = this.text;
      if (this.copyFrom) {
      ...
      const t = new zr(zr.COPYING);
      t.text = e, this.dispatchEvent(t), t.text != null && (e = t.text);
      try {
        await navigator.clipboard.writeText(e);
        const i = new zr(zr.COPIED);
        i.text = e, this.dispatchEvent(i), id(this, Ri, setTimeout(() => {
          this.state = "success";
        }, this.animationStateDelay));
      } catch (i) {
        this.state = "failed", console.error("Error copying to clipboard", i);
      }
    }), y(this, "uui-icon"), this.addEventListener("click", ds(this, Us));
  }
  disconnectedCallback() {
    super.disconnectedCallback(), ds(this, Ri) && clearTimeout(ds(this, Ri));
  }
  renderLabel() {
    return l`
      <slot class="label">
...
], pi.prototype, "copyFrom", 2);
Qo([
  a({ type: Number, attribute: "animation-state-delay" })
], pi.prototype, "animationStateDelay", 2);
pi = Qo([
  d("uui-button-copy-text")
], pi);
var rd = Object.getOwnPropertyDescriptor, od = (e, t, i, o) => {
  for (var r = o > 1 ? void 0 : o ? rd(t, i) : t, s = e.length - 1, n; s >= 0; s--)
    (n = e[s]) && (r = n(r) || r);
  return r;
};
let po = class extends Te {
  renderCheckbox() {
    return l`
      <div id="ticker">
        <div id="icon-check">
          ${this.indeterminate ? Wh : Zo}
        </div>
      </div>
    `;
  }
...
var sd = Object.defineProperty, nd = Object.getOwnPropertyDescriptor, Si = (e, t, i, o) => {
  for (var r = o > 1 ? void 0 : o ? nd(t, i) : t, s = e.length - 1, n; s >= 0; s--)
    (n = e[s]) && (r = (o ? n(t, i, r) : n(r)) || r);
  return o && r && sd(t, i, r), r;
};
let Q = class extends Ko(
  ki(v)
) {
  constructor() {
  ...
  handleOpenClick(e) {
    this.disabled || (e.stopPropagation(), this.dispatchEvent(new Dr(Dr.OPEN)));
  }
  // This is deprecated - use href instead
  handleOpenKeydown(e) {
    this.disabled || e.key === "Enter" && (e.preventDefault(), e.stopPropagation(), this.dispatchEvent(new Dr(Dr.OPEN)));
  }
  renderCheckbox() {
    if (this.selectable)
      return l`
...
var ad = Object.defineProperty, ld = Object.getOwnPropertyDescriptor, zl = (e) => {
  throw TypeError(e);
}, Jo = (e, t, i, o) => {
  for (var r = o > 1 ? void 0 : o ? ld(t, i) : t, s = e.length - 1, n; s >= 0; s--)
    (n = e[s]) && (r = (o ? n(t, i, r) : n(r)) || r);
  return o && r && ad(t, i, r), r;
}, ud = (e, t, i) => t.has(e) || zl("Cannot " + i), cd = (e, t, i) => t.has(e) ? zl("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, i), Qi = (e, t, i) => (ud(e, t, "access private method"), i), zt, Dl, Ml, Ll, zn;
let vi = class extends Q {
  constructor() {
    super(...arguments), cd(this, zt), this.name = "";
  }
  get background() {
  }
  set background(e) {
  ...
  render() {
    return l`
      ${Qi(this, zt, Ll).call(this)}
      ${this.href ? Qi(this, zt, Ml).call(this) : Qi(this, zt, Dl).call(this)}
...
Jo([
  a({ type: String })
], vi.prototype, "description", 2);
Jo([
  a({ type: String, attribute: "background" })
], vi.prototype, "background", 1);
vi = Jo([
  d("uui-card-block-type")
], vi);
var hd = Object.defineProperty, dd = Object.getOwnPropertyDescriptor, Tl = (e) => {
  throw TypeError(e);
}, es = (e, t, i, o) => {
  for (var r = o > 1 ? void 0 : o ? dd(t, i) : t, s = e.length - 1, n; s >= 0; s--)
    (n = e[s]) && (r = (o ? n(t, i, r) : n(r)) || r);
  return o && r && hd(t, i, r), r;
}, pd = (e, t, i) => t.has(e) || Tl("Cannot " + i), vd = (e, t, i) => t.has(e) ? Tl("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, i), vo = (e, t, i) => (pd(e, t, "access private method"), i), oi, Dn, Nl, Vl;
let fi = class extends Q {
  constructor() {
    super(...arguments), vd(this, oi), this.name = "", this.detail = "", this._iconSlotHasContent = !1, this.fallbackIcon = `<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
    fill="none"
    stroke="currentColor"
  ...
  render() {
    return l`
      ${this.href ? vo(this, oi, Vl).call(this) : vo(this, oi, Nl).call(this)}
      <!-- Select border must be right after #open-part -->
      <div id="select-border"></div>
      ${this.selectable ? this.renderCheckbox() : k}
      <slot name="tag"></slot>
...
es([
  a({ type: String })
], fi.prototype, "detail", 2);
es([
  g()
], fi.prototype, "_iconSlotHasContent", 2);
fi = es([
  d("uui-card-content-node")
], fi);
var fd = Object.defineProperty, bd = Object.getOwnPropertyDescriptor, Bl = (e) => {
  throw TypeError(e);
}, kr = (e, t, i, o) => {
  for (var r = o > 1 ? void 0 : o ? bd(t, i) : t, s = e.length - 1, n; s >= 0; s--)
    (n = e[s]) && (r = (o ? n(t, i, r) : n(r)) || r);
  return o && r && fd(t, i, r), r;
}, gd = (e, t, i) => t.has(e) || Bl("Cannot " + i), md = (e, t, i) => t.has(e) ? Bl("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, i), fo = (e, t, i) => (gd(e, t, "access private method"), i), si, Hl, jl, Mn;
let Lt = class extends Q {
  constructor() {
    super(...arguments), md(this, si), this.name = "", this.fileExt = "", this.hasPreview = !1;
  }
  connectedCallback() {
  ...
  render() {
    return l` ${this.renderMedia()}
      ...
      ${this.href ? fo(this, si, jl).call(this) : fo(this, si, Hl).call(this)}
      <!-- Select border must be right after .open-part -->
      <div id="select-border"></div>
      ${this.selectable ? this.renderCheckbox() : k}
      <slot name="tag"></slot>
...
kr([
  a({ type: String })
], Lt.prototype, "detail", 2);
kr([
  a({ type: String, attribute: "file-ext" })
], Lt.prototype, "fileExt", 2);
kr([
  g()
], Lt.prototype, "hasPreview", 2);
Lt = kr([
  d("uui-card-media")
], Lt);
var _d = Object.defineProperty, yd = Object.getOwnPropertyDescriptor, Rl = (e) => {
  throw TypeError(e);
}, Ln = (e, t, i, o) => {
  for (var r = o > 1 ? void 0 : o ? yd(t, i) : t, s = e.length - 1, n; s >= 0; s--)
    (n = e[s]) && (r = (o ? n(t, i, r) : n(r)) || r);
  return o && r && _d(t, i, r), r;
}, wd = (e, t, i) => t.has(e) || Rl("Cannot " + i), xd = (e, t, i) => t.has(e) ? Rl("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, i), bo = (e, t, i) => (wd(e, t, "access private method"), i), ni, Fl, Wl, Tn;
let cr = class extends Q {
  constructor() {
    super(...arguments), xd(this, ni), this.name = "", this._avatarSlotHasContent = !1, this._avatarSlotChanged = (e) => {
      this._avatarSlotHasContent = Bh(e.target);
    };
  }
  connectedCallback() {
  ...
  render() {
    return l`
      ${this.href ? bo(this, ni, Wl).call(this) : bo(this, ni, Fl).call(this)}
      <!-- Select border must be right after #open-part -->
      <div id="select-border"></div>
      ${this.selectable ? this.renderCheckbox() : k}
      <slot name="tag"></slot>
...
Ln([
  g()
], cr.prototype, "_avatarSlotHasContent", 2);
cr = Ln([
  d("uui-card-user")
], cr);
var $d = Object.defineProperty, kd = Object.getOwnPropertyDescriptor, Gl = (e, t, i, o) => {
  for (var r = o > 1 ? void 0 : o ? kd(t, i) : t, s = e.length - 1, n; s >= 0; s--)
    (n = e[s]) && (r = (o ? n(t, i, r) : n(r)) || r);
...
var Cd = { grad: 0.9, turn: 360, rad: 360 / (2 * Math.PI) }, He = function(e) {
  ...
  var t, i, o, r;
}, Pd = /^hsla?\(\s*([+-]?\d*\.?\d+)(deg|rad|grad|turn)?\s*,\s*([+-]?\d*\.?\d+)%\s*,\s*([+-]?\d*\.?\d+)%\s*(?:,\s*([+-]?\d*\.?\d+)(%)?\s*)?\)$/i, Sd = /^hsla?\(\s*([+-]?\d*\.?\d+)(deg|rad|grad|turn)?\s+([+-]?\d*\.?\d+)%\s+([+-]?\d*\.?\d+)%\s*(?:\/\s*([+-]?\d*\.?\d+)(%)?\s*)?\)$/i, Od = /^rgba?\(\s*([+-]?\d*\.?\d+)(%)?\s*,\s*([+-]?\d*\.?\d+)(%)?\s*,\s*([+-]?\d*\.?\d+)(%)?\s*(?:,\s*([+-]?\d*\.?\d+)(%)?\s*)?\)$/i, Id = /^rgba?\(\s*([+-]?\d*\.?\d+)(%)?\s+([+-]?\d*\.?\d+)(%)?\s+([+-]?\d*\.?\d+)(%)?\s*(?:\/\s*([+-]?\d*\.?\d+)(%)?\s*)?\)$/i, Ia = { string: [[function(e) {
  var t = Ed.exec(e);
  ...
  var t = Pd.exec(e) || Sd.exec(e);
  if (!t) return null;
  var i, o, r = Pa({ h: (i = t[1], o = t[2], o === void 0 && (o = "deg"), Number(i) * (Cd[o] || 1)), s: Number(t[3]), l: Number(t[4]), a: t[5] === void 0 ? 1 : Number(t[5]) / (t[6] ? 100 : 1) });
  return Oa(r);
}, "hsl"]], object: [[function(e) {
  var t = e.r, i = e.g, o = e.b, r = e.a, s = r === void 0 ? 1 : r;
  return He(t) && He(i) && He(o) ? Ea({ r: Number(t), g: Number(i), b: Number(o), a: Number(s) }) : null;
}, "rgb"], [function(e) {
  var t = e.h, i = e.s, o = e.l, r = e.a, s = r === void 0 ? 1 : r;
  if (!He(t) || !He(i) || !He(o)) return null;
  var n = Pa({ h: Number(t), s: Number(i), l: Number(o), a: Number(s) });
  return Oa(n);
}, "hsl"], [function(e) {
  ...
  return typeof e == "string" ? Aa(e.trim(), Ia.string) : typeof e == "object" && e !== null ? Aa(e, Ia.object) : [null, void 0];
}, vs = function(e, t) {
  var i = Ji(e);
  ...
  function e(t) {
    this.parsed = Ad(t)[0], this.rgba = this.parsed || { r: 0, g: 0, b: 0, a: 1 };
  }
  return e.prototype.isValid = function() {
    return this.parsed !== null;
  }, e.prototype.brightness = function() {
    return R(fs(this.rgba), 2);
  }, e.prototype.isDark = function() {
    return fs(this.rgba) < 0.5;
  }, e.prototype.isLight = function() {
    return fs(this.rgba) >= 0.5;
  }, e.prototype.toHex = function() {
    return t = ps(this.rgba), i = t.r, o = t.g, r = t.b, n = (s = t.a) < 1 ? Mr(R(255 * s)) : "", "#" + Mr(i) + Mr(o) + Mr(r) + n;
    var t, i, o, r, s, n;
  }, e.prototype.toRgb = function() {
    return ps(this.rgba);
  }, e.prototype.toRgbString = function() {
    return t = ps(this.rgba), i = t.r, o = t.g, r = t.b, (s = t.a) < 1 ? "rgba(" + i + ", " + o + ", " + r + ", " + s + ")" : "rgb(" + i + ", " + o + ", " + r + ")";
    var t, i, o, r, s;
  }, e.prototype.toHsl = function() {
    return Sa(Ji(this.rgba));
  }, e.prototype.toHslString = function() {
    return t = Sa(Ji(this.rgba)), i = t.h, o = t.s, r = t.l, (s = t.a) < 1 ? "hsla(" + i + ", " + o + "%, " + r + "%, " + s + ")" : "hsl(" + i + ", " + o + "%, " + r + "%)";
    var t, i, o, r, s;
    ...
    return t === void 0 && (t = 0.1), he(vs(this.rgba, t));
  }, e.prototype.desaturate = function(t) {
    return t === void 0 && (t = 0.1), he(vs(this.rgba, -t));
  }, e.prototype.grayscale = function() {
    return he(vs(this.rgba, -1));
  }, e.prototype.lighten = function(t) {
    return t === void 0 && (t = 0.1), he(Ua(this.rgba, t));
  ...
  return e instanceof za ? e : new za(e);
};
class Da extends S {
  static {
    this.CHANGE = "change";
...
var Ud = Object.defineProperty, zd = Object.getOwnPropertyDescriptor, Ne = (e, t, i, o) => {
  for (var r = o > 1 ? void 0 : o ? zd(t, i) : t, s = e.length - 1, n; s >= 0; s--)
    (n = e[s]) && (r = (o ? n(t, i, r) : n(r)) || r);
  return o && r && Ud(t, i, r), r;
};
let fe = class extends v {
  ...
  syncValues() {
    ...
    this._value = e.toRgbString(), this.dispatchEvent(new Da(Da.CHANGE));
  }
...
const { I: Dd } = Cc, Yl = (e) => e.strings === void 0, Ma = () => document.createComment(""), Bi = (e, t, i) => {
  ...
  return i;
}, Ot = (e, t, i = e) => (e._$AI(t, i), e), Md = {}, Zl = (e, t = Md) => e._$AH = t, Ld = (e) => e._$AH, bs = (e) => {
...
const Td = Ei(class extends Pi {
  ...
  update(e, [t]) {
    ...
    } else if (e.type === ye.ATTRIBUTE && i.getAttribute(o) === t + "") return se;
    return Zl(e), t;
  }
});
var Nd = { grad: 0.9, turn: 360, rad: 360 / (2 * Math.PI) }, je = function(e) {
  return typeof e == "string" ? e.length > 0 : typeof e == "number";
}, F = function(e, t, i) {
  return t === void 0 && (t = 0), i === void 0 && (i = Math.pow(10, t)), Math.round(i * e) / i + 0;
}, pe = function(e, t, i) {
  ...
  var t, i, o, r;
}, Bd = /^hsla?\(\s*([+-]?\d*\.?\d+)(deg|rad|grad|turn)?\s*,\s*([+-]?\d*\.?\d+)%\s*,\s*([+-]?\d*\.?\d+)%\s*(?:,\s*([+-]?\d*\.?\d+)(%)?\s*)?\)$/i, Hd = /^hsla?\(\s*([+-]?\d*\.?\d+)(deg|rad|grad|turn)?\s+([+-]?\d*\.?\d+)%\s+([+-]?\d*\.?\d+)%\s*(?:\/\s*([+-]?\d*\.?\d+)(%)?\s*)?\)$/i, jd = /^rgba?\(\s*([+-]?\d*\.?\d+)(%)?\s*,\s*([+-]?\d*\.?\d+)(%)?\s*,\s*([+-]?\d*\.?\d+)(%)?\s*(?:,\s*([+-]?\d*\.?\d+)(%)?\s*)?\)$/i, Rd = /^rgba?\(\s*([+-]?\d*\.?\d+)(%)?\s+([+-]?\d*\.?\d+)(%)?\s+([+-]?\d*\.?\d+)(%)?\s*(?:\/\s*([+-]?\d*\.?\d+)(%)?\s*)?\)$/i, Ds = { string: [[function(e) {
  var t = Vd.exec(e);
  ...
  var t = jd.exec(e) || Rd.exec(e);
  return t ? t[2] !== t[4] || t[4] !== t[6] ? null : La({ r: Number(t[1]) / (t[2] ? 100 / 255 : 1), g: Number(t[3]) / (t[4] ? 100 / 255 : 1), b: Number(t[5]) / (t[6] ? 100 / 255 : 1), a: t[7] === void 0 ? 1 : Number(t[7]) / (t[8] ? 100 : 1) }) : null;
}, "rgb"], [function(e) {
  var t = Bd.exec(e) || Hd.exec(e);
  if (!t) return null;
  var i, o, r = Ta({ h: (i = t[1], o = t[2], o === void 0 && (o = "deg"), Number(i) * (Nd[o] || 1)), s: Number(t[3]), l: Number(t[4]), a: t[5] === void 0 ? 1 : Number(t[5]) / (t[6] ? 100 : 1) });
  return Va(r);
}, "hsl"]], object: [[function(e) {
  var t = e.r, i = e.g, o = e.b, r = e.a, s = r === void 0 ? 1 : r;
  return je(t) && je(i) && je(o) ? La({ r: Number(t), g: Number(i), b: Number(o), a: Number(s) }) : null;
}, "rgb"], [function(e) {
  var t = e.h, i = e.s, o = e.l, r = e.a, s = r === void 0 ? 1 : r;
  if (!je(t) || !je(i) || !je(o)) return null;
  var n = Ta({ h: Number(t), s: Number(i), l: Number(o), a: Number(s) });
  return Va(n);
}, "hsl"], [function(e) {
  var t = e.h, i = e.s, o = e.v, r = e.a, s = r === void 0 ? 1 : r;
  if (!je(t) || !je(i) || !je(o)) return null;
  ...
  return typeof e == "string" ? Ba(e.trim(), Ds.string) : typeof e == "object" && e !== null ? Ba(e, Ds.object) : [null, void 0];
}, ms = function(e, t) {
  var i = er(e);
  ...
  function e(t) {
    this.parsed = Fd(t)[0], this.rgba = this.parsed || { r: 0, g: 0, b: 0, a: 1 };
  }
  return e.prototype.isValid = function() {
    return this.parsed !== null;
  }, e.prototype.brightness = function() {
    return F(_s(this.rgba), 2);
  }, e.prototype.isDark = function() {
    return _s(this.rgba) < 0.5;
  }, e.prototype.isLight = function() {
    return _s(this.rgba) >= 0.5;
  }, e.prototype.toHex = function() {
    return t = gs(this.rgba), i = t.r, o = t.g, r = t.b, n = (s = t.a) < 1 ? Lr(F(255 * s)) : "", "#" + Lr(i) + Lr(o) + Lr(r) + n;
    var t, i, o, r, s, n;
  }, e.prototype.toRgb = function() {
    return gs(this.rgba);
  }, e.prototype.toRgbString = function() {
    return t = gs(this.rgba), i = t.r, o = t.g, r = t.b, (s = t.a) < 1 ? "rgba(" + i + ", " + o + ", " + r + ", " + s + ")" : "rgb(" + i + ", " + o + ", " + r + ")";
    var t, i, o, r, s;
  }, e.prototype.toHsl = function() {
    return Na(er(this.rgba));
  }, e.prototype.toHslString = function() {
    return t = Na(er(this.rgba)), i = t.h, o = t.s, r = t.l, (s = t.a) < 1 ? "hsla(" + i + ", " + o + "%, " + r + "%, " + s + ")" : "hsl(" + i + ", " + o + "%, " + r + "%)";
    var t, i, o, r, s;
  }, e.prototype.toHsv = function() {
    return t = Jl(this.rgba), { h: F(t.h), s: F(t.s), v: F(t.v), a: F(t.a, 3) };
    var t;
  }, e.prototype.invert = function() {
    return _e({ r: 255 - (t = this.rgba).r, g: 255 - t.g, b: 255 - t.b, a: t.a });
    var t;
  }, e.prototype.saturate = function(t) {
    return t === void 0 && (t = 0.1), _e(ms(this.rgba, t));
  }, e.prototype.desaturate = function(t) {
    return t === void 0 && (t = 0.1), _e(ms(this.rgba, -t));
  }, e.prototype.grayscale = function() {
    return _e(ms(this.rgba, -1));
  }, e.prototype.lighten = function(t) {
    return t === void 0 && (t = 0.1), _e(Ha(this.rgba, t));
  }, e.prototype.darken = function(t) {
    return t === void 0 && (t = 0.1), _e(Ha(this.rgba, -t));
  }, e.prototype.rotate = function(t) {
    return t === void 0 && (t = 15), this.hue(this.hue() + t);
  }, e.prototype.alpha = function(t) {
    return typeof t == "number" ? _e({ r: (i = this.rgba).r, g: i.g, b: i.b, a: t }) : F(this.rgba.a, 3);
    var i;
  }, e.prototype.hue = function(t) {
    var i = er(this.rgba);
    return typeof t == "number" ? _e({ h: t, s: i.s, l: i.l, a: i.a }) : F(i.h);
  }, e.prototype.isEqual = function(t) {
    return this.toHex() === _e(t).toHex();
  }, e;
})(), _e = function(e) {
  return e instanceof mo ? e : new mo(e);
}, ja = [], Wd = function(e) {
  e.forEach(function(t) {
    ja.indexOf(t) < 0 && (t(mo, Ds), ja.push(t));
  });
};
function Gd(e, t) {
...
var qd = Object.defineProperty, Kd = Object.getOwnPropertyDescriptor, B = (e, t, i, o) => {
  for (var r = o > 1 ? void 0 : o ? Kd(t, i) : t, s = e.length - 1, n; s >= 0; s--)
    (n = e[s]) && (r = (o ? n(t, i, r) : n(r)) || r);
  return o && r && qd(t, i, r), r;
};
Wd([Gd]);
const Ra = "EyeDropper" in window;
let L = class extends Me("label", v) {
  constructor() {
    super(...arguments), this._value = "", this.inputValue = "", this.hue = 0, this.saturation = 0, this.lightness = 0, this.alpha = 100, this._colord = _e("hsl(0, 0%, 0%)"), this.format = "hex", this.name = "", this.size = "medium", this.noFormatToggle = !1, this.inline = !1, this.disabled = !1, this.opacity = !1, this.readonly = !1, this.uppercase = !1, this.swatches = [
      "#d0021b",
      "#f5a623",
      "#f8e71c",
      "#8b572a",
  ...
  setColor(e) {
    ...
    const t = new mo(e), { h: i, s: o, l: r, a: s } = t.toHsl();
...
var Xd = { grad: 0.9, turn: 360, rad: 360 / (2 * Math.PI) }, Re = function(e) {
  return typeof e == "string" ? e.length > 0 : typeof e == "number";
}, W = function(e, t, i) {
  return t === void 0 && (t = 0), i === void 0 && (i = Math.pow(10, t)), Math.round(i * e) / i + 0;
}, ve = function(e, t, i) {
  ...
  var t, i, o, r;
}, Zd = /^hsla?\(\s*([+-]?\d*\.?\d+)(deg|rad|grad|turn)?\s*,\s*([+-]?\d*\.?\d+)%\s*,\s*([+-]?\d*\.?\d+)%\s*(?:,\s*([+-]?\d*\.?\d+)(%)?\s*)?\)$/i, Qd = /^hsla?\(\s*([+-]?\d*\.?\d+)(deg|rad|grad|turn)?\s+([+-]?\d*\.?\d+)%\s+([+-]?\d*\.?\d+)%\s*(?:\/\s*([+-]?\d*\.?\d+)(%)?\s*)?\)$/i, Jd = /^rgba?\(\s*([+-]?\d*\.?\d+)(%)?\s*,\s*([+-]?\d*\.?\d+)(%)?\s*,\s*([+-]?\d*\.?\d+)(%)?\s*(?:,\s*([+-]?\d*\.?\d+)(%)?\s*)?\)$/i, ep = /^rgba?\(\s*([+-]?\d*\.?\d+)(%)?\s+([+-]?\d*\.?\d+)(%)?\s+([+-]?\d*\.?\d+)(%)?\s*(?:\/\s*([+-]?\d*\.?\d+)(%)?\s*)?\)$/i, Ka = { string: [[function(e) {
  var t = Yd.exec(e);
  ...
  var t = Jd.exec(e) || ep.exec(e);
  return t ? t[2] !== t[4] || t[4] !== t[6] ? null : Fa({ r: Number(t[1]) / (t[2] ? 100 / 255 : 1), g: Number(t[3]) / (t[4] ? 100 / 255 : 1), b: Number(t[5]) / (t[6] ? 100 / 255 : 1), a: t[7] === void 0 ? 1 : Number(t[7]) / (t[8] ? 100 : 1) }) : null;
}, "rgb"], [function(e) {
  var t = Zd.exec(e) || Qd.exec(e);
  if (!t) return null;
  var i, o, r = Wa({ h: (i = t[1], o = t[2], o === void 0 && (o = "deg"), Number(i) * (Xd[o] || 1)), s: Number(t[3]), l: Number(t[4]), a: t[5] === void 0 ? 1 : Number(t[5]) / (t[6] ? 100 : 1) });
  return qa(r);
}, "hsl"]], object: [[function(e) {
  var t = e.r, i = e.g, o = e.b, r = e.a, s = r === void 0 ? 1 : r;
  return Re(t) && Re(i) && Re(o) ? Fa({ r: Number(t), g: Number(i), b: Number(o), a: Number(s) }) : null;
}, "rgb"], [function(e) {
  var t = e.h, i = e.s, o = e.l, r = e.a, s = r === void 0 ? 1 : r;
  if (!Re(t) || !Re(i) || !Re(o)) return null;
  var n = Wa({ h: Number(t), s: Number(i), l: Number(o), a: Number(s) });
  return qa(n);
}, "hsl"], [function(e) {
  var t = e.h, i = e.s, o = e.v, r = e.a, s = r === void 0 ? 1 : r;
  if (!Re(t) || !Re(i) || !Re(o)) return null;
  ...
  return typeof e == "string" ? Xa(e.trim(), Ka.string) : typeof e == "object" && e !== null ? Xa(e, Ka.object) : [null, void 0];
}, ws = function(e, t) {
  var i = tr(e);
  ...
  function e(t) {
    this.parsed = tp(t)[0], this.rgba = this.parsed || { r: 0, g: 0, b: 0, a: 1 };
  }
  return e.prototype.isValid = function() {
    return this.parsed !== null;
  }, e.prototype.brightness = function() {
    return W(xs(this.rgba), 2);
  }, e.prototype.isDark = function() {
    return xs(this.rgba) < 0.5;
  }, e.prototype.isLight = function() {
    return xs(this.rgba) >= 0.5;
  }, e.prototype.toHex = function() {
    return t = ys(this.rgba), i = t.r, o = t.g, r = t.b, n = (s = t.a) < 1 ? Nr(W(255 * s)) : "", "#" + Nr(i) + Nr(o) + Nr(r) + n;
    var t, i, o, r, s, n;
  }, e.prototype.toRgb = function() {
    return ys(this.rgba);
  }, e.prototype.toRgbString = function() {
    return t = ys(this.rgba), i = t.r, o = t.g, r = t.b, (s = t.a) < 1 ? "rgba(" + i + ", " + o + ", " + r + ", " + s + ")" : "rgb(" + i + ", " + o + ", " + r + ")";
    var t, i, o, r, s;
  }, e.prototype.toHsl = function() {
    return Ga(tr(this.rgba));
  }, e.prototype.toHslString = function() {
    return t = Ga(tr(this.rgba)), i = t.h, o = t.s, r = t.l, (s = t.a) < 1 ? "hsla(" + i + ", " + o + "%, " + r + "%, " + s + ")" : "hsl(" + i + ", " + o + "%, " + r + "%)";
    var t, i, o, r, s;
  }, e.prototype.toHsv = function() {
    ...
    return t === void 0 && (t = 0.1), Fe(ws(this.rgba, t));
  }, e.prototype.desaturate = function(t) {
    return t === void 0 && (t = 0.1), Fe(ws(this.rgba, -t));
  }, e.prototype.grayscale = function() {
    return Fe(ws(this.rgba, -1));
  }, e.prototype.lighten = function(t) {
    return t === void 0 && (t = 0.1), Fe(Ya(this.rgba, t));
  }, e.prototype.darken = function(t) {
    return t === void 0 && (t = 0.1), Fe(Ya(this.rgba, -t));
  }, e.prototype.rotate = function(t) {
    return t === void 0 && (t = 15), this.hue(this.hue() + t);
  ...
  return e instanceof Ms ? e : new Ms(e);
};
class Za extends S {
  static {
    this.CHANGE = "change";
...
var ip = Object.defineProperty, rp = Object.getOwnPropertyDescriptor, xe = (e, t, i, o) => {
  for (var r = o > 1 ? void 0 : o ? rp(t, i) : t, s = e.length - 1, n; s >= 0; s--)
    (n = e[s]) && (r = (o ? n(t, i, r) : n(r)) || r);
  return o && r && ip(t, i, r), r;
};
let le = class extends Me("label", v) {
  constructor() {
  ...
  willUpdate(e) {
    if (e.has("type") && (this.type === "hue" ? this.max = 360 : this.type === "saturation" ? this.max = 100 : this.type === "lightness" ? this.max = 100 : this.type === "opacity" && (this.max = this.max ?? 100), this.precision = this.precision ?? 1, this.color)) {
      const t = new Ms(this.color), { h: i, s: o, l: r } = t.toHsl(), { r: s, g: n, b: u } = t.toRgb(), c = this.type === "saturation" ? `linear-gradient(to ${this.vertical ? "top" : "right"}, hsl(${i}, 0%, ${r}%), hsl(${i}, 100%, ${r}%))` : this.type === "lightness" ? `linear-gradient(to ${this.vertical ? "top" : "right"}, hsl(${i}, ${o}%, 0%), hsl(${i}, ${o}%, 100%))` : null, h = this.type === "opacity" ? `linear-gradient(to ${this.vertical ? "top" : "right"}, transparent 0%, rgba(${s}, ${n}, ${u}, ${this.max}%) 100%)` : null;
  ...
  syncValues() {
    this.dispatchEvent(new Za(Za.CHANGE));
  }
  get cssPropCurrentValue() {
    return this.value === 0 ? this.vertical ? 100 : 0 : 100 / (this.vertical ? this.max / ka(this.value, this.min, this.max) : this.max / this.value);
  }
  render() {
    return l`<div
        part="slider"
...
const ir = (e, t) => {
  ...
  for (const o of i) o._$AO?.(t, !1), ir(o, t);
  return !0;
}, _o = (e) => {
  let t, i;
  do {
...
function op(e) {
  this._$AN !== void 0 ? (_o(this), this._$AM = e, ou(this)) : this._$AM = e;
}
function sp(e, t = !1, i = 0) {
  const o = this._$AH, r = this._$AN;
  if (r !== void 0 && r.size !== 0) if (t) if (Array.isArray(o)) for (let s = i; s < o.length; s++) ir(o[s], !1), _o(o[s]);
  else o != null && (ir(o, !1), _o(o));
  else ir(this, e);
}
const np = (e) => {
  e.type == ye.CHILD && (e._$AP ??= sp, e._$AQ ??= op);
};
class ap extends Pi {
  constructor() {
  ...
  _$AO(t, i = !0) {
    t !== this.isConnected && (this.isConnected = t, t ? this.reconnected?.() : this.disconnected?.()), i && (ir(this, t), _o(this));
  }
  setValue(t) {
...
const $s = /* @__PURE__ */ new WeakMap(), Kr = Ei(class extends ap {
  render(e) {
    return k;
  }
  update(e, [t]) {
  ...
  rt(e) {
    if (this.isConnected || (e = void 0), typeof this.G == "function") {
      ...
      let i = $s.get(t);
      i === void 0 && (i = /* @__PURE__ */ new WeakMap(), $s.set(t, i)), i.get(this.G) !== void 0 && this.G.call(this.ht, void 0), i.set(this.G, e), e !== void 0 && this.G.call(this.ht, e);
    } else this.G.value = e;
  }
  get lt() {
    return typeof this.G == "function" ? $s.get(this.ht ?? globalThis)?.get(this.G) : this.G?.value;
  }
  disconnected() {
...
var lp = Object.defineProperty, up = Object.getOwnPropertyDescriptor, su = (e) => {
  throw TypeError(e);
}, Oi = (e, t, i, o) => {
  for (var r = o > 1 ? void 0 : o ? up(t, i) : t, s = e.length - 1, n; s >= 0; s--)
    (n = e[s]) && (r = (o ? n(t, i, r) : n(r)) || r);
  return o && r && lp(t, i, r), r;
}, cp = (e, t, i) => t.has(e) || su("Cannot " + i), hp = (e, t, i) => t.has(e) ? su("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, i), dp = (e, t, i) => (cp(e, t, "access private method"), i), Ls, nu;
let ht = class extends Me(
  "label",
  ki($r(v))
) {
  constructor() {
    super(), hp(this, Ls), this.disabled = !1, this.readonly = !1, this.showLabel = !1, this.addEventListener("click", this._setAriaAttributes);
  }
  get value() {
    return this._value ?? "";
  }
...
var pp = Object.defineProperty, vp = Object.getOwnPropertyDescriptor, Cr = (e, t, i, o) => {
  for (var r = o > 1 ? void 0 : o ? vp(t, i) : t, s = e.length - 1, n; s >= 0; s--)
    (n = e[s]) && (r = (o ? n(t, i, r) : n(r)) || r);
  return o && r && pp(t, i, r), r;
};
let Tt = class extends Me("label", v) {
  constructor() {
    super(), this.value = "", this.disabled = !1, this.readonly = !1, this._onSelected = (e) => {
      const t = e.target;
      this._swatches.includes(t) && (this._selectedElement && (this._selectedElement.selected = !1, this._selectedElement.active = !1, this._selectedElement = void 0), this._selectedElement = t, this._activeElement = this._selectedElement, this.value = this._selectedElement.value || "", this.dispatchEvent(new Vr(Vr.CHANGE)));
    ...
    }, this.addEventListener(ti.SELECTED, this._onSelected), this.addEventListener(ti.DESELECTED, this._onDeselected);
  }
  get _activeElement() {
...
Cr([
  xt({ selector: "uui-color-swatch" })
], Tt.prototype, "_swatches", 2);
Tt = Cr([
...
var fp = Object.defineProperty, bp = Object.getOwnPropertyDescriptor, au = (e) => {
  throw TypeError(e);
}, $t = (e, t, i, o) => {
  for (var r = o > 1 ? void 0 : o ? bp(t, i) : t, s = e.length - 1, n; s >= 0; s--)
    (n = e[s]) && (r = (o ? n(t, i, r) : n(r)) || r);
  return o && r && fp(t, i, r), r;
}, gp = (e, t, i) => t.has(e) || au("Cannot " + i), mp = (e, t, i) => t.has(e) ? au("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, i), Qa = (e, t, i) => (gp(e, t, "access private method"), i), Xr, Ts;
let De = class extends v {
  constructor() {
    super(...arguments), mp(this, Xr), this.displayValue = "", this._value = "", this._activeElementValue = null, this._onSlotChange = () => {
      Qa(this, Xr, Ts).call(this), this._updateSelection(), this.dispatchEvent(
      ...
      if (!(this._options.length <= 0))
        switch (e.code) {
          ...
          //Space key
          case "Space": {
            e.preventDefault(), e.stopPropagation(), this._getActiveElement?.click();
            break;
          }
          case "End": {
  ...
  connectedCallback() {
    super.connectedCallback(), this._for || (this._for = this), this.addEventListener(ti.SELECTED, this._onSelected), this.addEventListener(ti.DESELECTED, this._onDeselected);
  }
  disconnectedCallback() {
    super.disconnectedCallback(), document.removeEventListener("keydown", this._onKeyDown), this.removeEventListener(ti.SELECTED, this._onSelected), this.removeEventListener(ti.DESELECTED, this._onDeselected);
  }
  _updateSelection() {
    this.displayValue = "";
  ...
  _goToIndex(e) {
    ...
    this._activeElementValue = t.value, Qa(this, Xr, Ts).call(this), t && t.scrollIntoView({
      behavior: "auto",
      block: "nearest",
      inline: "nearest"
    });
...
], De.prototype, "_options", 2);
$t([
  xt({
    flatten: !0,
    selector: "uui-combobox-list-option[active]"
  })
], De.prototype, "_activeOptions", 2);
$t([
  g()
], De.prototype, "_value", 2);
$t([
  g()
], De.prototype, "_activeElementValue", 2);
De = $t([
  d("uui-combobox-list")
], De);
var _p = Object.defineProperty, yp = Object.getOwnPropertyDescriptor, Ii = (e, t, i, o) => {
  for (var r = o > 1 ? void 0 : o ? yp(t, i) : t, s = e.length - 1, n; s >= 0; s--)
    (n = e[s]) && (r = (o ? n(t, i, r) : n(r)) || r);
  return o && r && _p(t, i, r), r;
};
let dt = class extends ki(
  $r(v)
) {
  constructor() {
...
Ii([
  g()
], dt.prototype, "_disabled", 2);
Ii([
  g()
], dt.prototype, "_displayValue", 2);
Ii([
  a({ type: String })
], dt.prototype, "value", 1);
Ii([
  a({ type: String, attribute: "display-value" })
], dt.prototype, "displayValue", 1);
Ii([
  a({ type: Boolean, reflect: !0 })
], dt.prototype, "disabled", 1);
dt = Ii([
...
var wp = Object.defineProperty, xp = Object.getOwnPropertyDescriptor, lu = (e) => {
  throw TypeError(e);
}, J = (e, t, i, o) => {
  for (var r = o > 1 ? void 0 : o ? xp(t, i) : t, s = e.length - 1, n; s >= 0; s--)
    (n = e[s]) && (r = (o ? n(t, i, r) : n(r)) || r);
  return o && r && wp(t, i, r), r;
}, Nn = (e, t, i) => t.has(e) || lu("Cannot " + i), $ = (e, t, i) => (Nn(e, t, "read from private field"), i ? i.call(e) : t.get(e)), Y = (e, t, i) => t.has(e) ? lu("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, i), uu = (e, t, i, o) => (Nn(e, t, "write to private field"), t.set(e, i), i), Yr = (e, t, i) => (Nn(e, t, "access private method"), i), oe, Zt, ii, cu, Fi, yo, Zr, Qr, Ns, wo, xo, Vs, Wi, Qt, Bs, Jr, eo, Hs, to;
let G = class extends Le(v, "") {
  constructor() {
    super(...arguments), Y(this, ii), this.closeLabel = "Close", this.disabled = !1, this.hideExpandSymbol = !1, this.readonly = !1, this.placeholder = "", Y(this, oe), Y(this, Zt), this._displayValue = "", this._search = "", this._isPhone = !1, this._isOpen = !1, Y(this, Fi, () => {
      this._isPhone = $(this, Zt).matches;
    }), Y(this, Zr, () => requestAnimationFrame(() => this._input.focus())), Y(this, Qr, () => requestAnimationFrame(() => {
      this.shadowRoot?.activeElement || $(this, Qt).call(this);
    })), Y(this, Ns, (e) => {
      e.preventDefault(), e.stopImmediatePropagation(), this.search = e.target.value, this.dispatchEvent(new Pe(Pe.SEARCH)), $(this, Wi).call(this);
    }), Y(this, wo, () => {
      this.value && this.value !== $(this, oe)?.value && Yr(this, ii, yo).call(this);
    }), Y(this, xo, () => {
      this.value = $(this, oe)?.value || "", this.search = this.value ? this.search : "", $(this, Qt).call(this), this.dispatchEvent(new Pe(Pe.CHANGE));
    }), Y(this, Vs, () => {
      ...
      if (this.open === !1 && e.code === "Enter" && (e.preventDefault(), e.stopImmediatePropagation()), (e.code === "ArrowUp" || e.code === "ArrowDown") && $(this, Wi).call(this), e.code === "Space") {
        if (this._isOpen) return;
        e.preventDefault(), e.stopImmediatePropagation(), $(this, Wi).call(this);
      }
      (e.code === "Escape" || e.code === "Enter") && $(this, Qt).call(this);
    }), Y(this, Jr, (e) => {
      ...
      <uui-icon name="remove" .fallback=${Un.strings[0]}></uui-icon>
    </uui-button>`), Y(this, to, () => l`<div id="dropdown">
      <uui-scroll-container tabindex="-1" id="scroll-container">
        <slot @slotchange=${Yr(this, ii, cu)}></slot>
  ...
  set value(e) {
    super.value = e, typeof e == "string" && Yr(this, ii, yo).call(this);
  }
  get search() {
    return this._search;
  }
  ...
  connectedCallback() {
    super.connectedCallback(), this.addEventListener("blur", $(this, Qr)), this.addEventListener("mousedown", $(this, Zr)), uu(this, Zt, window.matchMedia("(max-width: 600px)")), $(this, Fi).call(this), $(this, Zt).addEventListener("change", $(this, Fi)), y(this, "uui-icon"), y(this, "uui-input"), y(this, "uui-button"), y(this, "uui-combobox-list"), y(this, "uui-scroll-container"), y(this, "uui-popover-container"), y(this, "uui-symbol-expand");
  }
  disconnectedCallback() {
    super.disconnectedCallback(), this.removeEventListener("blur", $(this, Qr)), this.removeEventListener("mousedown", $(this, Zr)), $(this, Zt).removeEventListener("change", $(this, Fi));
  }
  getFormElement() {
    return this._input;
  }
  ...
  render() {
    return this._isPhone && this.open ? l`<div id="phone-wrapper">
        <uui-button label="close" look="primary" @click=${$(this, Qt)}>
          ${this.closeLabel}
        </uui-button>
        ${$(this, eo).call(this)} ${$(this, to).call(this)}
      </div>` : l`
        ${$(this, eo).call(this)}
        <uui-popover-container
          id="combobox-popover"
...
var $p = Object.defineProperty, kp = Object.getOwnPropertyDescriptor, Vn = (e, t, i, o) => {
  for (var r = o > 1 ? void 0 : o ? kp(t, i) : t, s = e.length - 1, n; s >= 0; s--)
    (n = e[s]) && (r = (o ? n(t, i, r) : n(r)) || r);
  return o && r && $p(t, i, r), r;
};
...
Vn([
  a({ type: String })
], hr.prototype, "headline", 2);
Vn([
  g()
], hr.prototype, "_headlineSlotHasContent", 2);
hr = Vn([
  d("uui-dialog-layout")
], hr);
var Cp = Object.getOwnPropertyDescriptor, Ep = (e, t, i, o) => {
  for (var r = o > 1 ? void 0 : o ? Cp(t, i) : t, s = e.length - 1, n; s >= 0; s--)
    (n = e[s]) && (r = n(r) || r);
  return r;
};
...
var Pp = Object.defineProperty, Sp = Object.getOwnPropertyDescriptor, hu = (e, t, i, o) => {
  for (var r = o > 1 ? void 0 : o ? Sp(t, i) : t, s = e.length - 1, n; s >= 0; s--)
    (n = e[s]) && (r = (o ? n(t, i, r) : n(r)) || r);
  return o && r && Pp(t, i, r), r;
};
...
var Op = Object.defineProperty, Ip = Object.getOwnPropertyDescriptor, Ai = (e, t, i, o) => {
  for (var r = o > 1 ? void 0 : o ? Ip(t, i) : t, s = e.length - 1, n; s >= 0; s--)
    (n = e[s]) && (r = (o ? n(t, i, r) : n(r)) || r);
  return o && r && Op(t, i, r), r;
};
let pt = class extends Me("", v) {
  constructor() {
...
Ai([
  P("#input")
], pt.prototype, "_input", 2);
Ai([
  P("#dropzone")
], pt.prototype, "_dropzone", 2);
Ai([
  a({ type: String })
], pt.prototype, "accept", 1);
Ai([
  a({
    type: Boolean,
    reflect: !0,
...
], pt.prototype, "disallowFolderUpload", 2);
Ai([
  a({ type: Boolean })
...
var Up = Object.defineProperty, zp = Object.getOwnPropertyDescriptor, Ve = (e, t, i, o) => {
  for (var r = o > 1 ? void 0 : o ? zp(t, i) : t, s = e.length - 1, n; s >= 0; s--)
    (n = e[s]) && (r = (o ? n(t, i, r) : n(r)) || r);
  return o && r && Up(t, i, r), r;
};
  ...
  render() {
    return l`
      ...
      <div id="file-info">
        ...
        <span id="file-size">
          ${this._size && !this._isDirectory ? l`${Ap.humanFileSize(this._size, !0)}` : ""}
        </span>
      </div>
    `;
  }
...
var Dp = Object.defineProperty, Mp = Object.getOwnPropertyDescriptor, ts = (e, t, i, o) => {
...
ts([
  g()
], bi.prototype, "_labelSlotHasContent", 2);
ts([
  g()
], bi.prototype, "_descriptionSlotHasContent", 2);
bi = ts([
...
const Ja = (e, t, i) => {
  ...
  update(e, [t, i, o]) {
    const r = Ld(e), { values: s, keys: n } = this.dt(t, i, o);
    if (!Array.isArray(r)) return this.ut = n, s;
    const u = this.ut ??= [], c = [];
    let h, m, f = 0, C = r.length - 1, x = 0, O = s.length - 1;
    for (; f <= C && x <= O; ) if (r[f] === null) f++;
    else if (r[C] === null) C--;
    else if (u[f] === n[x]) c[x] = Ot(r[f], s[x]), f++, x++;
    else if (u[C] === n[O]) c[O] = Ot(r[C], s[O]), C--, O--;
    else if (u[f] === n[O]) c[O] = Ot(r[f], s[O]), Bi(e, c[O + 1], r[f]), f++, O--;
    else if (u[C] === n[x]) c[x] = Ot(r[C], s[x]), Bi(e, r[f], r[C]), C--, x++;
    else if (h === void 0 && (h = Ja(n, x, O), m = Ja(u, f, C)), h.has(u[f])) if (h.has(u[C])) {
      const X = m.get(n[x]), Be = X !== void 0 ? r[X] : null;
      if (Be === null) {
        const tt = Bi(e, r[f]);
        Ot(tt, s[x]), c[x] = tt;
      } else c[x] = Ot(Be, s[x]), Bi(e, r[f], Be), r[X] = null;
      x++;
    } else bs(r[C]), C--;
    else bs(r[f]), f++;
    for (; x <= O; ) {
...
class Rs extends Pi {
  constructor(t) {
    if (super(t), this.it = k, t.type !== ye.CHILD) throw Error(this.constructor.directiveName + "() can only be used in child bindings");
  }
  render(t) {
...
const io = Ei(Rs);
var Lp = Object.defineProperty, Tp = Object.getOwnPropertyDescriptor, du = (e, t, i, o) => {
...
var Np = Object.getOwnPropertyDescriptor, Vp = (e, t, i, o) => {
  for (var r = o > 1 ? void 0 : o ? Np(t, i) : t, s = e.length - 1, n; s >= 0; s--)
    (n = e[s]) && (r = n(r) || r);
  return r;
};
let el = class extends v {
  constructor() {
...
var Bp = Object.defineProperty, Hp = Object.getOwnPropertyDescriptor, Ht = (e, t, i, o) => {
  for (var r = o > 1 ? void 0 : o ? Hp(t, i) : t, s = e.length - 1, n; s >= 0; s--)
    (n = e[s]) && (r = (o ? n(t, i, r) : n(r)) || r);
  return o && r && Bp(t, i, r), r;
};
let Je = class extends v {
  ...
  requestIcon() {
    if (this._name !== "" && this._name !== null) {
      const e = new Co(Co.ICON_REQUEST, {
  ...
  render() {
    return this._useFallback === !0 ? this.fallback === null ? l`<slot name="fallback"></slot>` : l`${io(this.fallback)}` : this._nameSvg !== null ? l`${io(this._nameSvg)}` : this.svg !== null ? l`${io(this.svg)}` : l`<slot></slot>`;
  }
};
Je.styles = [
  p`
...
var jp = Object.defineProperty, Rp = Object.getOwnPropertyDescriptor, vu = (e, t, i, o) => {
  for (var r = o > 1 ? void 0 : o ? Rp(t, i) : t, s = e.length - 1, n; s >= 0; s--)
    (n = e[s]) && (r = (o ? n(t, i, r) : n(r)) || r);
...
vu([
  a({ attribute: !1 })
], Eo.prototype, "_icons", 2);
Eo = vu([
  d("uui-icon-registry")
], Eo);
const Fp = b`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12h14"/><path d="M12 5v14"/></svg>`, Wp = b`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"><path d="m21.73 18-8-14a2 2 0 0 0-3.48 0l-8 14A2 2 0 0 0 4 21h16a2 2 0 0 0 1.73-3Z" /><path d="M12 9v4" /><path d="M12 17h.01" /></svg>`, Gp = b`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"><path d="m21.44 11.05-9.19 9.19a6 6 0 0 1-8.49-8.49l8.57-8.57A4 4 0 1 1 18 8.84l-8.59 8.57a2 2 0 0 1-2.83-2.83l8.49-8.48" /></svg>`, qp = b`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"><rect width="18" height="18" x="3" y="4" rx="2" ry="2" /><line x1="16" x2="16" y1="2" y2="6" /><line x1="8" x2="8" y1="2" y2="6" /><line x1="3" x2="21" y1="10" y2="10" /><path d="M8 14h.01" /><path d="M12 14h.01" /><path d="M16 14h.01" /><path d="M8 18h.01" /><path d="M12 18h.01" /><path d="M16 18h.01" /></svg>`, Kp = b`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12" /></svg>`, Xp = b`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"><rect width="8" height="4" x="8" y="2" rx="1" ry="1" /><path d="M16 4h2a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h2" /></svg>`, Yp = b`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"><polyline points="16 18 22 12 16 6" /><polyline points="8 6 2 12 8 18" /></svg>`, Zp = b`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"><path d="m2 22 1-1h3l9-9" /><path d="M3 21v-3l9-9" /><path d="m15 6 3.4-3.4a2.1 2.1 0 1 1 3 3L18 9l.4.4a2.1 2.1 0 1 1-3 3l-3.8-3.8a2.1 2.1 0 1 1 3-3l.4.4Z" /></svg>`, Qp = b`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"><path d="M15.5 2H8.6c-.4 0-.8.2-1.1.5-.3.3-.5.7-.5 1.1v12.8c0 .4.2.8.5 1.1.3.3.7.5 1.1.5h9.8c.4 0 .8-.2 1.1-.5.3-.3.5-.7.5-1.1V6.5L15.5 2z" /><path d="M3 7.6v12.8c0 .4.2.8.5 1.1.3.3.7.5 1.1.5h9.8" /><path d="M15 2v5h5" /></svg>`, Jp = b`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"><path d="M3 6h18" /><path d="M19 6v14c0 1-1 2-2 2H7c-1 0-2-1-2-2V6" /><path d="M8 6V4c0-1 1-2 2-2h4c1 0 2 1 2 2v2" /><line x1="10" x2="10" y1="11" y2="17" /><line x1="14" x2="14" y1="11" y2="17" /></svg>`, ev = b`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"><path d="M14.5 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7.5L14.5 2z" /><polyline points="14 2 14 8 20 8" /></svg>`, tv = b`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4" /><polyline points="7 10 12 15 17 10" /><line x1="12" x2="12" y1="15" y2="3" /></svg>`, iv = b`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"><path d="M17 3a2.85 2.83 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5Z" /><path d="m15 5 4 4" /></svg>`, rv = b`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"><path d="M19 14c1.49-1.46 3-3.21 3-5.5A5.5 5.5 0 0 0 16.5 3c-1.76 0-3 .5-4.5 2-1.5-1.5-2.74-2-4.5-2A5.5 5.5 0 0 0 2 8.5c0 2.3 1.5 4.05 3 5.5l7 7Z" /></svg>`, ov = b`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"><path d="M20 20a2 2 0 0 0 2-2V8a2 2 0 0 0-2-2h-7.9a2 2 0 0 1-1.69-.9L9.6 3.9A2 2 0 0 0 7.93 3H4a2 2 0 0 0-2 2v13a2 2 0 0 0 2 2Z" /><path d="M2 10h20" /></svg>`, sv = b`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"><polygon points="7.86 2 16.14 2 22 7.86 22 16.14 16.14 22 7.86 22 2 16.14 2 7.86 7.86 2" /><path d="m15 9-6 6" /><path d="m9 9 6 6" /></svg>`, nv = b`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round" ><circle cx="12" cy="12" r="10" /><path d="M12 16v-4" /><path d="M12 8h.01" /></svg>`, av = b`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"><path d="M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71" /><path d="M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71" /></svg>`, lv = b`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"><rect width="18" height="11" x="3" y="11" rx="2" ry="2" /><path d="M7 11V7a5 5 0 0 1 10 0v4" /></svg>`, uv = b`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"><rect width="4" height="16" x="6" y="4" /><rect width="4" height="16" x="14" y="4" /></svg>`, cv = b`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"><rect width="18" height="18" x="3" y="3" rx="2" ry="2" /><circle cx="9" cy="9" r="2" /><path d="m21 15-3.086-3.086a2 2 0 0 0-2.828 0L6 21" /></svg>`, hv = b`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"><polygon points="5 3 19 12 5 21 5 3" /></svg>`, dv = b`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"><path d="M18 6 6 18" /><path d="m6 6 12 12" /></svg>`, pv = b`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="8" /><path d="m21 21-4.3-4.3" /></svg>`, vv = b`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"><path d="M2 12s3-7 10-7 10 7 10 7-3 7-10 7-10-7-10-7Z" /><circle cx="12" cy="12" r="3" /></svg>`, fv = b`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"><path d="M12.22 2h-.44a2 2 0 0 0-2 2v.18a2 2 0 0 1-1 1.73l-.43.25a2 2 0 0 1-2 0l-.15-.08a2 2 0 0 0-2.73.73l-.22.38a2 2 0 0 0 .73 2.73l.15.1a2 2 0 0 1 1 1.72v.51a2 2 0 0 1-1 1.74l-.15.09a2 2 0 0 0-.73 2.73l.22.38a2 2 0 0 0 2.73.73l.15-.08a2 2 0 0 1 2 0l.43.25a2 2 0 0 1 1 1.73V20a2 2 0 0 0 2 2h.44a2 2 0 0 0 2-2v-.18a2 2 0 0 1 1-1.73l.43-.25a2 2 0 0 1 2 0l.15.08a2 2 0 0 0 2.73-.73l.22-.39a2 2 0 0 0-.73-2.73l-.15-.08a2 2 0 0 1-1-1.74v-.5a2 2 0 0 1 1-1.74l.15-.09a2 2 0 0 0 .73-2.73l-.22-.38a2 2 0 0 0-2.73-.73l-.15.08a2 2 0 0 1-2 0l-.43-.25a2 2 0 0 1-1-1.73V4a2 2 0 0 0-2-2z" /><circle cx="12" cy="12" r="3" /></svg>`, bv = b`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12h14" /></svg>`, gv = b`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"><path d="M3 12a9 9 0 0 1 9-9 9.75 9.75 0 0 1 6.74 2.74L21 8" /><path d="M21 3v5h-5" /><path d="M21 12a9 9 0 0 1-9 9 9.75 9.75 0 0 1-6.74-2.74L3 16" /><path d="M8 16H3v5" /></svg>`, mv = b`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"><rect width="18" height="11" x="3" y="11" rx="2" ry="2" /><path d="M7 11V7a5 5 0 0 1 9.9-1" /></svg>`, _v = b`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"><path d="M9.88 9.88a3 3 0 1 0 4.24 4.24" /><path d="M10.73 5.08A10.43 10.43 0 0 1 12 5c7 0 10 7 10 7a13.16 13.16 0 0 1-1.67 2.68" /><path d="M6.61 6.61A13.526 13.526 0 0 0 2 12s3 7 10 7a9.74 9.74 0 0 0 5.39-1.61" /><line x1="2" x2="22" y1="2" y2="22" /></svg>`, yv = b`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"><path d="M15 4V2" /><path d="M15 16v-2" /><path d="M8 9h2" /><path d="M20 9h2" /><path d="M17.8 11.8 19 13" /><path d="M15 9h0" /><path d="M17.8 6.2 19 5" /><path d="m3 21 9-9" /><path d="M12.2 6.2 11 5" /></svg>`, wv = b`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10" /><path d="m15 9-6 6" /><path d="m9 9 6 6" /></svg>`;
class xv extends pu {
  constructor() {
    super(), this.defineIcon("add", Fp.strings[0]), this.defineIcon("alert", Wp.strings[0]), this.defineIcon("attachment", Gp.strings[0]), this.defineIcon("calendar", qp.strings[0]), this.defineIcon("check", Kp.strings[0]), this.defineIcon("clipboard", Xp.strings[0]), this.defineIcon("code", Yp.strings[0]), this.defineIcon("colorpicker", Zp.strings[0]), this.defineIcon("copy", Qp.strings[0]), this.defineIcon("delete", Jp.strings[0]), this.defineIcon("document", ev.strings[0]), this.defineIcon("download", tv.strings[0]), this.defineIcon("edit", iv.strings[0]), this.defineIcon("favorite", rv.strings[0]), this.defineIcon("folder", ov.strings[0]), this.defineIcon("forbidden", sv.strings[0]), this.defineIcon("info", nv.strings[0]), this.defineIcon("link", av.strings[0]), this.defineIcon("lock", lv.strings[0]), this.defineIcon("pause", uv.strings[0]), this.defineIcon("picture", cv.strings[0]), this.defineIcon("play", hv.strings[0]), this.defineIcon("remove", dv.strings[0]), this.defineIcon("search", pv.strings[0]), this.defineIcon("see", vv.strings[0]), this.defineIcon("settings", fv.strings[0]), this.defineIcon("subtract", bv.strings[0]), this.defineIcon("sync", gv.strings[0]), this.defineIcon("unlock", mv.strings[0]), this.defineIcon("unsee", _v.strings[0]), this.defineIcon("wand", yv.strings[0]), this.defineIcon("wrong", wv.strings[0]);
  }
}
var $v = Object.getOwnPropertyDescriptor, kv = (e, t, i, o) => {
  for (var r = o > 1 ? void 0 : o ? $v(t, i) : t, s = e.length - 1, n; s >= 0; s--)
    (n = e[s]) && (r = n(r) || r);
  return r;
};
let il = class extends Eo {
  constructor() {
    super(), this.registry = new xv();
  }
};
il = kv([
  d("uui-icon-registry-essential")
], il);
var Cv = Object.defineProperty, Ev = Object.getOwnPropertyDescriptor, Ui = (e, t, i, o) => {
  for (var r = o > 1 ? void 0 : o ? Ev(t, i) : t, s = e.length - 1, n; s >= 0; s--)
    (n = e[s]) && (r = (o ? n(t, i, r) : n(r)) || r);
  return o && r && Cv(t, i, r), r;
};
let vt = class extends Le(v) {
  constructor() {
    ...
    return l`<uui-file-preview .file="${e}">
      <uui-action-bar slot="actions">
        <uui-button
          ...
          color="danger"
          label=${`Delete ${e.name}`}>
          <uui-icon name="delete" .fallback=${Hh.strings[0]}></uui-icon>
        </uui-button>
      </uui-action-bar>
    </uui-file-preview>`;
  }
...
Ui([
  P("#dropzone")
], vt.prototype, "_dropzone", 2);
Ui([
  P("#dropzone")
], vt.prototype, "_dropZone", 2);
Ui([
  a({ type: String })
], vt.prototype, "accept", 2);
Ui([
  a({ type: Boolean })
], vt.prototype, "multiple", 2);
Ui([
  g()
], vt.prototype, "_files", 2);
vt = Ui([
  d("uui-input-file")
], vt);
class Hr extends S {
...
var Pv = Object.defineProperty, Sv = Object.getOwnPropertyDescriptor, fu = (e) => {
  throw TypeError(e);
}, K = (e, t, i, o) => {
  for (var r = o > 1 ? void 0 : o ? Sv(t, i) : t, s = e.length - 1, n; s >= 0; s--)
    (n = e[s]) && (r = (o ? n(t, i, r) : n(r)) || r);
  return o && r && Pv(t, i, r), r;
}, Ov = (e, t, i) => t.has(e) || fu("Cannot " + i), Iv = (e, t, i) => t.has(e) ? fu("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, i), Av = (e, t, i) => (Ov(e, t, "access private method"), i), Fs, bu;
let z = class extends Le(
  Me("", v),
  ""
) {
  constructor() {
    super(), Iv(this, Fs), this.minlengthMessage = (e) => `${e} characters left`, this.maxlengthMessage = (e, t) => `Maximum length exceeded (${t}/${e} characters)`, this.disabled = !1, this.readonly = !1, this.placeholder = "", this.autoWidth = !1, this.inputMode = "text", this.tabIndex = 0, this._type = "text", this.addEventListener("mousedown", () => {
      this.style.setProperty("--uui-show-focus-outline", "0");
    }), this.addEventListener("blur", () => {
      this.style.setProperty("--uui-show-focus-outline", "");
    }), this.addEventListener("keydown", Av(this, Fs, bu)), this.addValidator(
      "tooShort",
      () => {
  ...
  onInput(e) {
    e.stopPropagation(), this.value = e.target.value, this.dispatchEvent(new Hr(Hr.INPUT));
  }
  onChange(e) {
    e.stopPropagation(), this.pristine = !1, this.dispatchEvent(new Hr(Hr.CHANGE));
  }
  renderPrepend() {
...
var Uv = Object.defineProperty, zv = Object.getOwnPropertyDescriptor, gu = (e) => {
  throw TypeError(e);
}, is = (e, t, i, o) => {
  for (var r = o > 1 ? void 0 : o ? zv(t, i) : t, s = e.length - 1, n; s >= 0; s--)
    (n = e[s]) && (r = (o ? n(t, i, r) : n(r)) || r);
  return o && r && Uv(t, i, r), r;
}, mu = (e, t, i) => t.has(e) || gu("Cannot " + i), Dv = (e, t, i) => (mu(e, t, "read from private field"), i ? i.call(e) : t.get(e)), Mv = (e, t, i) => t.has(e) ? gu("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, i), Lv = (e, t, i, o) => (mu(e, t, "write to private field"), t.set(e, i), i), ro;
let gi = class extends z {
  constructor() {
    super(), Mv(this, ro, !0), this.unlockLabel = "Unlock input", this.lockLabel = "Lock input", this.readonly = !0, this.tabIndex = -1;
  }
  set locked(e) {
    Lv(this, ro, e), this.tabIndex = e ? -1 : 0;
  }
  get locked() {
    return Dv(this, ro);
  }
  ...
  _onLockToggle() {
    this.readonly = this.locked = !this.locked, this.pristine = !1, this.dispatchEvent(new rl(rl.LOCK_CHANGE)), this.locked || this._input?.focus();
  }
  renderIcon() {
    return this.locked === !0 ? l`<uui-icon name="lock" .fallback=${jh.strings[0]}></uui-icon>` : l`<uui-icon
          name="unlock"
...
is([
  a({ type: Boolean, reflect: !0 })
], gi.prototype, "locked", 1);
is([
  a({ type: String, reflect: !1, attribute: "unlock-label" })
], gi.prototype, "unlockLabel", 2);
is([
  a({ type: String, reflect: !1, attribute: "lock-label" })
], gi.prototype, "lockLabel", 2);
gi = is([
  d("uui-input-lock")
], gi);
var Tv = Object.defineProperty, Nv = Object.getOwnPropertyDescriptor, Hn = (e, t, i, o) => {
  for (var r = o > 1 ? void 0 : o ? Nv(t, i) : t, s = e.length - 1, n; s >= 0; s--)
    (n = e[s]) && (r = (o ? n(t, i, r) : n(r)) || r);
  return o && r && Tv(t, i, r), r;
};
let dr = class extends z {
  ...
  renderIcon() {
    return this.passwordType === "password" ? l`<uui-icon name="see" .fallback=${Fh.strings[0]}></uui-icon>` : l`<uui-icon
          name="unsee"
...
var Vv = Object.getOwnPropertyDescriptor, Bv = (e, t, i, o) => {
  for (var r = o > 1 ? void 0 : o ? Vv(t, i) : t, s = e.length - 1, n; s >= 0; s--)
    (n = e[s]) && (r = n(r) || r);
  return r;
};
...
var Hv = Object.getOwnPropertyDescriptor, jv = (e, t, i, o) => {
  for (var r = o > 1 ? void 0 : o ? Hv(t, i) : t, s = e.length - 1, n; s >= 0; s--)
    (n = e[s]) && (r = n(r) || r);
  return r;
};
...
var Rv = Object.defineProperty, Fv = Object.getOwnPropertyDescriptor, rs = (e, t, i, o) => {
...
rs([
  a({ type: Boolean, reflect: !0 })
], mi.prototype, "required", 2);
mi = rs([
  d("uui-label")
], mi);
var Wv = Object.defineProperty, Gv = Object.getOwnPropertyDescriptor, jn = (e, t, i, o) => {
  for (var r = o > 1 ? void 0 : o ? Gv(t, i) : t, s = e.length - 1, n; s >= 0; s--)
    (n = e[s]) && (r = (o ? n(t, i, r) : n(r)) || r);
  return o && r && Wv(t, i, r), r;
};
...
jn([
  a({ type: Number })
], pr.prototype, "progress", 1);
jn([
  a({ type: Number })
], pr.prototype, "animationDuration", 1);
pr = jn([
  d("uui-loader-bar")
], pr);
var qv = Object.defineProperty, Kv = Object.getOwnPropertyDescriptor, Rn = (e, t, i, o) => {
  for (var r = o > 1 ? void 0 : o ? Kv(t, i) : t, s = e.length - 1, n; s >= 0; s--)
    (n = e[s]) && (r = (o ? n(t, i, r) : n(r)) || r);
  return o && r && qv(t, i, r), r;
};
...
Rn([
  a({ type: Number })
], vr.prototype, "progress", 2);
Rn([
  a({ type: Boolean, reflect: !0, attribute: "show-progress" })
], vr.prototype, "showProgress", 2);
vr = Rn([
  d("uui-loader-circle")
], vr);
var Xv = Object.getOwnPropertyDescriptor, Yv = (e, t, i, o) => {
...
var Zv = Object.defineProperty, Qv = Object.getOwnPropertyDescriptor, _u = (e) => {
  throw TypeError(e);
}, me = (e, t, i, o) => {
  for (var r = o > 1 ? void 0 : o ? Qv(t, i) : t, s = e.length - 1, n; s >= 0; s--)
    (n = e[s]) && (r = (o ? n(t, i, r) : n(r)) || r);
  return o && r && Zv(t, i, r), r;
}, Jv = (e, t, i) => t.has(e) || _u("Cannot " + i), ef = (e, t, i) => t.has(e) ? _u("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, i), ks = (e, t, i) => (Jv(e, t, "access private method"), i), Gi, Ks, yu;
let ne = class extends Ko(
  ki($r(Me("label", v)))
) {
  constructor() {
    super(...arguments), ef(this, Gi), this.disabled = !1, this.showChildren = !1, this.hasChildren = !1, this.loading = !1, this.caretLabel = "Reveal the underlying items", this.iconSlotHasContent = !1, this._labelButtonChanged = (e) => {
      this.selectableTarget = e || this;
    }, this._iconSlotChanged = (e) => {
      this.iconSlotHasContent = e.target.assignedNodes({ flatten: !0 }).length > 0;
    }, this._onCaretClicked = () => {
      const e = this.showChildren ? rr.HIDE_CHILDREN : rr.SHOW_CHILDREN, t = new rr(e, { cancelable: !0 });
  ...
  _renderLabelAsAnchor() {
    return this.disabled ? l` <span id="label-button" ${Kr(this._labelButtonChanged)}>
        ${this._renderLabelInside()}
      </span>` : l` <a
      id="label-button"
      ${Kr(this._labelButtonChanged)}
      href=${_(this.href)}
      target=${_(this.target || void 0)}
      rel=${_(
      this.rel || _(
...
Ks = function() {
  ...
  const e = new rr(rr.CLICK_LABEL);
  this.dispatchEvent(e);
};
yu = function() {
  if (this.renderExpandSymbol) {
    const e = this.renderExpandSymbol();
    if (e)
      return e;
  }
  return l`<uui-symbol-expand
      aria-hidden="true"
...
], ne.prototype, "selectMode", 2);
me([
  a({ type: String, attribute: "caret-label" })
], ne.prototype, "caretLabel", 2);
me([
  a({ attribute: !1 })
], ne.prototype, "renderExpandSymbol", 2);
me([
  g()
], ne.prototype, "iconSlotHasContent", 2);
ne = me([
  d("uui-menu-item")
], ne);
var tf = Object.defineProperty, rf = Object.getOwnPropertyDescriptor, zi = (e, t, i, o) => {
  for (var r = o > 1 ? void 0 : o ? rf(t, i) : t, s = e.length - 1, n; s >= 0; s--)
    (n = e[s]) && (r = (o ? n(t, i, r) : n(r)) || r);
  return o && r && tf(t, i, r), r;
};
const of = "uui:modal-open", qi = "uui:modal-close", sf = "uui:modal-close-end";
class $e extends v {
  constructor() {
  ...
  forceClose() {
    this.isClosing = !0, this.isOpen = !1, this._dialogElement?.close(), this.dispatchEvent(new CustomEvent("close-end")), this.dispatchEvent(new CustomEvent(sf)), this.remove();
  }
  static {
    this.styles = [
      p`
...
var nf = Object.defineProperty, af = Object.getOwnPropertyDescriptor, wu = (e) => {
  throw TypeError(e);
}, xu = (e, t, i, o) => {
  for (var r = o > 1 ? void 0 : o ? af(t, i) : t, s = e.length - 1, n; s >= 0; s--)
    (n = e[s]) && (r = (o ? n(t, i, r) : n(r)) || r);
  return o && r && nf(t, i, r), r;
}, lf = (e, t, i) => t.has(e) || wu("Cannot " + i), ol = (e, t, i) => (lf(e, t, "read from private field"), i ? i.call(e) : t.get(e)), uf = (e, t, i) => t.has(e) ? wu("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, i), oo, Xs;
let fr = class extends $e {
  constructor() {
    super(...arguments), uf(this, oo), this.size = "full";
  }
  firstUpdated(e) {
...
var cf = Object.defineProperty, hf = Object.getOwnPropertyDescriptor, $u = (e) => {
  throw TypeError(e);
}, Di = (e, t, i, o) => {
  for (var r = o > 1 ? void 0 : o ? hf(t, i) : t, s = e.length - 1, n; s >= 0; s--)
    (n = e[s]) && (r = (o ? n(t, i, r) : n(r)) || r);
  return o && r && cf(t, i, r), r;
}, ku = (e, t, i) => t.has(e) || $u("Cannot " + i), Hi = (e, t, i) => (ku(e, t, "read from private field"), i ? i.call(e) : t.get(e)), Cs = (e, t, i) => t.has(e) ? $u("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, i), jr = (e, t, i) => (ku(e, t, "access private method"), i), Ys, Jt, ei, Zs, Qs;
let ft = class extends v {
  constructor() {
    super(), Cs(this, ei), this.sidebarGap = 64, this.transitionDurationMS = 250, Cs(this, Ys, () => {
      ...
      if (this._modals = this.modalSlot?.assignedElements({ flatten: !0 }).filter(
        ...
        (o) => o.removeEventListener(qi, Hi(this, Jt))
      ), this._modals.filter(
        (o) => e.indexOf(o) === -1
      ).forEach(
        (o) => o.addEventListener(qi, Hi(this, Jt))
      ...
      jr(this, ei, Zs).call(this), jr(this, ei, Qs).call(this);
    }), Cs(this, Jt, (e) => {
      ...
      jr(this, ei, Zs).call(this), jr(this, ei, Qs).call(this);
    }), this.addEventListener(qi, Hi(this, Jt));
  }
  firstUpdated(e) {
...
Di([
  P("slot")
], ft.prototype, "modalSlot", 2);
Di([
  g()
], ft.prototype, "_modals", 2);
Di([
  g()
], ft.prototype, "_sidebars", 2);
Di([
  a({ type: Number })
], ft.prototype, "sidebarGap", 2);
Di([
  a({ type: Number })
], ft.prototype, "transitionDurationMS", 2);
ft = Di([
  d("uui-modal-container")
], ft);
var df = Object.getOwnPropertyDescriptor, pf = (e, t, i, o) => {
  for (var r = o > 1 ? void 0 : o ? df(t, i) : t, s = e.length - 1, n; s >= 0; s--)
    (n = e[s]) && (r = n(r) || r);
  return r;
};
...
var vf = Object.defineProperty, ff = Object.getOwnPropertyDescriptor, ce = (e, t, i, o) => {
  for (var r = o > 1 ? void 0 : o ? ff(t, i) : t, s = e.length - 1, n; s >= 0; s--)
    (n = e[s]) && (r = (o ? n(t, i, r) : n(r)) || r);
  return o && r && vf(t, i, r), r;
};
const bf = 45, Es = (e, t, i) => Math.min(Math.max(e, t), i), gf = (e, t) => Array.from({ length: t - e + 1 }, (i, o) => e + o);
let ie = class extends v {
   ...
   */
  goToNextPage() {
    this.current++, this.dispatchEvent(new Kt(Kt.CHANGE));
  }
  /**
   ...
   */
  goToPage(e) {
    this.current = e, this.dispatchEvent(new Kt(Kt.CHANGE));
  }
...
var mf = Object.defineProperty, _f = Object.getOwnPropertyDescriptor, Er = (e, t, i, o) => {
  for (var r = o > 1 ? void 0 : o ? _f(t, i) : t, s = e.length - 1, n; s >= 0; s--)
    (n = e[s]) && (r = (o ? n(t, i, r) : n(r)) || r);
  return o && r && mf(t, i, r), r;
};
function Rr(e, t, i) {
...
let Nt = class extends v {
  ...
  _getScrollParents() {
    ...
    let r = e;
    for (; r; ) {
      if (t = getComputedStyle(r), i && t.position === "static") {
        r = this._getAncestorElement(r);
        continue;
      }
      if (o.test(t.overflow + t.overflowY + t.overflowX) && this._scrollParents.push(r), t.position === "fixed")
        return;
      r = this._getAncestorElement(r);
    }
    this._scrollParents.push(document.body);
  }
  _getAncestorElement(e) {
  ...
  _updatePlacement() {
    ...
    if (i != null && t != null) {
      ...
      if (this.placement === "auto") {
        const Ee = this._scrollParents[0], Ni = Ee.clientWidth, Ct = Ee.clientHeight, Ft = i.x - t.width, Wt = Ni - (i.x + i.width) - t.width, us = i.y - t.height, Pr = Ct - (i.y + i.height) - t.height;
        let Sr = 0.5, Or = 0.5;
        const ac = Math.max(Ft, Wt);
        let oa = Math.max(us, Pr);
        Pr > us && Pr > this.margin && (oa += 9999), ac > oa ? (Ft > Wt ? (Sr = 0, n = !0) : (Sr = 1, u = !0), O = this.margin) : (us > Pr ? (Or = 0, r = !0) : (Or = 1, s = !0), X = this.margin), m = Sr, f = Or, C = 1 - Sr, x = 1 - Or;
      } else
      ...
      r || s ? (this._scrollParents.forEach((Ee, Ni) => {
        const Ct = Ee === document.body ? 0 : o[Ni].x, Ft = -i.x + Ct, Wt = Ee.clientWidth - i.x - i.width + Be + Ct - (t.width - i.width) * (1 - m);
        Ce = Rr(Ce, Ft, Wt);
      }), Ce = Rr(Ce, -t.width, i.width)) : (n || u) && (this._scrollParents.forEach((Ee, Ni) => {
        const Ct = Ee === document.body ? 0 : o[Ni].y, Ft = -i.y + Ct, Wt = Ee.clientHeight - i.y - i.height + tt + Ct - (t.height - i.height) * (1 - f);
        it = Rr(it, Ft, Wt);
      }), it = Rr(it, -t.height, i.height)), (this._positionX !== Ce || this._positionY !== it) && (this._positionX = Ce, this._positionY = it, Be === Ce && tt === it && this._stopScrollListener(), e.style.left = `${this._positionX}px`, e.style.top = `${this._positionY}px`);
    }
  }
...
Er([
  P("#container")
], Nt.prototype, "containerElement", 2);
Er([
  a({ type: Number })
], Nt.prototype, "margin", 2);
Er([
  a({ type: String, reflect: !0 })
], Nt.prototype, "placement", 1);
Er([
  a({ type: Boolean, reflect: !0 })
], Nt.prototype, "open", 1);
Nt = Er([
...
var yf = Object.defineProperty, wf = Object.getOwnPropertyDescriptor, Cu = (e) => {
  throw TypeError(e);
}, jt = (e, t, i, o) => {
  for (var r = o > 1 ? void 0 : o ? wf(t, i) : t, s = e.length - 1, n; s >= 0; s--)
    (n = e[s]) && (r = (o ? n(t, i, r) : n(r)) || r);
  return o && r && yf(t, i, r), r;
}, Fn = (e, t, i) => t.has(e) || Cu("Cannot " + i), I = (e, t, i) => (Fn(e, t, "read from private field"), i ? i.call(e) : t.get(e)), We = (e, t, i) => t.has(e) ? Cu("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, i), Ki = (e, t, i, o) => (Fn(e, t, "write to private field"), t.set(e, i), i), nt = (e, t, i) => (Fn(e, t, "access private method"), i), Ge, lt, It, Xi, en, Ke, Yi, tn, Ie, rn, Eu, on, Pu, sn;
let et = class extends v {
  constructor() {
    super(), We(this, Ie), this.margin = 0, this._placement = "bottom-start", this._open = !1, this._actualPlacement = this._placement, We(this, Ge, null), We(this, lt, []), We(this, It, null), We(this, Xi, { width: 0, height: 0 }), We(this, en, (e) => {
      this._open = e.newState === "open", Ki(this, Ge, Vh(
        this,
        "popovertarget",
        this.id
      )), I(this, Ge)?.dispatchEvent(
        new CustomEvent("uui-popover-before-toggle", {
          bubbles: !1,
          composed: !1,
          detail: { oldState: e.oldState, newState: e.newState }
        })
      ), this._open ? (nt(this, Ie, Pu).call(this), nt(this, Ie, Eu).call(this), requestAnimationFrame(() => {
        I(this, Ke).call(this);
      })) : nt(this, Ie, on).call(this);
    }), We(this, Ke, () => {
      this._open && (this._actualPlacement = this._placement, this.style.opacity = "0", I(this, Yi).call(this, 3));
    }), We(this, Yi, (e) => {
      if (I(this, tn).call(this), e--, I(this, Ge) === null) return;
      ...
      if (Math.max(x, O) !== h && (t || i) && e > 0) {
        nt(this, Ie, rn).call(this), I(this, Yi).call(this, e);
        return;
      }
      h = Math.max(x, O);
      const Be = Math.min(
    ...
    }), this.addEventListener("beforetoggle", I(this, en), {
      passive: !0
    });
  }
  get open() {
  ...
  connectedCallback() {
    super.connectedCallback(), this.hasAttribute("popover") || this.setAttribute("popover", ""), I(this, It) || (Ki(this, It, new ResizeObserver((e) => {
      const t = e[0], i = t.contentRect.width, o = t.contentRect.height;
      i === I(this, Xi).width && o === I(this, Xi).height || (Ki(this, Xi, { width: i, height: o }), I(this, Ke).call(this));
    })), I(this, It).observe(this));
  }
  disconnectedCallback() {
    super.disconnectedCallback(), nt(this, Ie, on).call(this), I(this, It)?.disconnect(), Ki(this, It, null);
  }
  /**
   * @internal
   */
...
Pu = function() {
  if (Ki(this, lt, []), !I(this, Ge)) return;
  let e = getComputedStyle(I(this, Ge));
  if (e.position === "fixed")
    return;
  let t = e.position === "absolute";
  const i = /(auto|scroll)/;
  let o = I(this, Ge);
  for (; o; ) {
    if (e = getComputedStyle(o), t && e.position === "static") {
      o = nt(this, Ie, sn).call(this, o);
      continue;
    }
    if (e.position !== "static" && (t = e.position === "absolute"), i.test(e.overflow + e.overflowY + e.overflowX) && I(this, lt).push(o), e.position === "fixed")
      return;
    o = nt(this, Ie, sn).call(this, o);
  }
  I(this, lt).push(document.body);
};
sn = function(e) {
  return e?.parentElement ? e.parentElement : e?.getRootNode()?.host;
};
...
var xf = Object.defineProperty, $f = Object.getOwnPropertyDescriptor, Su = (e, t, i, o) => {
  for (var r = o > 1 ? void 0 : o ? $f(t, i) : t, s = e.length - 1, n; s >= 0; s--)
    (n = e[s]) && (r = (o ? n(t, i, r) : n(r)) || r);
  return o && r && xf(t, i, r), r;
};
const kf = (e, t, i) => Math.min(Math.max(e, t), i);
let Po = class extends v {
  ...
  set progress(e) {
    const t = this._progress;
    this._progress = kf(e, 0, 100), this.requestUpdate("progress", t);
  }
  _getProgressStyle() {
...
var Cf = Object.defineProperty, Ef = Object.getOwnPropertyDescriptor, Ou = (e) => {
  throw TypeError(e);
}, kt = (e, t, i, o) => {
  for (var r = o > 1 ? void 0 : o ? Ef(t, i) : t, s = e.length - 1, n; s >= 0; s--)
    (n = e[s]) && (r = (o ? n(t, i, r) : n(r)) || r);
  return o && r && Cf(t, i, r), r;
}, Pf = (e, t, i) => t.has(e) || Ou("Cannot " + i), Sf = (e, t, i) => t.has(e) ? Ou("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, i), Of = (e, t, i) => (Pf(e, t, "access private method"), i), nn, Iu;
let we = class extends v {
  constructor() {
    super(...arguments), Sf(this, nn), this.name = "", this.value = "", this.label = "", this.checked = !1, this.disabled = !1, this.readonly = !1;
  }
  focus() {
...
Iu = function(e) {
  ...
  this.checked = t, t && this.focus(), this.dispatchEvent(new So(So.CHANGE));
};
we.styles = [
  Xo,
  p`
...
var If = Object.defineProperty, Af = Object.getOwnPropertyDescriptor, Au = (e) => {
  throw TypeError(e);
}, Wn = (e, t, i, o) => {
  for (var r = o > 1 ? void 0 : o ? Af(t, i) : t, s = e.length - 1, n; s >= 0; s--)
    (n = e[s]) && (r = (o ? n(t, i, r) : n(r)) || r);
  return o && r && If(t, i, r), r;
}, Gn = (e, t, i) => t.has(e) || Au("Cannot " + i), w = (e, t, i) => (Gn(e, t, "read from private field"), i ? i.call(e) : t.get(e)), rt = (e, t, i) => t.has(e) ? Au("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, i), so = (e, t, i, o) => (Gn(e, t, "write to private field"), t.set(e, i), i), N = (e, t, i) => (Gn(e, t, "access private method"), i), H, U, an, ln, Oo, Io, un, M, Uu, qn, cn, Kn, Xn, Dt, zu, Du, br;
const Uf = "ArrowLeft", zf = "ArrowUp", Df = "ArrowRight", Mf = "ArrowDown", Lf = " ", Tf = "Enter";
let _i = class extends Le(v, "") {
  constructor() {
    super(), rt(this, M), this.disabled = !1, this.readonly = !1, rt(this, H, null), rt(this, U, []), rt(this, an, (e) => {
      w(this, U)?.forEach((t) => {
      ...
      e.target.checked === !0 && (this.value = e.target.value, N(this, M, br).call(this));
    }), rt(this, un, (e) => {
      switch (e.key) {
        case Uf:
        case zf: {
          e.preventDefault(), N(this, M, zu).call(this);
          break;
        }
        case Df:
        case Mf: {
          e.preventDefault(), N(this, M, Du).call(this);
          break;
        }
        case Lf: {
          w(this, H) === null && (this.value = N(this, M, Dt).call(this, 1, !1)?.value, N(this, M, br).call(this));
          break;
        }
        case Tf:
          this.submit();
      }
    }), this.addEventListener("keydown", w(this, un)), this.addEventListener("focusin", w(this, an)), this.addEventListener("focusout", w(this, ln)), this.updateComplete.then(() => {
      N(this, M, cn).call(this, this.value);
    });
  }
  get value() {
    return super.value;
  ...
  set value(e) {
    super.value = e, N(this, M, cn).call(this, e);
  }
  connectedCallback() {
    super.connectedCallback(), this.hasAttribute("role") || this.setAttribute("role", "radiogroup");
  }
  updated(e) {
    super.updated(e), e.has("disabled") && N(this, M, Kn).call(this, this.disabled), e.has("readonly") && N(this, M, Xn).call(this, this.readonly), e.has("name") && N(this, M, qn).call(this, e.get("name"));
  }
  /**
   * This method enables <label for="..."> to focus the select
   */
  async focus() {
    await this.updateComplete, w(this, H) !== null ? w(this, U)[w(this, H)]?.focus() : N(this, M, Dt).call(this, 1, !1)?.focus();
  }
  async blur() {
    await this.updateComplete, w(this, H) !== null ? w(this, U)[w(this, H)]?.blur() : N(this, M, Dt).call(this, 1, !1)?.blur();
  }
  async click() {
    await this.updateComplete, w(this, H) !== null ? w(this, U)[w(this, H)]?.click() : N(this, M, Dt).call(this, 1, !1)?.click();
  }
  getFormElement() {
  ...
  render() {
    return l` <slot @slotchange=${N(this, M, Uu)}></slot> `;
  }
};
...
Uu = function(e) {
  if (e.stopPropagation(), w(this, U)?.forEach((i) => {
    i.removeEventListener(
      ...
      w(this, Io)
    ), i.removeEventListener("blur", w(this, Oo));
  }), so(this, H, null), so(this, U, e.target.assignedElements({ flatten: !0 }).filter((i) => i instanceof we)), w(this, U).length === 0) return;
  w(this, U).forEach((i) => {
    i.addEventListener(
      So.CHANGE,
      // @ts-ignore TODO: fix typescript error
      w(this, Io)
    ), i.addEventListener("blur", w(this, Oo));
  }), N(this, M, qn).call(this, this.name), this.disabled && N(this, M, Kn).call(this, !0), this.readonly && N(this, M, Xn).call(this, !0);
  ...
  if (t.length > 1 && (w(this, U).forEach((i) => {
    ...
    const i = t[0];
    this.value = i.value, so(this, H, w(this, U).indexOf(i));
  }
};
qn = function(e) {
...
cn = function(e) {
  ...
  w(this, U).forEach((i, o) => {
    i.value === e ? (i.checked = !0, i.makeFocusable(), so(this, H, o)) : (i.checked = !1, t.push(i));
...
zu = function() {
  this.value = N(this, M, Dt).call(this, -1)?.value ?? "", w(this, U)[w(this, H) ?? 0]?.focus(), N(this, M, br).call(this);
};
Du = function() {
  this.value = N(this, M, Dt).call(this)?.value ?? "", w(this, U)[w(this, H) ?? 0]?.focus(), N(this, M, br).call(this);
};
br = function() {
...
var Nf = Object.defineProperty, Vf = Object.getOwnPropertyDescriptor, Mu = (e) => {
  throw TypeError(e);
}, T = (e, t, i, o) => {
  for (var r = o > 1 ? void 0 : o ? Vf(t, i) : t, s = e.length - 1, n; s >= 0; s--)
    (n = e[s]) && (r = (o ? n(t, i, r) : n(r)) || r);
  return o && r && Nf(t, i, r), r;
}, Lu = (e, t, i) => t.has(e) || Mu("Cannot " + i), Bf = (e, t, i) => (Lu(e, t, "read from private field"), i ? i.call(e) : t.get(e)), al = (e, t, i) => t.has(e) ? Mu("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, i), Xt = (e, t, i) => (Lu(e, t, "access private method"), i), st, At, hn;
const Ps = {
  TOP: 3,
  CENTER: 2
}, ji = 18, ai = 3, qe = 12, Hf = 24, Ss = (e) => {
  const t = e.toString().indexOf(".");
  return t >= 0 ? e.toString().length - t - 1 : 0;
};
let D = class extends Le(v, "") {
  ...
  constructor() {
    super(), al(this, st), this.disabled = !1, this.readonly = !1, this._min = 0, this._max = 0, this.hideStepValues = !1, this._step = 1, this._movement = !1, this.startPoint = {
      ...
      low: 0,
      high: 0
    }, this._lowInputValue = 0, this._highInputValue = 0, this._trackWidth = 0, this._lowValuePercentStart = 0, this._highValuePercentEnd = 100, al(this, hn, (e) => {
    ...
    }, this.addEventListener("keydown", Bf(this, hn)), this.addEventListener("mousedown", this._onMouseDown), this.addEventListener("touchstart", this._onTouchStart), window.addEventListener("resize", () => {
  ...
  set min(e) {
    this._min = e, Xt(this, st, At).call(this);
  }
  get max() {
    return this._max;
  }
  set max(e) {
    this._max = e, Xt(this, st, At).call(this);
  }
  get step() {
    return this._step;
  }
  set step(e) {
    this._step = e, Xt(this, st, At).call(this);
  }
  get minGap() {
    return this._minGap;
  }
  set minGap(e) {
    this._minGap = e, Xt(this, st, At).call(this);
  }
  get maxGap() {
    return this._maxGap;
  }
  set maxGap(e) {
    this._maxGap = e, Xt(this, st, At).call(this);
  }
  get value() {
    return super.value;
  }
  set value(e) {
    super.value = e, Xt(this, st, At).call(this);
  }
  setValueLow(e) {
    e = A(
      e,
  ...
  _renderStepCircles(e) {
    ...
    return b`${e.map((i) => {
      ...
      return o / t >= r && o / t <= s ? b`<circle class="track-step filled" cx="${o}" cy="${ai * 2}" r="4.5" />` : b`<circle class="track-step regular" cx="${o}" cy="${ai * 2}" r="4.5" />`;
    })}`;
  }
  _renderNativeInputs() {
...
], D.prototype, "hideStepValues", 2);
T([
  a({ type: Number })
], D.prototype, "step", 1);
T([
  a({ type: Number, attribute: "min-gap" })
], D.prototype, "minGap", 1);
T([
  a({ type: Number, attribute: "max-gap" })
], D.prototype, "maxGap", 1);
T([
  a({ type: String })
], D.prototype, "value", 1);
T([
  g()
], D.prototype, "_movement", 2);
T([
  g()
], D.prototype, "_lowInputValue", 2);
T([
  g()
], D.prototype, "_highInputValue", 2);
T([
  g()
], D.prototype, "_trackWidth", 2);
T([
  g()
], D.prototype, "_lowValuePercentStart", 2);
T([
  g()
], D.prototype, "_highValuePercentEnd", 2);
T([
  P("#range-slider")
], D.prototype, "_outerTrack", 2);
T([
  P("#inputLow")
], D.prototype, "_inputLow", 2);
T([
  P("#inputHigh")
], D.prototype, "_inputHigh", 2);
T([
  P(".color")
], D.prototype, "_innerColor", 2);
T([
  P("#inner-color-thumb")
], D.prototype, "_innerColorThumb", 2);
D = T([
  d("uui-range-slider")
], D);
var jf = Object.getOwnPropertyDescriptor, Rf = (e, t, i, o) => {
...
var Ff = Object.defineProperty, Wf = Object.getOwnPropertyDescriptor, os = (e, t, i, o) => {
  for (var r = o > 1 ? void 0 : o ? Wf(t, i) : t, s = e.length - 1, n; s >= 0; s--)
    (n = e[s]) && (r = (o ? n(t, i, r) : n(r)) || r);
  return o && r && Ff(t, i, r), r;
};
let bt = class extends Ko(
  ki(v)
) {
  constructor() {
  ...
  handleOpenClick(e) {
    e.stopPropagation(), this.dispatchEvent(new Fr(Fr.OPEN));
  }
  handleOpenKeydown(e) {
    e.key !== " " && e.key !== "Enter" || (e.preventDefault(), e.stopPropagation(), this.dispatchEvent(new Fr(Fr.OPEN)));
  }
};
bt.styles = [
  p`
...
os([
  a({ type: Boolean, reflect: !0 })
], bt.prototype, "error", 2);
bt = os([
  d("uui-ref")
], bt);
var Gf = Object.defineProperty, qf = Object.getOwnPropertyDescriptor, Tu = (e) => {
  throw TypeError(e);
}, Rt = (e, t, i, o) => {
  for (var r = o > 1 ? void 0 : o ? qf(t, i) : t, s = e.length - 1, n; s >= 0; s--)
    (n = e[s]) && (r = (o ? n(t, i, r) : n(r)) || r);
  return o && r && Gf(t, i, r), r;
}, Kf = (e, t, i) => t.has(e) || Tu("Cannot " + i), Xf = (e, t, i) => t.has(e) ? Tu("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, i), ut = (e, t, i) => (Kf(e, t, "access private method"), i), Ue, Nu, Vu, ss, Bu, Hu, ju;
let V = class extends bt {
  constructor() {
    super(...arguments), Xf(this, Ue), this.name = "", this.detail = "", this._iconSlotHasContent = !1, this.fallbackIcon = `<svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
    fill="none"
    stroke="currentColor"
...
ss = function() {
  return l`
      <span id="content" class="uui-text">
        <span id="icon">
          <slot name="icon" @slotchange=${ut(this, Ue, Nu)}></slot>
          ${this._iconSlotHasContent === !1 ? ut(this, Ue, Vu).call(this) : ""}
        </span>
        <div id="info">
...
ju = function() {
  return this.readonly ? l`${ut(this, Ue, ss).call(this)}` : this.href ? ut(this, Ue, Bu).call(this) : ut(this, Ue, Hu).call(this);
};
V.styles = [
  ...bt.styles,
  p`
...
var Yf = Object.defineProperty, Zf = Object.getOwnPropertyDescriptor, Ru = (e, t, i, o) => {
...
Ru([
  a({ type: String })
], Ao.prototype, "alias", 2);
Ao = Ru([
  d("uui-ref-node-data-type")
], Ao);
var Qf = Object.defineProperty, Jf = Object.getOwnPropertyDescriptor, Fu = (e, t, i, o) => {
  for (var r = o > 1 ? void 0 : o ? Jf(t, i) : t, s = e.length - 1, n; s >= 0; s--)
    (n = e[s]) && (r = (o ? n(t, i, r) : n(r)) || r);
...
var eb = Object.getOwnPropertyDescriptor, tb = (e, t, i, o) => {
  for (var r = o > 1 ? void 0 : o ? eb(t, i) : t, s = e.length - 1, n; s >= 0; s--)
    (n = e[s]) && (r = n(r) || r);
  return r;
};
let pn = class extends V {
  constructor() {
...
var ib = Object.defineProperty, rb = Object.getOwnPropertyDescriptor, Wu = (e, t, i, o) => {
  for (var r = o > 1 ? void 0 : o ? rb(t, i) : t, s = e.length - 1, n; s >= 0; s--)
    (n = e[s]) && (r = (o ? n(t, i, r) : n(r)) || r);
  return o && r && ib(t, i, r), r;
};
...
], zo.prototype, "groupName", 2);
zo = Wu([
  d("uui-ref-node-member")
], zo);
var ob = Object.defineProperty, sb = Object.getOwnPropertyDescriptor, Yn = (e, t, i, o) => {
...
Yn([
  a({ type: String })
], gr.prototype, "version", 2);
Yn([
  a({ type: String })
], gr.prototype, "author", 2);
gr = Yn([
  d("uui-ref-node-package")
], gr);
var nb = Object.defineProperty, ab = Object.getOwnPropertyDescriptor, Gu = (e, t, i, o) => {
...
var lb = Object.defineProperty, ub = Object.getOwnPropertyDescriptor, qu = (e, t, i, o) => {
  for (var r = o > 1 ? void 0 : o ? ub(t, i) : t, s = e.length - 1, n; s >= 0; s--)
    (n = e[s]) && (r = (o ? n(t, i, r) : n(r)) || r);
  return o && r && lb(t, i, r), r;
};
...
var cb = Object.defineProperty, hb = Object.getOwnPropertyDescriptor, ke = (e, t, i, o) => {
...
var pb = Object.defineProperty, vb = Object.getOwnPropertyDescriptor, Ku = (e) => {
  throw TypeError(e);
}, re = (e, t, i, o) => {
  for (var r = o > 1 ? void 0 : o ? vb(t, i) : t, s = e.length - 1, n; s >= 0; s--)
    (n = e[s]) && (r = (o ? n(t, i, r) : n(r)) || r);
  return o && r && pb(t, i, r), r;
}, Zn = (e, t, i) => t.has(e) || Ku("Cannot " + i), ul = (e, t, i) => (Zn(e, t, "read from private field"), i ? i.call(e) : t.get(e)), Os = (e, t, i) => t.has(e) ? Ku("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, i), cl = (e, t, i, o) => (Zn(e, t, "write to private field"), t.set(e, i), i), fb = (e, t, i) => (Zn(e, t, "access private method"), i), no, ao, vn, Xu;
const or = 12, hl = 24, bb = (e, t, i) => Array.from({ length: (t - e) / i + 1 }, (o, r) => e + r * i), gb = (e) => {
  const t = e.toString().indexOf(".");
  return t >= 0 ? e.toString().length - t - 1 : 0;
};
let q = class extends Le(v, "") {
  constructor() {
    super(), Os(this, vn), Os(this, no, 0), this.hideStepValues = !1, this.hideValueLabel = !1, this.min = 0, this.max = 100, Os(this, ao, 1), this.disabled = !1, this.readonly = !1, this._stepWidth = 0, this.onWindowResize = () => {
      this._stepWidth = this._calculateStepWidth();
    }, this._steps = [], this._sliderPosition = "0%", this.addEventListener("mousedown", () => {
      this.style.setProperty("--uui-show-focus-outline", "0");
    }), this.addEventListener("blur", () => {
      this.style.setProperty("--uui-show-focus-outline", "");
    }), this.addEventListener("keydown", fb(this, vn, Xu));
  }
  get step() {
    return ul(this, ao);
  }
  set step(e) {
    cl(this, ao, e), cl(this, no, (e.toString().split(".")[1] || []).length);
  }
  get value() {
    return super.value;
  }
  set value(e) {
    ...
    i = Math.min(Math.max(i, this.min), this.max), this.step > 0 && (i = Math.round(i / this.step) * this.step), super.value = i.toFixed(ul(this, no)).toString(), this._calculateSliderPosition(), this.requestUpdate("value", t);
  }
  /**
   * This method enables <label for="..."> to focus the select
   */
  ...
  _updateSteps() {
    this._steps = bb(this.min, this.max, this.step), this._stepWidth = this._calculateStepWidth();
  }
  _calculateStepWidth() {
    return (this._track.getBoundingClientRect().width - or * 2) / (this._steps.length - 1);
  }
  ...
  _onInput(e) {
    e.stopPropagation(), this.value = this._input.value, this.dispatchEvent(new Wr(Wr.INPUT));
  }
  _onChange(e) {
    e.stopPropagation(), this.pristine = !1, this.dispatchEvent(new Wr(Wr.CHANGE));
  }
  renderTrackSteps() {
    return b`
  ${this._steps.map((e) => {
      if (this._stepWidth >= hl) {
        const t = Math.round(
          or + this._stepWidth * this._steps.indexOf(e)
        );
...
`;
  ...
  renderStepValues() {
    return this.hideStepValues ? k : l`<div id="step-values">
      ...
      (e) => l` <span
            ><span>
              ${this._steps.length <= 20 && this._stepWidth >= hl ? e.toFixed(gb(this.step)) : k}
            </span></span
          >`
    )}
    </div>`;
...
q.styles = [
  ...
  p`
      ...
      #track-inner {
        position: absolute;
        left: ${or}px; /* Match TRACK_MARGIN */
        right: ${or}px; /* Match TRACK_MARGIN */
      }
    ...
    226
      ...
      #step-values {
        margin: 0 ${or}px; /* Match TRACK_MARGIN */
        margin-top: 6px;
        display: flex;
...
var mb = Object.defineProperty, _b = Object.getOwnPropertyDescriptor, Yu = (e, t, i, o) => {
  for (var r = o > 1 ? void 0 : o ? _b(t, i) : t, s = e.length - 1, n; s >= 0; s--)
    (n = e[s]) && (r = (o ? n(t, i, r) : n(r)) || r);
  return o && r && mb(t, i, r), r;
};
...
var yb = Object.defineProperty, wb = Object.getOwnPropertyDescriptor, Qn = (e, t, i, o) => {
  for (var r = o > 1 ? void 0 : o ? wb(t, i) : t, s = e.length - 1, n; s >= 0; s--)
    (n = e[s]) && (r = (o ? n(t, i, r) : n(r)) || r);
  return o && r && yb(t, i, r), r;
};
let mr = class extends v {
  ...
  render() {
    return this.src ? l`<img src=${this.src} alt=${this.alt} />` : l`<uui-icon
          name="picture"
          .fallback=${Rh.strings[0]}></uui-icon>`;
  }
};
mr.styles = [
  p`
...
var xb = Object.defineProperty, $b = Object.getOwnPropertyDescriptor, Zu = (e, t, i, o) => {
...
var kb = Object.getOwnPropertyDescriptor, Cb = (e, t, i, o) => {
...
var Eb = Object.defineProperty, Pb = Object.getOwnPropertyDescriptor, Qu = (e, t, i, o) => {
  for (var r = o > 1 ? void 0 : o ? Pb(t, i) : t, s = e.length - 1, n; s >= 0; s--)
    (n = e[s]) && (r = (o ? n(t, i, r) : n(r)) || r);
  return o && r && Eb(t, i, r), r;
};
...
var Sb = Object.getOwnPropertyDescriptor, Ob = (e, t, i, o) => {
  for (var r = o > 1 ? void 0 : o ? Sb(t, i) : t, s = e.length - 1, n; s >= 0; s--)
    (n = e[s]) && (r = n(r) || r);
  return r;
};
...
var Ib = Object.defineProperty, Ab = Object.getOwnPropertyDescriptor, Ju = (e, t, i, o) => {
  for (var r = o > 1 ? void 0 : o ? Ab(t, i) : t, s = e.length - 1, n; s >= 0; s--)
    (n = e[s]) && (r = (o ? n(t, i, r) : n(r)) || r);
  return o && r && Ib(t, i, r), r;
};
let Vo = class extends $r(v) {
  constructor() {
...
Ju([
  a({ type: Boolean, reflect: !0 })
], Vo.prototype, "descending", 2);
Vo = Ju([
  d("uui-symbol-sort")
], Vo);
var Ub = Object.getOwnPropertyDescriptor, zb = (e, t, i, o) => {
  for (var r = o > 1 ? void 0 : o ? Ub(t, i) : t, s = e.length - 1, n; s >= 0; s--)
    (n = e[s]) && (r = n(r) || r);
  return r;
};
...
var Db = Object.defineProperty, Mb = Object.getOwnPropertyDescriptor, ns = (e, t, i, o) => {
...
], gt.prototype, "disableChildInteraction", 2);
ns([
  a({ type: Boolean, reflect: !0, attribute: "no-padding" })
], gt.prototype, "noPadding", 2);
ns([
  a({ type: Boolean, reflect: !0, attribute: "clip-text" })
], gt.prototype, "clipText", 2);
gt = ns([
  d("uui-table-cell")
], gt);
var Lb = Object.getOwnPropertyDescriptor, Tb = (e, t, i, o) => {
  for (var r = o > 1 ? void 0 : o ? Lb(t, i) : t, s = e.length - 1, n; s >= 0; s--)
    (n = e[s]) && (r = n(r) || r);
  return r;
};
let mn = class extends v {
};
mn.styles = [
  p`
      :host {
...
var Nb = Object.getOwnPropertyDescriptor, Vb = (e, t, i, o) => {
  for (var r = o > 1 ? void 0 : o ? Nb(t, i) : t, s = e.length - 1, n; s >= 0; s--)
    (n = e[s]) && (r = n(r) || r);
  return r;
};
let _n = class extends gt {
  connectedCallback() {
...
var Bb = Object.getOwnPropertyDescriptor, Hb = (e, t, i, o) => {
...
var jb = Object.defineProperty, Rb = Object.getOwnPropertyDescriptor, ec = (e, t, i, o) => {
  for (var r = o > 1 ? void 0 : o ? Rb(t, i) : t, s = e.length - 1, n; s >= 0; s--)
    (n = e[s]) && (r = (o ? n(t, i, r) : n(r)) || r);
  return o && r && jb(t, i, r), r;
};
let Bo = class extends Ko(
  ki(v)
) {
  constructor() {
    super();
...
], Bo.prototype, "slotCellNodes", 2);
Bo = ec([
  d("uui-table-row")
], Bo);
var Fb = Object.defineProperty, Wb = Object.getOwnPropertyDescriptor, Mi = (e, t, i, o) => {
  for (var r = o > 1 ? void 0 : o ? Wb(t, i) : t, s = e.length - 1, n; s >= 0; s--)
    (n = e[s]) && (r = (o ? n(t, i, r) : n(r)) || r);
  return o && r && Fb(t, i, r), r;
};
let mt = class extends $r(Me("", v)) {
  constructor() {
...
var Gb = Object.defineProperty, qb = Object.getOwnPropertyDescriptor, tc = (e) => {
  throw TypeError(e);
}, Li = (e, t, i, o) => {
  for (var r = o > 1 ? void 0 : o ? qb(t, i) : t, s = e.length - 1, n; s >= 0; s--)
    (n = e[s]) && (r = (o ? n(t, i, r) : n(r)) || r);
  return o && r && Gb(t, i, r), r;
}, Jn = (e, t, i) => t.has(e) || tc("Cannot " + i), E = (e, t, i) => (Jn(e, t, "read from private field"), i ? i.call(e) : t.get(e)), Se = (e, t, i) => t.has(e) ? tc("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, i), sr = (e, t, i, o) => (Jn(e, t, "write to private field"), t.set(e, i), i), ae = (e, t, i) => (Jn(e, t, "access private method"), i), as, ze, Xe, li, yi, Ho, _r, nr, te, ic, rc, ea, oc, wi, ls, sc, ta, wn;
let _t = class extends v {
  constructor() {
    super(...arguments), Se(this, te), Se(this, as, 0), this.dropdownContentDirection = "vertical", Se(this, ze, []), Se(this, Xe, []), Se(this, li, /* @__PURE__ */ new Map()), Se(this, yi, []), Se(this, Ho, new ResizeObserver(ae(this, te, rc).bind(this))), Se(this, _r, []), Se(this, nr, !1), Se(this, wi, (e) => {
      const t = e.currentTarget;
      if (ae(this, te, wn).call(this, t)) {
        t.active = !0;
        const i = E(this, li).get(t);
        i && (i.active = !0), [
          ...E(this, ze),
          ...E(this, Xe)
        ].filter((s) => s !== t && s !== i).forEach((s) => {
          ae(this, te, wn).call(this, s) && (s.active = !1);
        }), E(this, Xe).some(
          (s) => s.active && s !== i
  ...
  connectedCallback() {
    super.connectedCallback(), ae(this, te, ic).call(this);
  }
  disconnectedCallback() {
    super.disconnectedCallback(), E(this, Ho).unobserve(this), ae(this, te, ea).call(this);
  }
  render() {
    return l`
      <div id="main">
        <div id="grid" role="tablist">
          <slot @slotchange=${ae(this, te, oc)}></slot>
        </div>
        <uui-button
...
ic = async function() {
  y(this, "uui-button"), y(this, "uui-popover-container"), y(this, "uui-symbol-more"), await this.updateComplete, E(this, Ho).observe(this._mainElement);
};
rc = function(e) {
  const t = Number.parseFloat(
    this.style.getPropertyValue("--uui-tab-group-gap")
  );
  (Number.isNaN(t) ? 0 : t) !== E(this, as) ? ae(this, te, ls).call(this) : ae(this, te, ta).call(this, e[0].contentBoxSize[0].inlineSize);
};
ea = function() {
  E(this, ze).forEach((e) => {
    e.removeEventListener("click", E(this, wi)), E(this, _r).forEach((t) => t.disconnect());
  }), E(this, _r).length = 0, E(this, yi).length = 0;
};
oc = function() {
  ae(this, te, ea).call(this), ae(this, te, sc).call(this), E(this, ze).forEach((e) => {
    e.addEventListener("click", E(this, wi));
    const t = new ResizeObserver(
      ae(this, te, ls).bind(this)
    );
    t.observe(e), E(this, _r).push(t);
  });
};
wi = /* @__PURE__ */ new WeakMap();
ls = async function() {
  if (E(this, nr)) return;
  sr(this, nr, !0), requestAnimationFrame(() => {
    sr(this, nr, !1);
  ...
  const o = 2;
  this._mainElement.style.width = i - t + o + "px", ae(this, te, ta).call(this, this._mainElement.offsetWidth);
};
sc = function() {
  sr(this, ze, this._slottedNodes ? this._slottedNodes : []), ae(this, te, ls).call(this);
};
ta = function(e) {
  const t = this._moreButtonElement.offsetWidth, i = e - (t || 0);
  E(this, Xe).forEach((s) => {
    s.removeEventListener("click", E(this, wi));
  }), sr(this, Xe, []), E(this, li).clear();
  let o = !1;
  ...
  for (let s = 0; s < r; s++) {
    ...
    if (n <= (s === r - 1 ? e : i))
      ...
      c.addEventListener("click", E(this, wi)), c.classList.add("hidden-tab"), c.style.display = "", c.orientation = this.dropdownContentDirection, E(this, li).set(c, u), E(this, li).set(u, c), E(this, Xe).push(c), u.style.display = "none", u.active && (o = !0);
    }
  }
...
Li([
  P("#more-button")
], _t.prototype, "_moreButtonElement", 2);
Li([
  P("#popover-container")
], _t.prototype, "_popoverContainerElement", 2);
Li([
  P("#main")
], _t.prototype, "_mainElement", 2);
Li([
  xt({
    flatten: !0,
    selector: "uui-tab, [uui-tab], [role=tab]"
  })
], _t.prototype, "_slottedNodes", 2);
Li([
  a({
    type: String,
    reflect: !0,
...
], _t.prototype, "dropdownContentDirection", 2);
_t = Li([
  d("uui-tab-group")
], _t);
class Kg extends S {
...
var Kb = Object.defineProperty, Xb = Object.getOwnPropertyDescriptor, ia = (e, t, i, o) => {
  for (var r = o > 1 ? void 0 : o ? Xb(t, i) : t, s = e.length - 1, n; s >= 0; s--)
    (n = e[s]) && (r = (o ? n(t, i, r) : n(r)) || r);
  return o && r && Kb(t, i, r), r;
};
...
var Yb = Object.defineProperty, Zb = Object.getOwnPropertyDescriptor, ee = (e, t, i, o) => {
...
var Qb = Object.defineProperty, Jb = Object.getOwnPropertyDescriptor, Ti = (e, t, i, o) => {
...
let yt = class extends v {
  ...
  set autoClose(e) {
    this._autoClose = e, e !== null ? (this._timer === null ? this._timer = new Nh(this._onOpenTimerComplete, e) : this._timer.setDuration(e), this._pauseTimer === !1 && this.isOpen === !0 && this._animate === !1 && this._timer.start()) : (this._timer?.destroy(), this._timer = null);
  }
  /**
...
Ti([
  a({ type: Number })
], yt.prototype, "autoClose", 1);
Ti([
  P("#toast")
], yt.prototype, "_toastEl", 2);
Ti([
  g()
], yt.prototype, "_animate", 2);
Ti([
  a({ type: Boolean, reflect: !0 })
], yt.prototype, "open", 1);
yt = Ti([
...
var eg = Object.defineProperty, tg = Object.getOwnPropertyDescriptor, nc = (e, t, i, o) => {
  for (var r = o > 1 ? void 0 : o ? tg(t, i) : t, s = e.length - 1, n; s >= 0; s--)
    (n = e[s]) && (r = (o ? n(t, i, r) : n(r)) || r);
  return o && r && eg(t, i, r), r;
};
...
], jo.prototype, "_autoClose", 2);
jo = nc([
  d("uui-toast-notification-container")
], jo);
var ig = Object.defineProperty, rg = Object.getOwnPropertyDescriptor, ra = (e, t, i, o) => {
  for (var r = o > 1 ? void 0 : o ? rg(t, i) : t, s = e.length - 1, n; s >= 0; s--)
    (n = e[s]) && (r = (o ? n(t, i, r) : n(r)) || r);
  return o && r && ig(t, i, r), r;
};
...
ra([
  a({ type: String })
], wr.prototype, "headline", 2);
ra([
  g()
], wr.prototype, "_headlineSlotHasContent", 2);
wr = ra([
  d("uui-toast-notification-layout")
], wr);
var og = Object.getOwnPropertyDescriptor, sg = (e, t, i, o) => {
  for (var r = o > 1 ? void 0 : o ? og(t, i) : t, s = e.length - 1, n; s >= 0; s--)
    (n = e[s]) && (r = n(r) || r);
  return r;
};
let Ro = class extends Te {
  constructor() {
    super("switch");
  }
  renderCheckbox() {
...
var ng = Object.getOwnPropertyDescriptor, ag = (e, t, i, o) => {
  for (var r = o > 1 ? void 0 : o ? ng(t, i) : t, s = e.length - 1, n; s >= 0; s--)
    (n = e[s]) && (r = n(r) || r);
  return r;
};
let xn = class extends v {
  render() {
    return l`<slot></slot>`;
  }
};
...
export {
  $g as ActiveMixin,
  kg as LabelMixin,
  Lg as PopoverTargetMixin,
  Eg as SelectOnlyMixin,
  Cg as SelectableMixin,
  Sg as Timer,
  As as UUIActionBarElement,
  ct as UUIAvatarElement,
  ci as UUIAvatarGroupElement,
  hi as UUIBadgeElement,
  fg as UUIBlinkAnimationValue,
  vg as UUIBlinkKeyframes,
  Te as UUIBooleanInputElement,
  _a as UUIBooleanInputEvent,
  Ye as UUIBoxElement,
  di as UUIBreadcrumbItemElement,
  co as UUIBreadcrumbsElement,
  pi as UUIButtonCopyTextElement,
  Z as UUIButtonElement,
  ur as UUIButtonGroupElement,
  Qe as UUIButtonInlineCreateElement,
  $a as UUIButtonInlineCreateEvent,
  vi as UUICardBlockTypeElement,
  fi as UUICardContentNodeElement,
  Q as UUICardElement,
  Dr as UUICardEvent,
  Lt as UUICardMediaElement,
  cr as UUICardUserElement,
  go as UUICaretElement,
  po as UUICheckboxElement,
  fe as UUIColorAreaElement,
  Da as UUIColorAreaEvent,
  Tr as UUIColorPickerChangeEvent,
  L as UUIColorPickerElement,
  le as UUIColorSliderElement,
  Za as UUIColorSliderEvent,
  ht as UUIColorSwatchElement,
  Tt as UUIColorSwatchesElement,
  Vr as UUIColorSwatchesEvent,
  G as UUIComboboxElement,
  Pe as UUIComboboxEvent,
  De as UUIComboboxListElement,
  Ae as UUIComboboxListEvent,
  dt as UUIComboboxListOptionElement,
  zr as UUICopyTextEvent,
  js as UUIDialogElement,
  hr as UUIDialogLayoutElement,
  yl as UUIEvent,
  pt as UUIFileDropzoneElement,
  Br as UUIFileDropzoneEvent,
  be as UUIFilePreviewElement,
  Gt as UUIFormControlEvent,
  Pg as UUIFormControlMixin,
  el as UUIFormElement,
  bi as UUIFormLayoutItemElement,
  ko as UUIFormValidationMessageElement,
  gg as UUIHorizontalPulseAnimationValue,
  bg as UUIHorizontalPulseKeyframes,
  _g as UUIHorizontalShakeAnimationValue,
  mg as UUIHorizontalShakeKeyframes,
  Je as UUIIconElement,
  tl as UUIIconHost,
  pu as UUIIconRegistry,
  Eo as UUIIconRegistryElement,
  xv as UUIIconRegistryEssential,
  il as UUIIconRegistryEssentialElement,
  Co as UUIIconRequestEvent,
  z as UUIInputElement,
  Hr as UUIInputEvent,
  vt as UUIInputFileElement,
  gi as UUIInputLockElement,
  rl as UUIInputLockEvent,
  dr as UUIInputPasswordElement,
  Vg as UUIInterfaceColorValues,
  Bg as UUIInterfaceHeadingValues,
  Ng as UUIInterfaceLookValues,
  Gs as UUIKeyElement,
  Ws as UUIKeyboardShortcutElement,
  mi as UUILabelElement,
  pr as UUILoaderBarElement,
  vr as UUILoaderCircleElement,
  qs as UUILoaderElement,
  ne as UUIMenuItemElement,
  rr as UUIMenuItemEvent,
  sf as UUIModalCloseEndEvent,
  qi as UUIModalCloseEvent,
  ft as UUIModalContainerElement,
  Js as UUIModalDialogElement,
  $e as UUIModalElement,
  of as UUIModalOpenEvent,
  fr as UUIModalSidebarElement,
  ie as UUIPaginationElement,
  Kt as UUIPaginationEvent,
  et as UUIPopoverContainerElement,
  Nt as UUIPopoverElement,
  Po as UUIProgressBarElement,
  we as UUIRadioElement,
  So as UUIRadioEvent,
  _i as UUIRadioGroupElement,
  nl as UUIRadioGroupEvent,
  D as UUIRangeSliderElement,
  bt as UUIRefElement,
  Fr as UUIRefEvent,
  dn as UUIRefListElement,
  Ao as UUIRefNodeDataTypeElement,
  Uo as UUIRefNodeDocumentTypeElement,
  V as UUIRefNodeElement,
  pn as UUIRefNodeFormElement,
  zo as UUIRefNodeMemberElement,
  gr as UUIRefNodePackageElement,
  Do as UUIRefNodeUserElement,
  Mo as UUIScrollContainerElement,
  ue as UUISelectElement,
  ll as UUISelectEvent,
  Ir as UUISelectableEvent,
  q as UUISliderElement,
  Wr as UUISliderEvent,
  Lo as UUISymbolExpandElement,
  $o as UUISymbolFileDropzoneElement,
  To as UUISymbolFileElement,
  mr as UUISymbolFileThumbnailElement,
  fn as UUISymbolFolderElement,
  No as UUISymbolLockElement,
  bn as UUISymbolMoreElement,
  Vo as UUISymbolSortElement,
  mt as UUITabElement,
  Kg as UUITabEvent,
  _t as UUITabGroupElement,
  Xg as UUITabGroupEvent,
  gt as UUITableCellElement,
  mn as UUITableColumnElement,
  gn as UUITableElement,
  _n as UUITableHeadCellElement,
  yn as UUITableHeadElement,
  Bo as UUITableRowElement,
  yr as UUITagElement,
  xr as UUITextStyles,
  j as UUITextareaElement,
  dl as UUITextareaEvent,
  jo as UUIToastNotificationContainerElement,
  yt as UUIToastNotificationElement,
  Oe as UUIToastNotificationEvent,
  wr as UUIToastNotificationLayoutElement,
  Ro as UUIToggleElement,
  xn as UUIVisuallyHiddenElement,
  Ug as clamp,
  Tg as defineElement,
  Ig as demandCustomElement,
  Ag as drag,
  Wc as findAncestorByAttributeValue,
  zg as reverseNumberInRange,
  Mg as slotHasContent,
  Dg as toHex
};
