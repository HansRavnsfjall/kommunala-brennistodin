...
var g = Object.defineProperty, y = Object.getOwnPropertyDescriptor, n = (a, e, o, i) => {
  for (var r = i > 1 ? void 0 : i ? y(e, o) : e, s = a.length - 1, l; s >= 0; s--)
    (l = a[s]) && (r = (i ? l(e, o, r) : l(r)) || r);
    ...
    super(), this.consumeContext(d, async (a) => {
      this.observe(
        ...
        (e) => {
          ...
          this._areaColumnsConfigurationObject = [{ alias: "placeholder", value: o }, { alias: "min", value: 1 }], this._areaConfigConfigurationObject = [{ alias: "defaultAreaGridColumns", value: o }];
        },
        "observeGridColumns"
      );
...
//# sourceMappingURL=block-grid-type-workspace-view-areas.element-BTJYV1Qh.js.map
