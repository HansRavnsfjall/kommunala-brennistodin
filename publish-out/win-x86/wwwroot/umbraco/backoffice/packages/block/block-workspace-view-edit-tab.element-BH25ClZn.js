import { U as H } from "./block-workspace.context-token-DTpZ56Fk.js";
...
}, G = (t, e, r) => e.has(t) || R("Cannot " + r), s = (t, e, r) => (G(t, e, "read from private field"), r ? r.call(t) : e.get(t)), b = (t, e, r) => e.has(t) ? R("Cannot add the same private member more than once") : e instanceof WeakSet ? e.add(t) : e.set(t, r), O = (t, e, r, a) => (G(t, e, "write to private field"), e.set(t, r), r), k = (t, e, r) => (G(t, e, "access private method"), r), g, P, v, C, I, d, W, N, U;
let u = class extends B {
  constructor() {
    super(), b(this, d), b(this, g), b(this, P), b(this, v, new J(this)), b(this, C), b(this, I, []), this.consumeContext(H, (t) => {
      O(this, P, t), this._ownerEntityType = s(this, P)?.getEntityType(), this.observe(
        t?.variantId,
        (e) => {
          this._workspaceVariantId = e, k(this, d, N).call(this);
        },
        "observeVariantId"
      ), k(this, d, W).call(this);
    });
  }
  get managerName() {
    return s(this, g);
  ...
  set managerName(t) {
    O(this, g, t), k(this, d, W).call(this);
  }
  get containerId() {
...
N = function() {
  ...
  s(this, C).forEach((e) => {
    ...
    this.observe(
      ...
      (a) => {
        if (a)
          s(this, I).push(e.unique), k(this, d, U).call(this);
        else {
          const i = s(this, I).indexOf(e.unique);
          i !== -1 && (s(this, I).splice(i, 1), k(this, d, U).call(this));
        }
      },
  ...
  renderGroup(t) {
    return f`
			<umb-block-workspace-view-edit-properties
				...
				.containerId=${t.ids[0]}></umb-block-workspace-view-edit-properties>
		`;
  }
};
c = /* @__PURE__ */ new WeakMap();
...
//# sourceMappingURL=block-workspace-view-edit-tab.element-BH25ClZn.js.map
