import { U as C } from "./block-workspace.context-token-DTpZ56Fk.js";
...
y = function() {
  ...
  this._tabs.length > 0 && this._tabs?.forEach((e) => {
    ...
    t.push({
      path: `tab/${P(s)}`,
      component: () => import("./block-workspace-view-edit-tab.element-BH25ClZn.js"),
      setup: (o) => {
        o.managerName = a(this, h), o.containerId = e.ids[0];
      }
    });
...
//# sourceMappingURL=block-workspace-view-edit.element-h83-m4xf.js.map
