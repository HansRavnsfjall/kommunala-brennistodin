import { html as b, css as _, state as c, customElement as v } from "@umbraco-cms/backoffice/external/lit";
...
var g = Object.defineProperty, A = Object.getOwnPropertyDescriptor, y = (e) => {
  throw TypeError(e);
}, m = (e, t, a, l) => {
  for (var r = l > 1 ? void 0 : l ? A(t, a) : t, p = e.length - 1, n; p >= 0; p--)
    (n = e[p]) && (r = (l ? n(t, a, r) : n(r)) || r);
  return l && r && g(t, a, r), r;
}, h = (e, t, a) => t.has(e) || y("Cannot " + a), s = (e, t, a) => (h(e, t, "read from private field"), a ? a.call(e) : t.get(e)), d = (e, t, a) => t.has(e) ? y("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, a), V = (e, t, a, l) => (h(e, t, "write to private field"), t.set(e, a), a), i, u;
...
//# sourceMappingURL=settings.element-DPvivHfg.js.map
