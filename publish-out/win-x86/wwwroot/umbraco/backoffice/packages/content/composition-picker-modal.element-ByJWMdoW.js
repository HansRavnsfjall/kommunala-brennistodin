...
import { UmbModalBaseElement as P, umbConfirmModal as A } from "@umbraco-cms/backoffice/modal";
import { UmbExtensionApiInitializer as I } from "@umbraco-cms/backoffice/extension-api";
...
let l = class extends P {
  ...
  connectedCallback() {
    ...
    if (e)
      y(this, d, new I(this, R, e, [this], (t, s) => {
  ...
  async _submitModal() {
    ...
    !e.every((o) => t.has(o)) && await A(this, {
...
$ = async function() {
  ...
  this._compatibleCompositions = s.map((o) => ({
    path: o,
    compositions: t.filter((c) => "/" + c.folderPath.join("/") === o)
  }));
};
E = function(e) {
...
//# sourceMappingURL=composition-picker-modal.element-ByJWMdoW.js.map
