...
class z extends C {
  constructor(t, e) {
    ...
    const r = e.manifest;
    this.#a = r.meta?.entityType, this.validationContext = new N(this), this.addValidationContext(this.validationContext), this.observe(
      this.unique,
      (s) => {
      ...
      null
    ), this.#s = this.consumeContext(x, (s) => {
      this.#e = s;
...
//# sourceMappingURL=property-type-workspace.context-GAeilqXV.js.map
