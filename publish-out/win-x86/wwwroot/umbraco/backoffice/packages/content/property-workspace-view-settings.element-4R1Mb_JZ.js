...
import "./paths-V4UWR6eP.js";
import { U as G } from "./property-type-workspace.context-token-Cbb8UB1S.js";
import { html as r, nothing as p, css as Z, state as u, query as H, customElement as Y } from "@umbraco-cms/backoffice/external/lit";
import { generateAlias as F } from "@umbraco-cms/backoffice/utils";
...
let n = class extends K {
  constructor() {
    ...
    ], this._aliasLocked = !0, this._autoGenerateAlias = !0, this.consumeContext(G, (e) => {
      ...
      return r`
			<uui-box class="uui-text">
				...
				<umb-property-layout label="#contentTypeEditor_displaySettingsHeadline" orientation="vertical">
					<div id="appearances" slot="editor">${i(this, a, I).call(this)} ${i(this, a, P).call(this)}</div>
				</umb-property-layout>

				${i(this, a, L).call(this)}
			</uui-box>
		`;
  }
};
...
f = function(e) {
  this.updateValue({ name: e.target.value.toString() }), this._aliasLocked && this._autoGenerateAlias && this.updateValue({ alias: F(this._data?.name ?? "") });
};
b = function() {
  const e = this._aliasInput.value.toString();
...
q = function() {
  return this._contentTypeVariesByCulture || this._contentTypeVariesBySegment ? r` <umb-property-layout label="#contentTypeEditor_variantsHeading" orientation="vertical">
					<umb-stack slot="editor" look="compact">
						${this._contentTypeVariesByCulture ? i(this, a, R).call(this) : p}
						${this._contentTypeVariesBySegment ? i(this, a, W).call(this) : p}
					</umb-stack>
				</umb-property-layout>` : "";
};
R = function() {
...
n = s([
  Y("umb-property-type-workspace-view-settings")
], n);
const pe = n;
export {
...
//# sourceMappingURL=property-workspace-view-settings.element-4R1Mb_JZ.js.map
