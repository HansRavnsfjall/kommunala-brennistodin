const n = {
  actions: {
    ...
    viewActionsFor: (e) => e ? `Se handlinger for '${e}'` : "Se handlinger",
  ...
  content: {
    ...
    openSplitViewForVariant: (e) => `Åbn ${e} i sidestillet visning`
  },
  blueprints: {
  ...
  entityDetail: {
    notFoundTitle: (e) => `${e ?? "Elementet"} blev ikke fundet`,
    notFoundDescription: (e) => `Den/det ønskede ${e ?? "element"} kunne ikke findes. Dette kan skyldes, at den/det er blevet slettet, eller at du ikke har adgang. Kontakt din administrator for hjælp.`,
    forbiddenTitle: (e) => `${e ?? "Elementet"} er ikke tilgængelig`,
    forbiddenDescription: (e) => `Du har ikke adgang til den/det ønskede ${e ?? "element"}. Kontakt din administrator for hjælp.`
  },
  media: {
  ...
  defaultdialogs: {
    ...
    confirmTrash: (e) => `Er du sikker på, at du vil flytte <strong>${e}</strong> til papirkurven?`,
    confirmBulkTrash: (e) => `Er du sikker på, at du vil flytte <strong>${e} ${e === 1 ? "element" : "elementer"}</strong> til papirkurven?`,
    confirmBulkDelete: (e) => `Er du sikker på, at du vil slette <strong>${e} ${e === 1 ? "element" : "elementer"}</strong>?`
  },
  dictionary: {
  ...
  general: {
    ...
    dividerPosition: (e) => `Skillevæg ved ${e}%`,
    discard: "Kassér",
    down: "Ned",
    download: "Hent",
    edit: "Rediger",
...
<span style="color: Red; font-weight: bold;">Bemærk:</span> at dokumenter og medier som afhænger af denne pakke vil muligvis holde op med at virke, så vær forsigtig. Hvis i tvivl, kontakt personen som har udviklet pakken.`,
  ...
  contentPicker: {
    ...
    unsupportedHeadline: (e) => `<strong>Ikke-understøttede ${e ?? "indholds"} elementer</strong><br>Følgende indhold understøttes ikke længere i denne editor.`,
  ...
  user: {
    ...
    createUserDescription: (e) => e === "Api" ? "Opret en API-bruger for at give eksterne tjenester mulighed for at godkende via Umbraco Management API'et." : "Opret en bruger for at give adgang til Umbraco. Når en bruger oprettes, genereres der en adgangskode, som du kan dele med brugeren.",
    ...
    languageNotFound: (e, t) => `Den angivne kultur "${e}" blev ikke fundet, basis-kulturen "${t}" vil blive brugt.`,
    languageNotFoundFallback: (e, t) => `Hverken den angivne kultur "${e}" eller basis-kulturen "${t}" blev fundet, standard fallback-kulturen "Engelsk (UK)" vil blive brugt.`,
  ...
  blockEditor: {
    ...
    createThisFor: (e, t) => t ? `Opret ${e} for ${t}` : `Opret ${e}`,
  ...
  tiptap: {
    ...
    charmap_arrows: "Pile",
    statusbar_characters: (e) => `${e.toLocaleString()} tegn`,
    statusbar_words: (e) => `${e.toLocaleString()} ord`
  },
  collection: {
...
//# sourceMappingURL=da-DDI7cSZn.js.map
