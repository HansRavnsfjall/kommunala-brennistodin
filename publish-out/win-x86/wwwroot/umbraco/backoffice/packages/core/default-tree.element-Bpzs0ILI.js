...
R = function() {
  return this._totalPages <= 1 || this._currentPage === this._totalPages ? _ : l` <uui-button id="load-more" @click=${$(this, d)} label="Load more"></uui-button> `;
};
i.styles = x`
		#load-more {
			width: 100%;
...
//# sourceMappingURL=default-tree.element-Bpzs0ILI.js.map
