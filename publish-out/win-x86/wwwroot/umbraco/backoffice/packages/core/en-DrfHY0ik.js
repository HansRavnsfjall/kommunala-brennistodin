const a = {
  actions: {
    ...
    copyTo: "Duplicate to",
    create: "Create",
    createFor: (e) => e ? `Create item for ${e}` : "Create",
    ...
    viewActionsFor: (e) => e ? `View actions for '${e}'` : "View actions",
    loadMore: "Load more"
  },
  actionCategories: {
    content: "Content",
  ...
  content: {
    ...
    openSplitViewForVariant: (e) => `Open ${e} in split view`,
  ...
  entityDetail: {
    ...
    forbiddenTitle: (e) => `Access denied to this ${e ?? "item"}`,
    forbiddenDescription: (e) => `You do not have permission to access this ${e ?? "item"}. Please contact your administrator for assistance.`
  },
  media: {
  ...
  general: {
    ...
    dividerPosition: (e) => `Divider at ${e}%`,
    discard: "Discard",
    document: "Document",
    down: "Down",
    download: "Download",
...
To manage your website, simply open the Umbraco backoffice and start adding content, updating the templates and stylesheets or add new functionality`,
  ...
  user: {
    ...
    languageNotFound: (e, t) => `The specified culture "${e}" was not found, the base culture of "${t}" will be used.`,
    languageNotFoundFallback: (e, t) => `Neither the specified culture "${e}" or base culture "${t}" was found, the default fallback culture of "English (UK)" will be used.`,
  ...
  tiptap: {
    ...
    statusbar_characters: (e) => `${e.toLocaleString()} ${e === 1 ? "character" : "characters"}`,
    statusbar_words: (e) => `${e.toLocaleString()} ${e === 1 ? "word" : "words"}`
  },
  linkPicker: {
    modalSource: "Source",
    modalManual: "Manual",
...
//# sourceMappingURL=en-DrfHY0ik.js.map
