const r = {
  actions: {
    ...
    viewActionsFor: (e) => e ? `Ver ações para '${e}'` : "Ver ações"
  },
  actionCategories: {
    content: "Conteúdo",
  ...
  entityDetail: {
    notFoundTitle: (e) => `${e ?? "Item"} não encontrado`,
    notFoundDescription: (e) => `O ${e ?? "item"} solicitado não pôde ser encontrado. Por favor, verifique o URL e tente novamente.`
  },
  media: {
  ...
  defaultdialogs: {
    ...
    confirmdelete: (e) => `Tem a certeza que quer eliminar${e ? ` <strong>${e}</strong>` : ""}?`,
    ...
    confirmTrash: (e) => `Tem a certeza que quer mover <strong>${e}</strong> para a Reciclagem?`,
    confirmBulkTrash: (e) => `Tem a certeza que quer mover <strong>${e} ${e === 1 ? "item" : "itens"}</strong> para a Reciclagem?`,
    confirmBulkDelete: (e) => `Tem a certeza que quer eliminar <strong>${e} ${e === 1 ? "item" : "itens"}</strong>?`,
    cut: "Cortar",
  ...
  general: {
    ...
    duration: (e, o, a) => new Date(o).getTime() < new Date(a).getTime() ? `${e} atrás` : `em ${e}`
  },
  colors: {
    blue: "Azul"
  },
...
Para gerir o seu website, simplesmente abra o backoffice do Umbraco e comece a adicionar conteúdo, atualizar os modelos e folhas de estilo ou adicionar nova funcionalidade`,
  ...
  contentPicker: {
    ...
    unsupportedHeadline: (e) => `<strong>Itens de ${e ?? "conteúdo"} não suportados</strong><br>O seguinte conteúdo já não é suportado neste Editor.`,
  ...
  user: {
    ...
    createUserHeadline: (e) => e === "Api" ? "Criar utilizador API" : "Criar utilizador",
    createUserDescription: (e) => e === "Api" ? "Crie um Utilizador API para permitir que serviços externos se autentiquem com a API de Gestão do Umbraco." : "Crie um utilizador para lhe dar acesso ao Umbraco. Quando um utilizador é criado, será gerada uma palavra-passe que pode partilhar com ele.",
    ...
    emailDescription: (e) => e ? "O endereço de email é usado para notificações, recuperação de palavra-passe e como nome de utilizador para iniciar sessão" : "O endereço de email é usado para notificações e recuperação de palavra-passe",
    kind: "Tipo",
    ...
    languageNotFound: (e, o) => `A cultura especificada "${e}" não foi encontrada, a cultura base de "${o}" será usada.`,
    languageNotFoundFallback: (e, o) => `Nem a cultura especificada "${e}" nem a cultura base "${o}" foram encontradas, a cultura de recurso predefinida de "Inglês (Reino Unido)" será usada.`,
    ...
    selectUserGroup: (e) => e ? "Selecionar Grupos de Utilizadores" : "Selecionar Grupo de Utilizadores",
    chooseUserGroup: (e) => e ? "Escolher Grupos de Utilizadores" : "Escolher Grupo de Utilizadores",
  ...
  references: {
    ...
    labelMoreReferences: (e) => e === 1 ? "...e mais um item" : `...e mais ${e} itens`
  },
  logViewer: {
  ...
  blockEditor: {
    ...
    createThisFor: (e, o) => o ? `Criar ${e} para ${o}` : `Criar ${e}`,
...
//# sourceMappingURL=pt-zDg4UyMF.js.map
