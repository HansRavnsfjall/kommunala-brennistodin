...
var B = Object.defineProperty, O = Object.getOwnPropertyDescriptor, b = (t) => {
  ...
  for (var o = l > 1 ? void 0 : l ? O(e, i) : e, h = t.length - 1, d; h >= 0; h--)
    (d = t[h]) && (o = (l ? d(e, i, o) : d(o)) || o);
  return l && o && B(e, i, o), o;
}, w = (t, e, i) => e.has(t) || b("Cannot " + i), m = (t, e, i) => (w(t, e, "read from private field"), i ? i.call(t) : e.get(t)), y = (t, e, i) => e.has(t) ? b("Cannot add the same private member more than once") : e instanceof WeakSet ? e.add(t) : e.set(t, i), S = (t, e, i, l) => (w(t, e, "write to private field"), e.set(t, i), i), a = (t, e, i) => (w(t, e, "access private method"), i), u, n, R, p, q, C, f, E, I;
  ...
  render() {
    return r`
			<umb-body-layout headline="Restore">
				<uui-box>
					${this._isAutomaticRestore ? r` Restore ${this._restoreItem?.name} to ${this._destinationItem?.name}` : a(this, n, E).call(this)}
				</uui-box>
...
E = function() {
  return r`
			...
			${this._destinationItem ? r`<uui-ref-node name=${this._destinationItem.name}>
					...
					</uui-ref-node>` : r` <uui-button id="placeholder" look="placeholder" @click=${a(this, n, q)}
...
//# sourceMappingURL=restore-from-recycle-bin-modal.element-CTv-1SeJ.js.map
