import { h as T, f as a, g as n, E as p } from "./constants-mZOozcI2.js";
...
class O extends l {
  ...
  async requestTreeRoot() {
    const { data: t } = await this._treeSource.getRootItems({ skip: 0, take: 0 }), r = t ? t.total > 0 : !1;
    return { data: {
      unique: null,
      entityType: n,
...
//# sourceMappingURL=data-type-tree.repository-DLWsuiSu.js.map
