import { d as p, u, f as d, O as c } from "./constants-mZOozcI2.js";
import { html as m, css as y, customElement as A } from "@umbraco-cms/backoffice/external/lit";
import { UmbLitElement as E } from "@umbraco-cms/backoffice/lit-element";
import { UmbEntityNamedDetailWorkspaceContextBase as b, UmbWorkspaceIsNewRedirectController as f, UmbInvariantWorkspacePropertyDatasetContext as g } from "@umbraco-cms/backoffice/workspace";
...
class I extends b {
    ...
    super(t, {
    ...
    ), this.properties = this.#t.asObservable(), this.#e = [], this.#r = [], this.#s = [], this.#i = [], this.#a = null, this.#n = new h(null), this.propertyEditorUiIcon = this.#n.asObservable(), this.#h = new h(null), this.propertyEditorUiName = this.#h.asObservable(), this.#d(), this.#u(), this.routes.setRoutes([
      {
        ...
        setup: async (e, r) => {
          ...
          await this.createScaffold({ parent: { entityType: s, unique: i } }), new f(
            this,
            this,
  ...
  #u() {
    this.observe(
      ...
      async (t) => {
        this.#i = [], this.#r = [], t !== void 0 && this.#m(t);
      },
      "editorUiAlias"
    );
  }
  ...
  #m(t) {
    ...
    this.observe(
      ...
      (e) => {
        this.#n.setValue(e?.meta.icon || null), this.#h.setValue(e?.name || null), this.#i = (e?.meta.settings?.properties ?? []).map((s, i) => ({
          ...s,
          weight: s.weight ?? 1e3 + i
        })), this.#r = e?.meta.settings?.defaultData || [];
        const r = e?.meta.propertyEditorSchemaAlias;
        r && this.setPropertyEditorSchemaAlias(r), this.#p();
      },
      "editorUi"
    );
  }
  #p() {
    if (this.#s && this.#i) {
      ...
      const t = this.#l;
      this.#l = this.getPropertyEditorUiAlias(), (this.getIsNew() || t && t !== this.#l) && this.#y();
    }
  }
  #y() {
...
//# sourceMappingURL=data-type-workspace.context-C4vWeiSW.js.map
