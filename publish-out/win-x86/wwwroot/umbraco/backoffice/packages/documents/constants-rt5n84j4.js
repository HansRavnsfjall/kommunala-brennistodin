...
const c = new E(
  ...
  sectionName: t,
  entityType: O
}), y = new e("create/parent/:parentEntityType/:parentUnique/:presetAlias", U), L = new e(
  "edit/:unique",
  U
), i = "document-type-property-type", B = "Umb.Repository.DocumentType.Composition", u = new T(
...
), Q = "Umb.Workspace.DocumentType", Z = "Umb.Workspace.DocumentType.Root", $ = "Umb.MenuItem.DocumentTypes";
export {
  r as A,
  U as B,
  B as C,
...
//# sourceMappingURL=constants-rt5n84j4.js.map
