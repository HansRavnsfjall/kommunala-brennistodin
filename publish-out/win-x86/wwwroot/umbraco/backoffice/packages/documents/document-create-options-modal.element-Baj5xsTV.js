...
import { k as S, n as q } from "./manifests-BfVrApfB.js";
import { when as $, html as r, repeat as E, css as O, state as f, customElement as U } from "@umbraco-cms/backoffice/external/lit";
...
import { UmbDocumentBlueprintItemRepository as I } from "@umbraco-cms/backoffice/document-blueprint";
...
let l = class extends W {
  constructor() {
    super(...arguments), u(this, n), u(this, g, new x(this)), u(this, T, new R(this)), u(this, v, new I(this)), u(this, c, ""), u(this, d, ""), this._allowedDocumentTypes = [], this._headline = `${this.localize.term("create_createUnder")} ${this.localize.term("actionCategories_content")}`, this._availableBlueprints = [];
  }
  async firstUpdated() {
...
l = p([
  U("umb-document-create-options-modal")
], l);
const ee = l;
export {
...
//# sourceMappingURL=document-create-options-modal.element-Baj5xsTV.js.map
