import { e as n, l as a, a as u } from "./manifests-BfVrApfB.js";
import { UmbTreeServerDataSourceBase as c, UmbTreeRepositoryBase as l } from "@umbraco-cms/backoffice/tree";
...
), p = (e) => e.parent.unique === null ? o(e) : r.getTreeDocumentChildren({
...
class f extends l {
  ...
  async requestTreeRoot() {
    const { data: t } = await this._treeSource.getRootItems({ skip: 0, take: 0 }), s = t ? t.total > 0 : !1;
    return { data: {
      unique: null,
      entityType: a,
...
export {
  f as UmbDocumentTreeRepository,
  f as default
};
//# sourceMappingURL=document-tree.repository-DRwbyGB_.js.map
