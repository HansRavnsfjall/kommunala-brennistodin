...
let o = class extends U {
  constructor() {
    super(), p(this, h), this._routes = [
      {
        path: "/:groupName",
        component: () => import("./health-check-group.element-SSdR5qwj.js"),
        setup: (e, t) => {
          const a = e;
      ...
      {
        path: "",
        component: () => import("./health-check-overview.element-DyAgalnt.js")
      },
      {
        path: "**",
...
//# sourceMappingURL=dashboard-health-check.element-mlap8K4_.js.map
