...
let s = class extends D {
  constructor() {
    super(...arguments), g(this, l), this.radius = 45, this.borderSize = 20, this.svgSize = 100, this.description = "", this.hideDetailBox = !1, this._circles = [], this._viewBox = 100, this._posY = 0, this._posX = 0, this._detailName = "", this._detailAmount = 0, this._detailColor = "black", this._totalAmount = 0, this._detailKind = "", g(this, u), g(this, b, (t) => {
  ...
  render() {
    return W` <div id="container" @mousemove=${_(this, b)}>
				<svg viewBox="0 0 ${this._viewBox} ${this._viewBox}" role="list">${d(this, l, N).call(this)}</svg>
				<div
					id="details-box"
...
v = function(t = null) {
  this._totalAmount = this._slices.reduce((e, o) => e + o.amount, 0), t?.stopPropagation(), this._circles = d(this, l, A).call(this, this._slices.map((e) => ({
...
P = function(t) {
  const o = t.target.dataset.index, i = this._circles[o];
  ...
  return $`
    ...
    (t, e) => $`
								...
								data-index="${e}"
									...
									role="listitem"
									d="${t.commands}"
									transform="rotate(${t.offset} ${this._viewBox / 2} ${this._viewBox / 2})">
								</path>
								<path
								data-index="${e}"
...
a([
  c()
], s.prototype, "_circles", 2);
a([
  c()
], s.prototype, "_viewBox", 2);
a([
  c()
], s.prototype, "_posY", 2);
a([
...
//# sourceMappingURL=donut-slice.element-CVeNivY3.js.map
