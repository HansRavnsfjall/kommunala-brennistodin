...
import { css as k, state as v, customElement as P, nothing as N, html as l, property as ye } from "@umbraco-cms/backoffice/external/lit";
...
}, B = (e, t, i) => t.has(e) || ae("Cannot " + i), n = (e, t, i) => (B(e, t, "read from private field"), t.get(e)), $ = (e, t, i) => t.has(e) ? ae("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, i), oe = (e, t, i, s) => (B(e, t, "write to private field"), t.set(e, i), i), F = (e, t, i) => (B(e, t, "access private method"), i), h, y, p, b, ne, le, ue, V;
let L = class extends M {
  constructor() {
    super(), $(this, b), $(this, h, 999), $(this, y, 1), this._savedSearches = [], this._total = 0, $(this, p), $(this, V, (e) => l` <li>
      ...
      oe(this, p, e), n(this, p)?.getSavedSearches({ skip: 0, take: n(this, h) }), F(this, b, ne).call(this);
    });
  }
  render() {
    return l` <uui-box id="saved-searches" headline="Saved searches">
			...
			${this._total > n(this, h) ? l`<uui-pagination
						...
						@change=${F(this, b, ue)}></uui-pagination>` : N}
		</uui-box>`;
  }
};
...
ue = function(e) {
  oe(this, y, e.target.current), F(this, b, le).call(this);
};
...
}, X = (e, t, i) => t.has(e) || ve("Cannot " + i), u = (e, t, i) => (X(e, t, "read from private field"), t.get(e)), T = (e, t, i) => t.has(e) ? ve("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, i), he = (e, t, i, s) => (X(e, t, "write to private field"), t.set(e, i), i), D = (e, t, i) => (X(e, t, "access private method"), i), g, x, d, C, ge, ce, pe;
let S = class extends M {
  constructor() {
    super(), T(this, C), T(this, g, 10), T(this, x, 1), this._total = 0, this._messageTemplates = [], T(this, d), this.consumeContext(E, (e) => {
      he(this, d, e), u(this, d)?.getMessageTemplates(0, u(this, g)), D(this, C, ge).call(this);
    });
  }
  render() {
    return l`
      ...
      (e) => l`<uui-table-row>
        ...
        `@MessageTemplate='${e.messageTemplate}'`
				...
				${this._total > u(this, g) ? l`<uui-pagination
							...
							nextlabel=${this.localize.term("general_next")}
							lastlabel=${this.localize.term("general_last")}
							@change=${D(this, C, pe)}></uui-pagination>` : N}
			</uui-box>
		`;
  }
};
...
pe = function(e) {
  he(this, x, e.target.current), D(this, C, ce).call(this);
};
S.styles = [
  se,
  k`
...
}, J = (e, t, i) => t.has(e) || de("Cannot " + i), A = (e, t, i) => (J(e, t, "read from private field"), t.get(e)), j = (e, t, i) => t.has(e) ? de("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, i), Me = (e, t, i, s) => (J(e, t, "write to private field"), t.set(e, i), i), ee = (e, t, i) => (J(e, t, "access private method"), i), _, U, _e, me;
let w = class extends M {
  constructor() {
    super(), j(this, U), j(this, _), this._logLevelCountResponse = null, this._logLevelCount = [], this._logLevelCountFilter = [], this.consumeContext(E, (e) => {
      Me(this, _, e), A(this, _)?.getLogCount(), ee(this, U, me).call(this);
    });
  }
  willUpdate(e) {
  ...
  setLogLevelCount() {
    this._logLevelCount = this._logLevelCountResponse ? Object.entries(this._logLevelCountResponse).filter(([e]) => !this._logLevelCountFilter.includes(e)) : [];
  }
    ...
    return l`
			<uui-box id="types" headline="Log types">
				<div id="log-types-container">
					<div id="legend">
						<ul>
							${this._logLevelCountResponse ? Object.keys(this._logLevelCountResponse).map(
      (e) => l`<li>
												<button
													@click=${(t) => {
        t.target?.classList.toggle("active"), ee(this, U, _e).call(this, e);
					...
					<umb-donut-chart .description=${"In chosen date range you have this number of log message of type:"}>
						${this._logLevelCountResponse ? this._logLevelCount.map(
...
me = function() {
  A(this, _) && this.observe(A(this, _).logCount, (e) => {
    this._logLevelCountResponse = e ?? null, this.setLogLevelCount();
  });
};
w.styles = [
  k`
...
R([
  v()
], w.prototype, "_logLevelCountResponse", 2);
R([
  v()
...
}, Q = (e, t, i) => t.has(e) || we("Cannot " + i), G = (e, t, i) => (Q(e, t, "read from private field"), t.get(e)), te = (e, t, i) => t.has(e) ? we("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, i), Ue = (e, t, i, s) => (Q(e, t, "write to private field"), t.set(e, i), i), We = (e, t, i) => (Q(e, t, "access private method"), i), m, q, fe;
let z = class extends M {
  constructor() {
    super(), te(this, q), te(this, m), this._loggers = [], this.loggerName = "Global", this.consumeContext(E, (e) => {
      Ue(this, m, e), G(this, m)?.getSavedSearches(), We(this, q, fe).call(this);
    });
  }
  render() {
    return l`${this._loggers.length > 0 ? this._loggers.find((e) => e.name === this.loggerName)?.level : N}`;
  }
};
m = /* @__PURE__ */ new WeakMap();
q = /* @__PURE__ */ new WeakSet();
fe = function() {
  G(this, m) && this.observe(G(this, m).loggers, (e) => {
    this._loggers = e ?? [];
  });
};
K([
...
}, Z = (e, t, i) => t.has(e) || $e("Cannot " + i), O = (e, t, i) => (Z(e, t, "read from private field"), t.get(e)), ie = (e, t, i) => t.has(e) ? $e("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, i), Re = (e, t, i, s) => (Z(e, t, "write to private field"), t.set(e, i), i), re = (e, t, i) => (Z(e, t, "access private method"), i), c, W, be, Ce;
let f = class extends M {
  constructor() {
    super(), ie(this, W), this._canShowLogs = !1, ie(this, c), this.consumeContext(E, (t) => {
      Re(this, c, t), re(this, W, be).call(this), re(this, W, Ce).call(this), O(this, c)?.getLogLevels(0, 100);
    });
  }
  render() {
    return l`
...
//# sourceMappingURL=index-DZP4lHY2.js.map
