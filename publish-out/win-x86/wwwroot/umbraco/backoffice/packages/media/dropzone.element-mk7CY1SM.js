import { I as C, r as w } from "./input-upload-field.element-DEgpG3Zz.js";
...
import { UmbModalBaseElement as N, UmbModalToken as F, umbOpenModal as Y } from "@umbraco-cms/backoffice/modal";
...
const fe = "Umb.Repository.MediaCollection", Ie = "Umb.CollectionView.Media.Grid", ye = "Umb.CollectionView.Media.Table", Ue = "Umb.Collection.Media", Te = "Umb.Repository.Media.Move", Oe = "Umb.Repository.Media.SortChildrenOf", ve = "Umb.Repository.Media.BulkMove", Re = "Umb.Menu.Media", ge = "Umb.MenuItem.Media", Se = "Umb.Repository.Media.Url", De = "Umb.Store.MediaUrl", Le = "Umb.Repository.Media.RecycleBin.Tree", Ce = "Umb.Store.Media.RecycleBin.Tree", we = "Umb.Tree.Media.RecycleBin", Pe = "Umb.Repository.Media.RecycleBin", Be = "Umb.Repository.Media.BulkTrash", qe = "media-recycle-bin-root", ze = "Umb.Repository.Media.Reference", Ne = "Umb.Repository.Media.Detail", Fe = "Umb.Store.Media.Detail", Ye = "Umb.Repository.Document.Validation", ke = "Umb.GlobalSearch.Media", xe = "Umb.Repository.Media.Tree", $e = "Umb.Store.Media.Tree", Ve = "Umb.Tree.Media", We = "Umb.Workspace.Media", Ge = {
  culture: null,
  segment: null,
  name: "",
  createDate: null,
...
var K = Object.defineProperty, H = Object.getOwnPropertyDescriptor, O = (a) => {
  throw TypeError(a);
}, M = (a, e, t, i) => {
  for (var n = i > 1 ? void 0 : i ? H(e, t) : e, s = a.length - 1, o; s >= 0; s--)
...
const J = d, je = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  get UmbDropzoneMediaTypePickerModalElement() {
    return d;
  },
  default: J
}, Symbol.toStringTag, { value: "Module" })), Q = new F("Umb.Modal.Dropzone.MediaTypePicker", {
  modal: {
    type: "dialog"
  }
});
class ee extends x {
  ...
  async #l(e, t) {
    const i = e.temporaryFile ? e.temporaryFile.file.name : e.folder?.name ?? "", n = {
      ...
      variants: [{ culture: null, segment: null, createDate: null, updateDate: null, flags: [], name: i }],
...
//# sourceMappingURL=dropzone.element-mk7CY1SM.js.map
