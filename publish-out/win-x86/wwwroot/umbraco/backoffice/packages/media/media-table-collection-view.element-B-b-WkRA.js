import { s as U, y as x } from "./input-upload-field.element-DEgpG3Zz.js";
...
var L = Object.defineProperty, V = Object.getOwnPropertyDescriptor, D = (e) => {
  throw TypeError(e);
}, E = (e, t, s, i) => {
  for (var a = i > 1 ? void 0 : i ? V(t, s) : t, h = e.length - 1, p; h >= 0; h--)
    (p = e[h]) && (a = (i ? p(t, s, a) : p(a)) || a);
  return i && a && L(t, s, a), a;
}, z = (e, t, s) => t.has(e) || D("Cannot " + s), H = (e, t, s) => t.has(e) ? D("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, s), R = (e, t, s) => (z(e, t, "access private method"), s), b, $;
...
var F = Object.defineProperty, G = Object.getOwnPropertyDescriptor, S = (e) => {
  ...
  for (var a = i > 1 ? void 0 : i ? G(t, s) : t, h = e.length - 1, p; h >= 0; h--)
    (p = e[h]) && (a = (i ? p(t, s, a) : p(a)) || a);
  return i && a && F(t, s, a), a;
}, y = (e, t, s) => t.has(e) || S("Cannot " + s), c = (e, t, s) => (y(e, t, "read from private field"), t.get(e)), f = (e, t, s) => t.has(e) ? S("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, s), K = (e, t, s, i) => (y(e, t, "write to private field"), t.set(e, s), s), l = (e, t, s) => (y(e, t, "access private method"), s), m, o, r, A, g, w, O, M, I, B;
...
w = function() {
  this._tableItems = [], this._items !== void 0 && this._workspacePathBuilder !== void 0 && (this._tableColumns.length === 0 && l(this, r, g).call(this), this._tableItems = this._items.map((e) => {
    ...
    const t = this._tableColumns?.map((s) => {
      ...
      const i = e.unique && this._workspacePathBuilder ? this._workspacePathBuilder({ entityType: e.entityType }) + x.generateLocal({
        unique: e.unique
      }) : "";
      return {
        columnAlias: s.alias,
        value: s.elementName ? { item: e, editPath: i } : l(this, r, O).call(this, e, s.alias)
      };
    }) ?? [];
    return {
      id: e.unique,
...
//# sourceMappingURL=media-table-collection-view.element-B-b-WkRA.js.map
