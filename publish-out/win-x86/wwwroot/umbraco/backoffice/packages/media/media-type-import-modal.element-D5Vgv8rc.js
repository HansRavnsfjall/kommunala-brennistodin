...
}, f = (e, t, i) => t.has(e) || g("Cannot " + i), u = (e, t, i) => (f(e, t, "read from private field"), i ? i.call(e) : t.get(e)), m = (e, t, i) => t.has(e) ? g("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, i), y = (e, t, i, o) => (f(e, t, "write to private field"), t.set(e, i), i), s = (e, t, i) => (f(e, t, "access private method"), i), _, l, c, r, T, w, C, x, v, M;
let d = class extends k {
  ...
  render() {
    return h` <umb-body-layout headline=${this.localize.term("general_import")}>
			<uui-box> ${s(this, r, M).call(this)} </uui-box>
			<uui-button
				slot="actions"
				type="button"
...
C = function(e) {
  ...
  }), this._fileContent = s(this, r, x).call(this, a);
};
x = function(e) {
  const t = [];
  return e.forEach((i) => {
...
//# sourceMappingURL=media-type-import-modal.element-D5Vgv8rc.js.map
