import { m as T, b as n, n as s, d as i } from "./constants-DTH5dSDc.js";
...
class I extends p {
  ...
  async requestTreeRoot() {
    const { data: t } = await this._treeSource.getRootItems({ skip: 0, take: 0 }), o = t ? t.total > 0 : !1;
    return { data: {
      unique: null,
      entityType: s,
...
//# sourceMappingURL=media-type-tree.repository-DCKn3FiN.js.map
