...
class k {
  ...
  async deleteCreatedPackage(t) {
    return await r(this._host, n.deletePackageCreatedById({ path: { id: t } }));
  }
  getCreatedPackage(t) {
    return r(this._host, n.getPackageCreatedById({ path: { id: t } }));
  }
  getCreatedPackages({ skip: t, take: e }) {
    return r(this._host, n.getPackageCreated({ query: { skip: t, take: e } }));
  }
  getCreatePackageDownload(t) {
    return r(this._host, n.getPackageCreatedByIdDownload({ path: { id: t } }));
  }
  /**
   ...
   */
  getRootItems() {
    return r(this._host, h.getManifestManifest());
  }
  /**
  ...
  getPackageConfiguration() {
    return r(this._host, n.getPackageConfiguration());
  }
  /**
  ...
  getPackageMigrations() {
    return r(this._host, n.getPackageMigrationStatus({ query: { skip: 0, take: 9999 } }));
  }
  async saveCreatedPackage(t) {
    return await r(this._host, n.postPackageCreated({ body: t }));
  }
  async updateCreatedPackage(t, e) {
    return await r(this._host, n.putPackageCreatedById({ path: { id: t }, body: e }));
  }
}
class _ extends p {
  #e;
...
export {
  _ as UmbPackageRepository,
  _ as default
};
//# sourceMappingURL=package.repository-Cg-nPSQY.js.map
