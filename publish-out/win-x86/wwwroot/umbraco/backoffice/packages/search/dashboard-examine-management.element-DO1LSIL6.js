    ...
    super(...arguments), x(this, m), this._routes = [
      {
        ...
        component: () => import("./section-view-examine-indexers-CCdBIIvf.js"),
        setup: (e, t) => {
          const a = e;
      ...
      },
      {
        ...
        component: () => import("./section-view-examine-searchers-BQHhHYlZ.js"),
        setup: (e, t) => {
          const a = e;
      ...
      {
        path: "",
        component: () => import("./section-view-examine-overview-KL2mUrjs.js")
      },
      {
        path: "**",
...
//# sourceMappingURL=dashboard-examine-management.element-DO1LSIL6.js.map
