import { b as o } from "./partial-view-workspace.context-token-DXd6FPys.js";
...
class d {
  ...
  async read(t) {
    ...
    const { data: r, error: i } = await s(this.#e, a.getPartialViewByPath({ path: { path: e } }));
...
//# sourceMappingURL=partial-view-detail.server.data-source-B1K_Wnqq.js.map
