import { k as y } from "./manifests-EJ-JBi2P.js";
...
var E = Object.getOwnPropertyDescriptor, h = (e) => {
  ...
  for (var r = o > 1 ? void 0 : o ? E(t, a) : t, s = e.length - 1, p; s >= 0; s--)
    (p = e[s]) && (r = p(r) || r);
  return r;
}, u = (e, t, a) => t.has(e) || h("Cannot " + a), k = (e, t, a) => (u(e, t, "read from private field"), t.get(e)), d = (e, t, a) => t.has(e) ? h("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, a), O = (e, t, a, o) => (u(e, t, "write to private field"), t.set(e, a), a), l = (e, t, a) => (u(e, t, "access private method"), a), n, i, m, _, f;
...
m = async function(e) {
  e.stopPropagation(), k(this, n)?.execute().then(() => {
    this._submitModal();
  }).catch(() => {
  });
};
...
//# sourceMappingURL=stylesheet-create-options-modal.element-AHFX7BiW.js.map
