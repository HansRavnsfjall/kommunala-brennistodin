import { U as d } from "./current-user-modal.token-If722qVy.js";
...
var w = Object.defineProperty, A = Object.getOwnPropertyDescriptor, l = (e) => {
  throw TypeError(e);
}, h = (e, r, t, a) => {
  for (var s = a > 1 ? void 0 : a ? A(r, t) : r, o = e.length - 1, p; o >= 0; o--)
    (p = e[o]) && (s = (a ? p(r, t, s) : p(s)) || s);
  return a && s && w(r, t, s), s;
}, c = (e, r, t) => r.has(e) || l("Cannot " + t), _ = (e, r, t) => (c(e, r, "read from private field"), r.get(e)), m = (e, r, t) => r.has(e) ? l("Cannot add the same private member more than once") : r instanceof WeakSet ? r.add(e) : r.set(e, t), x = (e, r, t, a) => (c(e, r, "write to private field"), r.set(e, t), t), M = (e, r, t) => (c(e, r, "access private method"), t), n, u, U;
...
//# sourceMappingURL=current-user-header-app.element-D9cDh-hh.js.map
