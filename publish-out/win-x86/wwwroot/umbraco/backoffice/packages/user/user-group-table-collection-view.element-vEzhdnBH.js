import { j as W, g as x } from "./constants-CCpPAcSy.js";
...
let f = class extends I {
  ...
  updated(t) {
    t.has("value") && this._observeSectionNames();
  }
  _observeSectionNames() {
    this.observe(
      G.byType("section"),
      (t) => {
...
//# sourceMappingURL=user-group-table-collection-view.element-vEzhdnBH.js.map
