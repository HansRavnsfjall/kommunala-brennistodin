import { h as C, n as E, t as f, r as y, u as T } from "./paths-CliQ1DWc.js";
...
import { U as g } from "./paths-fyt8epwP.js";
import "@umbraco-cms/backoffice/collection";
import { html as W, css as w, state as l, customElement as U } from "@umbraco-cms/backoffice/external/lit";
import { UmbLitElement as P, umbFocus as k } from "@umbraco-cms/backoffice/lit-element";
import { UmbTextStyles as A } from "@umbraco-cms/backoffice/style";
import { UmbEntityNamedDetailWorkspaceContextBase as B, UmbWorkspaceIsNewRedirectController as S, UmbWorkspaceIsNewRedirectControllerAlias as R } from "@umbraco-cms/backoffice/workspace";
...
s = h([
  U("umb-webhook-workspace-editor")
], s);
class Z extends B {
  constructor(e) {
    super(e, {
    ...
    }), this.headers = this._data.createObservablePartOfCurrent((t) => t?.headers), this.enabled = this._data.createObservablePartOfCurrent((t) => t?.enabled), this.url = this._data.createObservablePartOfCurrent((t) => t?.url), this.description = this._data.createObservablePartOfCurrent((t) => t?.description), this.events = this._data.createObservablePartOfCurrent((t) => t?.events), this.contentTypes = this._data.createObservablePartOfCurrent((t) => t?.contentTypes), this.routes.setRoutes([
      {
        path: "create",
        component: s,
        setup: async () => {
...
//# sourceMappingURL=webhook-workspace.context-BjbGiokw.js.map
